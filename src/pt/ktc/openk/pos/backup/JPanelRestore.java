...
public class JPanelRestore  extends JPanel implements JPanelView {
	
	private static Logger logger = Logger.getLogger(StringConstants.getString(StringEnumerates.pt_ktc_openk_pos_backup_JPanelRestore));

	private AppView m_oApp;

	/** Creates new form JPanelConfiguration */
	public JPanelRestore(AppView oApp) {
		this(oApp.getProperties());
		m_oApp=oApp;
	}

	public JPanelRestore(AppProperties props) {
	...
	public String getTitle() {
		return AppLocal.getIntString(StringConstants.getString(StringEnumerates.Menu_Restore));
	} 
	...
	private void myInitComponents() {
		...
		bLoadFile.setText(StringConstants.getString(StringEnumerates.Repor_Copia_de_Seguranca));
	...
	private void jbtnGenerate(java.awt.event.ActionEvent evt) {
		...
		if (!sair) {
			...
			// Vamos usar uma thread...
			GenerateBackup gBackup=new GenerateBackup(tarfile, jtxtOutput, m_oApp, jlblProgress);
