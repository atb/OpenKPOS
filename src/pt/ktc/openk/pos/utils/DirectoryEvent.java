        ...
        m_fc.addChoosableFileFilter(new FileFilter() {
            public boolean accept(File f) {
                if (f.isDirectory()) {
                    ...
                    return filename.endsWith(StringConstants.getString(StringEnumerates._xml));
...
//                        || filename.endsWith(".ZIP");
            ...
            public String getDescription() {
                return AppLocal.getIntString(StringConstants.getString(StringEnumerates.filter_xmlfile));
            }
        });
