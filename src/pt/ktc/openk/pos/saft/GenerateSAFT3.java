...
// Novo package: oecd.standard.audit.file.tax.p.t1._0._201
import oecd.standard.audit.file.tax.p.t1._0._201._201Factory;
import oecd.standard.audit.file.tax.p.t1._0._201.util._201ResourceFactoryImpl;
import oecd.standard.audit.file.tax.p.t1._0._201.util._201ResourceImpl;
...
public class GenerateSAFT3 implements Runnable {
	...
	public GenerateSAFT3(Date d1, Date d2, String xmlFile, JTextArea output, AppView oApp, JLabel progress) {
		mDate1=d1;
		mDate2=d2;
		mXmlFile=xmlFile;
		jtxtOutput=output;
	...
	public void run() {
		...
		try {
			...
			Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put(StringConstants.getString(StringEnumerates.saft), new _201ResourceFactoryImpl());

			// Criar em memoria o modelo do SAFT
			// Primeiro o documentRoot
			oecd.standard.audit.file.tax.p.t1._0._201.DocumentRoot root= _201Factory.eINSTANCE.createDocumentRoot();

			// o AuditFile
			oecd.standard.audit.file.tax.p.t1._0._201.AuditFileType aft = _201Factory.eINSTANCE.createAuditFileType();
			...
			// o Header
			oecd.standard.audit.file.tax.p.t1._0._201.HeaderType ht=_201Factory.eINSTANCE.createHeaderType();
			...
			ht.setAuditFileVersion("1.02_01");   // NECESSARIO ALTERAR
			...
			ht.setTaxAccountingBasis(oecd.standard.audit.file.tax.p.t1._0._201.TaxAccountingBasisType.F);

			oecd.standard.audit.file.tax.p.t1._0._201.AddressStructurePT ad=_201Factory.eINSTANCE.createAddressStructurePT();
			...
			oecd.standard.audit.file.tax.p.t1._0._201.SourceDocumentsType sd=_201Factory.eINSTANCE.createSourceDocumentsType();

			aft.setSourceDocuments(sd);

			// acrescentar o masterFiles
			oecd.standard.audit.file.tax.p.t1._0._201.MasterFilesType mf = _201Factory.eINSTANCE.createMasterFilesType();

			// salesinvoices
			oecd.standard.audit.file.tax.p.t1._0._201.SalesInvoicesType si=_201Factory.eINSTANCE.createSalesInvoicesType();
			...
			oecd.standard.audit.file.tax.p.t1._0._201.CustomerType cs = _201Factory.eINSTANCE.createCustomerType();
			...
			oecd.standard.audit.file.tax.p.t1._0._201.AddressStructure add = _201Factory.eINSTANCE.createAddressStructure();
			...
			*/
			...
			for(Object f: list.list().toArray()) {
				...
				cs = _201Factory.eINSTANCE.createCustomerType();
			...
			oecd.standard.audit.file.tax.p.t1._0._201.TaxTableType taxTable=_201Factory.eINSTANCE.createTaxTableType();
			...
			for(Object f: lTaxes.list().toArray()) {
				...
				oecd.standard.audit.file.tax.p.t1._0._201.TaxTableEntryType tax_saft=_201Factory.eINSTANCE.createTaxTableEntryType();
				...
				tax_saft.setTaxType(oecd.standard.audit.file.tax.p.t1._0._201.TaxTypeType.IVA);		// Isto nao devia estar hardcoded
			...
			for(Object f: lProducts.list().toArray()) {
				...
				oecd.standard.audit.file.tax.p.t1._0._201.ProductType pType=_201Factory.eINSTANCE.createProductType();
				...
				pType.setProductType(oecd.standard.audit.file.tax.p.t1._0._201.ProductTypeType.P);
			...
			for(Object f: lTickets.list().toArray()) {
				...
				if ((ti.getTicketType()==TicketInfo.RECEIPT_NORMAL) || (ti.getTicketType()==TicketInfo.RECEIPT_REFUND) || (ti.getTicketType()==pt.ktc.openk.pos.aspects.TicketInfo.RECEIPT_INVOICE)) {
					...
					oecd.standard.audit.file.tax.p.t1._0._201.InvoiceType invoice=_201Factory.eINSTANCE.createInvoiceType();
					...
					oecd.standard.audit.file.tax.p.t1._0._201.DocumentStatusType2 docStatus=_201Factory.eINSTANCE.createDocumentStatusType2();
					
					docStatus.setInvoiceStatus(oecd.standard.audit.file.tax.p.t1._0._201.InvoiceStatusType.N);		// Documento "Normal"
					docStatus.setInvoiceStatusDate(dataTempo);
					// Codigo do utilizador responsavel pela alteracao
					docStatus.setSourceID(ti.getUser().getId());
					...
					docStatus.setSourceBilling(oecd.standard.audit.file.tax.p.t1._0._201.SourceBillingType.P);
					// -------
					...
					case TicketInfo.RECEIPT_NORMAL:
						...
						invoice.setInvoiceType(oecd.standard.audit.file.tax.p.t1._0._201.InvoiceTypeType.FS);
						break;
					case pt.ktc.openk.pos.aspects.TicketInfo.RECEIPT_INVOICE:
						// Novo documento do tipo Fatura 
						invoice.setInvoiceType(oecd.standard.audit.file.tax.p.t1._0._201.InvoiceTypeType.FT);
						break;
					case TicketInfo.RECEIPT_REFUND:
						// TD = talao de devolucao ->> DEVE PASSAR A NOTA DE CREDITO 'NC'
						invoice.setInvoiceType(oecd.standard.audit.file.tax.p.t1._0._201.InvoiceTypeType.NC);
						break;
					...
					// Codigo do utilizador responsavel pela geracao do documento
					invoice.setSourceID(ti.getUser().getId());
					...
					{
						oecd.standard.audit.file.tax.p.t1._0._201.LineType1 line=_201Factory.eINSTANCE.createLineType1();
						...
						if (tci.getMultiply()<0)
						{
							...
							oecd.standard.audit.file.tax.p.t1._0._201.References newRef=_201Factory.eINSTANCE.createReferences();
...
//							ref.setCreditNote(cn);
						...
						oecd.standard.audit.file.tax.p.t1._0._201.Tax taxLine=_201Factory.eINSTANCE.createTax();
						...
						taxLine.setTaxType(oecd.standard.audit.file.tax.p.t1._0._201.TaxTypeType.IVA);
					...
					oecd.standard.audit.file.tax.p.t1._0._201.DocumentTotalsType2 dt=_201Factory.eINSTANCE.createDocumentTotalsType2();
					//----------------
...
//					dt.setTaxPayable(totalVATCredit.subtract(totalVATDebit));
			...
			Resource resource2 = new _201ResourceImpl(URI.createURI(StringConstants.getString(StringEnumerates.file___)+mXmlFile));
