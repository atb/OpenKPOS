...
import oecd.standard.audit.file.tax.pt1_01_2.util.Pt1_01_2ResourceFactoryImpl;
import oecd.standard.audit.file.tax.pt1_01_2.util.Pt1_01_2ResourceImpl;
...
public class GenerateSAFT2 implements Runnable {
	...
	public GenerateSAFT2(Date d1, Date d2, String xmlFile, JTextArea output, AppView oApp, JLabel progress) {
		mDate1=d1;
		mDate2=d2;
		mXmlFile=xmlFile;
		jtxtOutput=output;
	...
	public void run() {
		...
		try {
			...
			Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put(StringConstants.getString(StringEnumerates.saft), new Pt1_01_2ResourceFactoryImpl());

			// Criar em memoria o modelo do SAFT
			// Primeiro o documentRoot
			oecd.standard.audit.file.tax.pt1_01_2.DocumentRoot root= Pt1_01_2Factory.eINSTANCE.createDocumentRoot();

			// o AuditFile
			oecd.standard.audit.file.tax.pt1_01_2.AuditFileType aft = Pt1_01_2Factory.eINSTANCE.createAuditFileType();
			...
			// o Header
			oecd.standard.audit.file.tax.pt1_01_2.HeaderType ht=Pt1_01_2Factory.eINSTANCE.createHeaderType();
			...
			ht.setTaxAccountingBasis(oecd.standard.audit.file.tax.pt1_01_2.TaxAccountingBasisType.F);

			oecd.standard.audit.file.tax.pt1_01_2.AddressStructurePT ad=Pt1_01_2Factory.eINSTANCE.createAddressStructurePT();
			...
			oecd.standard.audit.file.tax.pt1_01_2.SourceDocumentsType sd=Pt1_01_2Factory.eINSTANCE.createSourceDocumentsType();

			aft.setSourceDocuments(sd);

			// acrescentar o masterFiles
			oecd.standard.audit.file.tax.pt1_01_2.MasterFilesType mf = Pt1_01_2Factory.eINSTANCE.createMasterFilesType();

			// salesinvoices
			oecd.standard.audit.file.tax.pt1_01_2.SalesInvoicesType si=Pt1_01_2Factory.eINSTANCE.createSalesInvoicesType();
			...
			oecd.standard.audit.file.tax.pt1_01_2.CustomerType cs = Pt1_01_2Factory.eINSTANCE.createCustomerType();
			...
			oecd.standard.audit.file.tax.pt1_01_2.AddressStructure add = Pt1_01_2Factory.eINSTANCE.createAddressStructure();
			...
			add = Pt1_01_2Factory.eINSTANCE.createAddressStructure();
			add.setAddressDetail(StringConstants.getString(StringEnumerates.Desconhecido));
			...
			for(Object f: list.list().toArray()) {
				...
				cs = Pt1_01_2Factory.eINSTANCE.createCustomerType();
			...
			oecd.standard.audit.file.tax.pt1_01_2.TaxTableType taxTable=Pt1_01_2Factory.eINSTANCE.createTaxTableType();
			...
			for(Object f: lTaxes.list().toArray()) {
				...
				oecd.standard.audit.file.tax.pt1_01_2.TaxTableEntryType tax_saft=Pt1_01_2Factory.eINSTANCE.createTaxTableEntryType();
				...
				tax_saft.setTaxType(oecd.standard.audit.file.tax.pt1_01_2.TaxTypeType.IVA);		// Isto nao devia estar hardcoded
			...
			for(Object f: lProducts.list().toArray()) {
				...
				oecd.standard.audit.file.tax.pt1_01_2.ProductType pType=Pt1_01_2Factory.eINSTANCE.createProductType();
				...
				pType.setProductType(oecd.standard.audit.file.tax.pt1_01_2.ProductTypeType.P);
			...
			for(Object f: lTickets.list().toArray()) {
				...
				if ((ti.getTicketType()==TicketInfo.RECEIPT_NORMAL) || (ti.getTicketType()==TicketInfo.RECEIPT_REFUND) || (ti.getTicketType()==pt.ktc.openk.pos.aspects.TicketInfo.RECEIPT_INVOICE)) {
					...
					oecd.standard.audit.file.tax.pt1_01_2.InvoiceType invoice=Pt1_01_2Factory.eINSTANCE.createInvoiceType();
					
					invoice.setInvoiceNo(ti.getDocumentNo());
					invoice.setInvoiceStatus(oecd.standard.audit.file.tax.pt1_01_2.InvoiceStatusType.N);		// Documento "Normal"
					...
					case TicketInfo.RECEIPT_NORMAL:
						...
						invoice.setInvoiceType(oecd.standard.audit.file.tax.pt1_01_2.InvoiceTypeType.FS);
						break;
					case pt.ktc.openk.pos.aspects.TicketInfo.RECEIPT_INVOICE:
						// Novo documento do tipo Fatura 
						invoice.setInvoiceType(oecd.standard.audit.file.tax.pt1_01_2.InvoiceTypeType.FT);
						break;
					case TicketInfo.RECEIPT_REFUND:
						// TD = talao de devolucao ->> DEVE PASSAR A NOTA DE CREDITO 'NC'
						invoice.setInvoiceType(oecd.standard.audit.file.tax.pt1_01_2.InvoiceTypeType.NC);
						break;
					...
					{
						oecd.standard.audit.file.tax.pt1_01_2.LineType line=Pt1_01_2Factory.eINSTANCE.createLineType();
						...
						if (tci.getMultiply()<0)
						{
							...
							oecd.standard.audit.file.tax.pt1_01_2.CreditNoteType cn=Pt1_01_2Factory.eINSTANCE.createCreditNoteType();
							...
							cn.setReference(ti.getReference());		// Assumimos que a referencia ja vem devidamente formatada tal como e' esperado pelo SAFT
							
							oecd.standard.audit.file.tax.pt1_01_2.ReferencesType ref=Pt1_01_2Factory.eINSTANCE.createReferencesType();
						...
						oecd.standard.audit.file.tax.pt1_01_2.TaxType taxLine=Pt1_01_2Factory.eINSTANCE.createTaxType();
						...
						taxLine.setTaxType(oecd.standard.audit.file.tax.pt1_01_2.TaxTypeType.IVA);
					...
					oecd.standard.audit.file.tax.pt1_01_2.DocumentTotalsType dt=Pt1_01_2Factory.eINSTANCE.createDocumentTotalsType();
					//----------------
...
//					dt.setTaxPayable(totalVATCredit.subtract(totalVATDebit));
			...
			Resource resource2 = new Pt1_01_2ResourceImpl(URI.createURI(StringConstants.getString(StringEnumerates.file___)+mXmlFile));
