...
public class JTicketsFinder extends javax.swing.JDialog implements EditorCreator {
    ...
    private void init(DataLogicSales dlSales, DataLogicCustomers dlCustomers) {
        ...
        jListTickets.setCellRenderer(new pt.ktc.openk.pos.ticket.FindTicketsRenderer());   // E esta classe que desenha as linhas da lista!
    ...
    private void initCombos() {
        String[] values = new String[] {"Faturas Simplificadas", "Faturas",
                    "Devolucoes", AppLocal.getIntString("label.all")};
    ...
    public Object createValue() throws BasicException {
        ...
        if (jComboBoxTicket.getSelectedIndex() == 3) {    // Todos
            afilter[2] = QBFCompareEnum.COMP_DISTINCT;
            afilter[3] = 99;
        } else if (jComboBoxTicket.getSelectedIndex() == 0) {   // Fatura Simplificada
            afilter[2] = QBFCompareEnum.COMP_EQUALS;
            afilter[3] = 0;
        } else if (jComboBoxTicket.getSelectedIndex() == 1) {   // Fatura
            afilter[2] = QBFCompareEnum.COMP_EQUALS;
            afilter[3] = 4;
        } else if (jComboBoxTicket.getSelectedIndex() == 2) {   // Nota de Credito / Devolucao
            afilter[2] = QBFCompareEnum.COMP_EQUALS;
            afilter[3] = 1;
        }
