...
public class JRefundLines extends javax.swing.JPanel {
    ...
    public JRefundLines(DataLogicSystem dlSystem, JPanelTicketEdits jTicketEdit) {
        ...
        ticketlines = new JTicketLines(dlSystem.getResourceAsXML(StringConstants.getString(StringEnumerates.Ticket_Line)));
    ...
    private void initComponents() {
        ...
        m_jbtnAddOne.setText(AppLocal.getIntString(StringConstants.getString(StringEnumerates.button_refundone))); // NOI18N
        ...
        m_jbtnAddLine.setText(AppLocal.getIntString(StringConstants.getString(StringEnumerates.button_refundline))); // NOI18N
        ...
        m_jbtnAddAll.setText(AppLocal.getIntString(StringConstants.getString(StringEnumerates.button_refundall))); // NOI18N
    ...
    private void m_jbtnAddAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jbtnAddAllActionPerformed
        ...
        for (int i = 0; i < m_aLines.size(); i++) {
            ...
            m_jTicketEdit.addTicketLine2(oNewLine);			// Isto estava comentado (ATB)(2013-01-08)			
        }
    ...
    private void m_jbtnAddLineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jbtnAddLineActionPerformed
        ...
        if (index >= 0) {
            ...
            TicketLineInfo oNewLine = new TicketLineInfo(oLine);            
            oNewLine.setMultiply(-oLine.getMultiply());
            m_jTicketEdit.addTicketLine2(oNewLine);			// (ATB)(2013-01-08) Isto estava comentado
        }        
