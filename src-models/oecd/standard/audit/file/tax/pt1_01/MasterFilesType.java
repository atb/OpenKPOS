 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.MasterFilesType#getGroup <em>Group</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.MasterFilesType#getGeneralLedger <em>General Ledger</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.MasterFilesType#getCustomer <em>Customer</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.MasterFilesType#getSupplier <em>Supplier</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.MasterFilesType#getProduct <em>Product</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.MasterFilesType#getTaxTable <em>Tax Table</em>}</li>
 * </ul>
 * </p>
 *
 * @see oecd.standard.audit.file.tax.pt1_01.Pt1_01Package#getMasterFilesType()
...
public interface MasterFilesType extends EObject {
	 ...
	 * @see oecd.standard.audit.file.tax.pt1_01.Pt1_01Package#getMasterFilesType_Group()
	 ...
	 * The list contents are of type {@link oecd.standard.audit.file.tax.pt1_01.GeneralLedgerType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see oecd.standard.audit.file.tax.pt1_01.Pt1_01Package#getMasterFilesType_GeneralLedger()
	 ...
	 * The list contents are of type {@link oecd.standard.audit.file.tax.pt1_01.CustomerType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see oecd.standard.audit.file.tax.pt1_01.Pt1_01Package#getMasterFilesType_Customer()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link oecd.standard.audit.file.tax.pt1_01.SupplierType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see oecd.standard.audit.file.tax.pt1_01.Pt1_01Package#getMasterFilesType_Supplier()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link oecd.standard.audit.file.tax.pt1_01.ProductType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see oecd.standard.audit.file.tax.pt1_01.Pt1_01Package#getMasterFilesType_Product()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link oecd.standard.audit.file.tax.pt1_01.TaxTableType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see oecd.standard.audit.file.tax.pt1_01.Pt1_01Package#getMasterFilesType_TaxTable()
	 * @model containment="true" transient="true" volatile="true" derived="true"
