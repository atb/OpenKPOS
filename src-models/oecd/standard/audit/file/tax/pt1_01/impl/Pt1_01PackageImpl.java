...
import oecd.standard.audit.file.tax.pt1_01.util.Pt1_01Validator;
 ...
 * @generated
 */
public class Pt1_01PackageImpl extends EPackageImpl implements Pt1_01Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see oecd.standard.audit.file.tax.pt1_01.Pt1_01Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Pt1_01PackageImpl() {
		super(eNS_URI, Pt1_01Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Pt1_01Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Pt1_01Package init() {
		if (isInited) return (Pt1_01Package)EPackage.Registry.INSTANCE.getEPackage(Pt1_01Package.eNS_URI);

		// Obtain or create and register package
		Pt1_01PackageImpl thePt1_01Package = (Pt1_01PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Pt1_01PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Pt1_01PackageImpl());
		...
		thePt1_01Package.createPackageContents();

		// Initialize created meta-data
		thePt1_01Package.initializePackageContents();
			...
			(thePt1_01Package, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return Pt1_01Validator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		thePt1_01Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Pt1_01Package.eNS_URI, thePt1_01Package);
		return thePt1_01Package;
	}
	 ...
	 * @generated
	 */
	public Pt1_01Factory getPt1_01Factory() {
		return (Pt1_01Factory)getEFactoryInstance();
	}
