 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.ShippingPointStructureImpl#getDeliveryID <em>Delivery ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.ShippingPointStructureImpl#getDeliveryDate <em>Delivery Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.ShippingPointStructureImpl#getAddress <em>Address</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ShippingPointStructureImpl extends EObjectImpl implements ShippingPointStructure {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.SHIPPING_POINT_STRUCTURE;
	}
	...
	public void setDeliveryID(String newDeliveryID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SHIPPING_POINT_STRUCTURE__DELIVERY_ID, oldDeliveryID, deliveryID));
	}
	...
	public void setDeliveryDate(XMLGregorianCalendar newDeliveryDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SHIPPING_POINT_STRUCTURE__DELIVERY_DATE, oldDeliveryDate, deliveryDate));
	}
	...
	public NotificationChain basicSetAddress(AddressStructure newAddress, NotificationChain msgs) {
		...
		address = newAddress;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.SHIPPING_POINT_STRUCTURE__ADDRESS, oldAddress, newAddress);
	...
	public void setAddress(AddressStructure newAddress) {
		if (newAddress != address) {
			...
			if (address != null)
				msgs = ((InternalEObject)address).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.SHIPPING_POINT_STRUCTURE__ADDRESS, null, msgs);
			if (newAddress != null)
				msgs = ((InternalEObject)newAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.SHIPPING_POINT_STRUCTURE__ADDRESS, null, msgs);
			msgs = basicSetAddress(newAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SHIPPING_POINT_STRUCTURE__ADDRESS, newAddress, newAddress));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pt1_01Package.SHIPPING_POINT_STRUCTURE__ADDRESS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01Package.SHIPPING_POINT_STRUCTURE__DELIVERY_ID:
				return getDeliveryID();
			case Pt1_01Package.SHIPPING_POINT_STRUCTURE__DELIVERY_DATE:
