 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineType1Impl#getRecordID <em>Record ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineType1Impl#getAccountID <em>Account ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineType1Impl#getSourceDocumentID <em>Source Document ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineType1Impl#getSystemEntryDate <em>System Entry Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineType1Impl#getDescription <em>Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineType1Impl#getDebitAmount <em>Debit Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineType1Impl#getCreditAmount <em>Credit Amount</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LineType1Impl extends EObjectImpl implements LineType1 {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.LINE_TYPE1;
	}
	...
	public void setRecordID(String newRecordID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE1__RECORD_ID, oldRecordID, recordID));
	}
	...
	public void setAccountID(String newAccountID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE1__ACCOUNT_ID, oldAccountID, accountID));
	}
	...
	public void setSourceDocumentID(String newSourceDocumentID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE1__SOURCE_DOCUMENT_ID, oldSourceDocumentID, sourceDocumentID));
	}
	...
	public void setSystemEntryDate(XMLGregorianCalendar newSystemEntryDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE1__SYSTEM_ENTRY_DATE, oldSystemEntryDate, systemEntryDate));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE1__DESCRIPTION, oldDescription, description));
	}
	...
	public void setDebitAmount(BigDecimal newDebitAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE1__DEBIT_AMOUNT, oldDebitAmount, debitAmount));
	}
	...
	public void setCreditAmount(BigDecimal newCreditAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE1__CREDIT_AMOUNT, oldCreditAmount, creditAmount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01Package.LINE_TYPE1__RECORD_ID:
				return getRecordID();
			case Pt1_01Package.LINE_TYPE1__ACCOUNT_ID:
				return getAccountID();
			case Pt1_01Package.LINE_TYPE1__SOURCE_DOCUMENT_ID:
				return getSourceDocumentID();
			case Pt1_01Package.LINE_TYPE1__SYSTEM_ENTRY_DATE:
				return getSystemEntryDate();
			case Pt1_01Package.LINE_TYPE1__DESCRIPTION:
				return getDescription();
			case Pt1_01Package.LINE_TYPE1__DEBIT_AMOUNT:
				return getDebitAmount();
			case Pt1_01Package.LINE_TYPE1__CREDIT_AMOUNT:
