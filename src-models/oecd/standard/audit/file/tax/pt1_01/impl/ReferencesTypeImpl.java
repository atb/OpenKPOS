 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.ReferencesTypeImpl#getCreditNote <em>Credit Note</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReferencesTypeImpl extends EObjectImpl implements ReferencesType {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.REFERENCES_TYPE;
	}
	...
	public NotificationChain basicSetCreditNote(CreditNoteType newCreditNote, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.REFERENCES_TYPE__CREDIT_NOTE, oldCreditNote, newCreditNote);
	...
	public void setCreditNote(CreditNoteType newCreditNote) {
		if (newCreditNote != creditNote) {
			...
			if (creditNote != null)
				msgs = ((InternalEObject)creditNote).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.REFERENCES_TYPE__CREDIT_NOTE, null, msgs);
			if (newCreditNote != null)
				msgs = ((InternalEObject)newCreditNote).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.REFERENCES_TYPE__CREDIT_NOTE, null, msgs);
			msgs = basicSetCreditNote(newCreditNote, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.REFERENCES_TYPE__CREDIT_NOTE, newCreditNote, newCreditNote));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pt1_01Package.REFERENCES_TYPE__CREDIT_NOTE:
