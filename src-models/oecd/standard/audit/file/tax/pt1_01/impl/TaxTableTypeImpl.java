 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.TaxTableTypeImpl#getTaxTableEntry <em>Tax Table Entry</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TaxTableTypeImpl extends EObjectImpl implements TaxTableType {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.TAX_TABLE_TYPE;
	}
	...
	public EList<TaxTableEntryType> getTaxTableEntry() {
		if (taxTableEntry == null) {
			taxTableEntry = new EObjectContainmentEList<TaxTableEntryType>(TaxTableEntryType.class, this, Pt1_01Package.TAX_TABLE_TYPE__TAX_TABLE_ENTRY);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pt1_01Package.TAX_TABLE_TYPE__TAX_TABLE_ENTRY:
