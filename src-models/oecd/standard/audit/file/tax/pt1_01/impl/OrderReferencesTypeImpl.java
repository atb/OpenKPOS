 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.OrderReferencesTypeImpl#getOriginatingON <em>Originating ON</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.OrderReferencesTypeImpl#getOrderDate <em>Order Date</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrderReferencesTypeImpl extends EObjectImpl implements OrderReferencesType {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.ORDER_REFERENCES_TYPE;
	}
	...
	public void setOriginatingON(String newOriginatingON) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.ORDER_REFERENCES_TYPE__ORIGINATING_ON, oldOriginatingON, originatingON));
	}
	...
	public void setOrderDate(XMLGregorianCalendar newOrderDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.ORDER_REFERENCES_TYPE__ORDER_DATE, oldOrderDate, orderDate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01Package.ORDER_REFERENCES_TYPE__ORIGINATING_ON:
				return getOriginatingON();
			case Pt1_01Package.ORDER_REFERENCES_TYPE__ORDER_DATE:
				return getOrderDate();
		}
