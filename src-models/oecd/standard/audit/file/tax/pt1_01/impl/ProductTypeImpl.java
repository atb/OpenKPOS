 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.ProductTypeImpl#getProductType <em>Product Type</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.ProductTypeImpl#getProductCode <em>Product Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.ProductTypeImpl#getProductGroup <em>Product Group</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.ProductTypeImpl#getProductDescription <em>Product Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.ProductTypeImpl#getProductNumberCode <em>Product Number Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProductTypeImpl extends EObjectImpl implements ProductType {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.PRODUCT_TYPE;
	}
	...
	public void setProductType(ProductTypeType newProductType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.PRODUCT_TYPE__PRODUCT_TYPE, oldProductType, productType, !oldProductTypeESet));
	}
	...
	public void unsetProductType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Pt1_01Package.PRODUCT_TYPE__PRODUCT_TYPE, oldProductType, PRODUCT_TYPE_EDEFAULT, oldProductTypeESet));
	}
	...
	public void setProductCode(String newProductCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.PRODUCT_TYPE__PRODUCT_CODE, oldProductCode, productCode));
	}
	...
	public void setProductGroup(String newProductGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.PRODUCT_TYPE__PRODUCT_GROUP, oldProductGroup, productGroup));
	}
	...
	public void setProductDescription(String newProductDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.PRODUCT_TYPE__PRODUCT_DESCRIPTION, oldProductDescription, productDescription));
	}
	...
	public void setProductNumberCode(String newProductNumberCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.PRODUCT_TYPE__PRODUCT_NUMBER_CODE, oldProductNumberCode, productNumberCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01Package.PRODUCT_TYPE__PRODUCT_TYPE:
				return getProductType();
			case Pt1_01Package.PRODUCT_TYPE__PRODUCT_CODE:
				return getProductCode();
			case Pt1_01Package.PRODUCT_TYPE__PRODUCT_GROUP:
				return getProductGroup();
			case Pt1_01Package.PRODUCT_TYPE__PRODUCT_DESCRIPTION:
				return getProductDescription();
			case Pt1_01Package.PRODUCT_TYPE__PRODUCT_NUMBER_CODE:
