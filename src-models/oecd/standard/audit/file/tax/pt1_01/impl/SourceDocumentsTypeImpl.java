 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SourceDocumentsTypeImpl#getSalesInvoices <em>Sales Invoices</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SourceDocumentsTypeImpl extends EObjectImpl implements SourceDocumentsType {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.SOURCE_DOCUMENTS_TYPE;
	}
	...
	public NotificationChain basicSetSalesInvoices(SalesInvoicesType newSalesInvoices, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.SOURCE_DOCUMENTS_TYPE__SALES_INVOICES, oldSalesInvoices, newSalesInvoices);
	...
	public void setSalesInvoices(SalesInvoicesType newSalesInvoices) {
		if (newSalesInvoices != salesInvoices) {
			...
			if (salesInvoices != null)
				msgs = ((InternalEObject)salesInvoices).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.SOURCE_DOCUMENTS_TYPE__SALES_INVOICES, null, msgs);
			if (newSalesInvoices != null)
				msgs = ((InternalEObject)newSalesInvoices).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.SOURCE_DOCUMENTS_TYPE__SALES_INVOICES, null, msgs);
			msgs = basicSetSalesInvoices(newSalesInvoices, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SOURCE_DOCUMENTS_TYPE__SALES_INVOICES, newSalesInvoices, newSalesInvoices));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pt1_01Package.SOURCE_DOCUMENTS_TYPE__SALES_INVOICES:
