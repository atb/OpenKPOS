 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CurrencyTypeImpl#getCurrencyCode <em>Currency Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CurrencyTypeImpl#getCurrencyCreditAmount <em>Currency Credit Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CurrencyTypeImpl#getCurrencyDebitAmount <em>Currency Debit Amount</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CurrencyTypeImpl extends EObjectImpl implements CurrencyType {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.CURRENCY_TYPE;
	}
	...
	public void setCurrencyCode(String newCurrencyCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CURRENCY_TYPE__CURRENCY_CODE, oldCurrencyCode, currencyCode));
	}
	...
	public void setCurrencyCreditAmount(BigDecimal newCurrencyCreditAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CURRENCY_TYPE__CURRENCY_CREDIT_AMOUNT, oldCurrencyCreditAmount, currencyCreditAmount));
	}
	...
	public void setCurrencyDebitAmount(BigDecimal newCurrencyDebitAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CURRENCY_TYPE__CURRENCY_DEBIT_AMOUNT, oldCurrencyDebitAmount, currencyDebitAmount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01Package.CURRENCY_TYPE__CURRENCY_CODE:
				return getCurrencyCode();
			case Pt1_01Package.CURRENCY_TYPE__CURRENCY_CREDIT_AMOUNT:
				return getCurrencyCreditAmount();
			case Pt1_01Package.CURRENCY_TYPE__CURRENCY_DEBIT_AMOUNT:
