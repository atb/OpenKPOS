 ...
 * @generated
 */
public class Pt1_01FactoryImpl extends EFactoryImpl implements Pt1_01Factory {
	/**
	 ...
	 * @generated
	 */
	public static Pt1_01Factory init() {
		try {
			Pt1_01Factory thePt1_01Factory = (Pt1_01Factory)EPackage.Registry.INSTANCE.getEFactory("urn:OECD:StandardAuditFile-Tax:PT_1.01_01"); 
			if (thePt1_01Factory != null) {
				return thePt1_01Factory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new Pt1_01FactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case Pt1_01Package.ADDRESS_STRUCTURE: return createAddressStructure();
			case Pt1_01Package.ADDRESS_STRUCTURE_PT: return createAddressStructurePT();
			case Pt1_01Package.AUDIT_FILE_TYPE: return createAuditFileType();
			case Pt1_01Package.CREDIT_NOTE_TYPE: return createCreditNoteType();
			case Pt1_01Package.CURRENCY_TYPE: return createCurrencyType();
			case Pt1_01Package.CUSTOMER_TYPE: return createCustomerType();
			case Pt1_01Package.DOCUMENT_ROOT: return createDocumentRoot();
			case Pt1_01Package.DOCUMENT_TOTALS_TYPE: return createDocumentTotalsType();
			case Pt1_01Package.GENERAL_LEDGER_ENTRIES_TYPE: return createGeneralLedgerEntriesType();
			case Pt1_01Package.GENERAL_LEDGER_TYPE: return createGeneralLedgerType();
			case Pt1_01Package.HEADER_TYPE: return createHeaderType();
			case Pt1_01Package.INVOICE_TYPE: return createInvoiceType();
			case Pt1_01Package.JOURNAL_TYPE: return createJournalType();
			case Pt1_01Package.LINE_TYPE: return createLineType();
			case Pt1_01Package.LINE_TYPE1: return createLineType1();
			case Pt1_01Package.MASTER_FILES_TYPE: return createMasterFilesType();
			case Pt1_01Package.ORDER_REFERENCES_TYPE: return createOrderReferencesType();
			case Pt1_01Package.PRODUCT_TYPE: return createProductType();
			case Pt1_01Package.REFERENCES_TYPE: return createReferencesType();
			case Pt1_01Package.SALES_INVOICES_TYPE: return createSalesInvoicesType();
			case Pt1_01Package.SETTLEMENT_TYPE: return createSettlementType();
			case Pt1_01Package.SHIPPING_POINT_STRUCTURE: return createShippingPointStructure();
			case Pt1_01Package.SOURCE_DOCUMENTS_TYPE: return createSourceDocumentsType();
			case Pt1_01Package.SUPPLIER_ADDRESS_STRUCTURE: return createSupplierAddressStructure();
			case Pt1_01Package.SUPPLIER_TYPE: return createSupplierType();
			case Pt1_01Package.TAX_TABLE_ENTRY_TYPE: return createTaxTableEntryType();
			case Pt1_01Package.TAX_TABLE_TYPE: return createTaxTableType();
			case Pt1_01Package.TAX_TYPE: return createTaxType();
			case Pt1_01Package.TRANSACTION_TYPE: return createTransactionType();
			default:
	...
	public InvoiceStatusType createInvoiceStatusTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createInvoiceStatusTypeFromString(Pt1_01Package.Literals.INVOICE_STATUS_TYPE, initialValue);
	}
	...
	public String convertInvoiceStatusTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertInvoiceStatusTypeToString(Pt1_01Package.Literals.INVOICE_STATUS_TYPE, instanceValue);
	}
	...
	public InvoiceTypeType createInvoiceTypeTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createInvoiceTypeTypeFromString(Pt1_01Package.Literals.INVOICE_TYPE_TYPE, initialValue);
	}
	...
	public String convertInvoiceTypeTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertInvoiceTypeTypeToString(Pt1_01Package.Literals.INVOICE_TYPE_TYPE, instanceValue);
	}
	...
	public PaymentMechanismType createPaymentMechanismTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createPaymentMechanismTypeFromString(Pt1_01Package.Literals.PAYMENT_MECHANISM_TYPE, initialValue);
	}
	...
	public String convertPaymentMechanismTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertPaymentMechanismTypeToString(Pt1_01Package.Literals.PAYMENT_MECHANISM_TYPE, instanceValue);
	}
	...
	public ProductTypeType createProductTypeTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createProductTypeTypeFromString(Pt1_01Package.Literals.PRODUCT_TYPE_TYPE, initialValue);
	}
	...
	public String convertProductTypeTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertProductTypeTypeToString(Pt1_01Package.Literals.PRODUCT_TYPE_TYPE, instanceValue);
	}
	...
	public TaxAccountingBasisType createTaxAccountingBasisTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createTaxAccountingBasisTypeFromString(Pt1_01Package.Literals.TAX_ACCOUNTING_BASIS_TYPE, initialValue);
	}
	...
	public String convertTaxAccountingBasisTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertTaxAccountingBasisTypeToString(Pt1_01Package.Literals.TAX_ACCOUNTING_BASIS_TYPE, instanceValue);
	}
	...
	public TaxTypeType createTaxTypeTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createTaxTypeTypeFromString(Pt1_01Package.Literals.TAX_TYPE_TYPE, initialValue);
	}
	...
	public String convertTaxTypeTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertTaxTypeTypeToString(Pt1_01Package.Literals.TAX_TYPE_TYPE, instanceValue);
	}
	...
	public TransactionTypeType createTransactionTypeTypeObjectFromString(EDataType eDataType, String initialValue) {
		return createTransactionTypeTypeFromString(Pt1_01Package.Literals.TRANSACTION_TYPE_TYPE, initialValue);
	}
	...
	public String convertTransactionTypeTypeObjectToString(EDataType eDataType, Object instanceValue) {
		return convertTransactionTypeTypeToString(Pt1_01Package.Literals.TRANSACTION_TYPE_TYPE, instanceValue);
	}
	 ...
	 * @generated
	 */
	public Pt1_01Package getPt1_01Package() {
		return (Pt1_01Package)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static Pt1_01Package getPackage() {
