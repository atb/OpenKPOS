 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getLineNumber <em>Line Number</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getOrderReferences <em>Order References</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getProductCode <em>Product Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getProductDescription <em>Product Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getUnitOfMeasure <em>Unit Of Measure</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getTaxPointDate <em>Tax Point Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getReferences <em>References</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getDebitAmount <em>Debit Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getCreditAmount <em>Credit Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getTax <em>Tax</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getTaxExemptionReason <em>Tax Exemption Reason</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.LineTypeImpl#getSettlementAmount <em>Settlement Amount</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LineTypeImpl extends EObjectImpl implements LineType {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.LINE_TYPE;
	}
	...
	public void setLineNumber(BigInteger newLineNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__LINE_NUMBER, oldLineNumber, lineNumber));
	}
	...
	public EList<OrderReferencesType> getOrderReferences() {
		if (orderReferences == null) {
			orderReferences = new EObjectContainmentEList<OrderReferencesType>(OrderReferencesType.class, this, Pt1_01Package.LINE_TYPE__ORDER_REFERENCES);
		}
	...
	public void setProductCode(String newProductCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__PRODUCT_CODE, oldProductCode, productCode));
	}
	...
	public void setProductDescription(String newProductDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__PRODUCT_DESCRIPTION, oldProductDescription, productDescription));
	}
	...
	public void setQuantity(BigDecimal newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__QUANTITY, oldQuantity, quantity));
	}
	...
	public void setUnitOfMeasure(String newUnitOfMeasure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__UNIT_OF_MEASURE, oldUnitOfMeasure, unitOfMeasure));
	}
	...
	public void setUnitPrice(BigDecimal newUnitPrice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__UNIT_PRICE, oldUnitPrice, unitPrice));
	}
	...
	public void setTaxPointDate(XMLGregorianCalendar newTaxPointDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__TAX_POINT_DATE, oldTaxPointDate, taxPointDate));
	}
	...
	public NotificationChain basicSetReferences(ReferencesType newReferences, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__REFERENCES, oldReferences, newReferences);
	...
	public void setReferences(ReferencesType newReferences) {
		if (newReferences != references) {
			...
			if (references != null)
				msgs = ((InternalEObject)references).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.LINE_TYPE__REFERENCES, null, msgs);
			if (newReferences != null)
				msgs = ((InternalEObject)newReferences).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.LINE_TYPE__REFERENCES, null, msgs);
			msgs = basicSetReferences(newReferences, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__REFERENCES, newReferences, newReferences));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setDebitAmount(BigDecimal newDebitAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__DEBIT_AMOUNT, oldDebitAmount, debitAmount));
	}
	...
	public void setCreditAmount(BigDecimal newCreditAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__CREDIT_AMOUNT, oldCreditAmount, creditAmount));
	}
	...
	public NotificationChain basicSetTax(TaxType newTax, NotificationChain msgs) {
		...
		tax = newTax;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__TAX, oldTax, newTax);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTax(TaxType newTax) {
		if (newTax != tax) {
			NotificationChain msgs = null;
			if (tax != null)
				msgs = ((InternalEObject)tax).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.LINE_TYPE__TAX, null, msgs);
			if (newTax != null)
				msgs = ((InternalEObject)newTax).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.LINE_TYPE__TAX, null, msgs);
			msgs = basicSetTax(newTax, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__TAX, newTax, newTax));
	}
	...
	public void setTaxExemptionReason(String newTaxExemptionReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__TAX_EXEMPTION_REASON, oldTaxExemptionReason, taxExemptionReason));
	}
	...
	public void setSettlementAmount(BigDecimal newSettlementAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.LINE_TYPE__SETTLEMENT_AMOUNT, oldSettlementAmount, settlementAmount));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pt1_01Package.LINE_TYPE__ORDER_REFERENCES:
				return ((InternalEList<?>)getOrderReferences()).basicRemove(otherEnd, msgs);
			case Pt1_01Package.LINE_TYPE__REFERENCES:
				return basicSetReferences(null, msgs);
			case Pt1_01Package.LINE_TYPE__TAX:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01Package.LINE_TYPE__LINE_NUMBER:
				return getLineNumber();
			case Pt1_01Package.LINE_TYPE__ORDER_REFERENCES:
				return getOrderReferences();
			case Pt1_01Package.LINE_TYPE__PRODUCT_CODE:
				return getProductCode();
			case Pt1_01Package.LINE_TYPE__PRODUCT_DESCRIPTION:
				return getProductDescription();
			case Pt1_01Package.LINE_TYPE__QUANTITY:
				return getQuantity();
			case Pt1_01Package.LINE_TYPE__UNIT_OF_MEASURE:
				return getUnitOfMeasure();
			case Pt1_01Package.LINE_TYPE__UNIT_PRICE:
				return getUnitPrice();
			case Pt1_01Package.LINE_TYPE__TAX_POINT_DATE:
				return getTaxPointDate();
			case Pt1_01Package.LINE_TYPE__REFERENCES:
				return getReferences();
			case Pt1_01Package.LINE_TYPE__DESCRIPTION:
				return getDescription();
			case Pt1_01Package.LINE_TYPE__DEBIT_AMOUNT:
				return getDebitAmount();
			case Pt1_01Package.LINE_TYPE__CREDIT_AMOUNT:
				return getCreditAmount();
			case Pt1_01Package.LINE_TYPE__TAX:
				return getTax();
			case Pt1_01Package.LINE_TYPE__TAX_EXEMPTION_REASON:
				return getTaxExemptionReason();
			case Pt1_01Package.LINE_TYPE__SETTLEMENT_AMOUNT:
