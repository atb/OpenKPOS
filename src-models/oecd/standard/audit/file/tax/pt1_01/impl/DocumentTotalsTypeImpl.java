 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.DocumentTotalsTypeImpl#getTaxPayable <em>Tax Payable</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.DocumentTotalsTypeImpl#getNetTotal <em>Net Total</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.DocumentTotalsTypeImpl#getGrossTotal <em>Gross Total</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.DocumentTotalsTypeImpl#getCurrency <em>Currency</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.DocumentTotalsTypeImpl#getSettlement <em>Settlement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentTotalsTypeImpl extends EObjectImpl implements DocumentTotalsType {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.DOCUMENT_TOTALS_TYPE;
	}
	...
	public void setTaxPayable(BigDecimal newTaxPayable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.DOCUMENT_TOTALS_TYPE__TAX_PAYABLE, oldTaxPayable, taxPayable));
	}
	...
	public void setNetTotal(BigDecimal newNetTotal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.DOCUMENT_TOTALS_TYPE__NET_TOTAL, oldNetTotal, netTotal));
	}
	...
	public void setGrossTotal(BigDecimal newGrossTotal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.DOCUMENT_TOTALS_TYPE__GROSS_TOTAL, oldGrossTotal, grossTotal));
	}
	...
	public NotificationChain basicSetCurrency(CurrencyType newCurrency, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.DOCUMENT_TOTALS_TYPE__CURRENCY, oldCurrency, newCurrency);
	...
	public void setCurrency(CurrencyType newCurrency) {
		if (newCurrency != currency) {
			...
			if (currency != null)
				msgs = ((InternalEObject)currency).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.DOCUMENT_TOTALS_TYPE__CURRENCY, null, msgs);
			if (newCurrency != null)
				msgs = ((InternalEObject)newCurrency).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.DOCUMENT_TOTALS_TYPE__CURRENCY, null, msgs);
			msgs = basicSetCurrency(newCurrency, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.DOCUMENT_TOTALS_TYPE__CURRENCY, newCurrency, newCurrency));
	}
	...
	public NotificationChain basicSetSettlement(SettlementType newSettlement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.DOCUMENT_TOTALS_TYPE__SETTLEMENT, oldSettlement, newSettlement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSettlement(SettlementType newSettlement) {
		if (newSettlement != settlement) {
			NotificationChain msgs = null;
			if (settlement != null)
				msgs = ((InternalEObject)settlement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.DOCUMENT_TOTALS_TYPE__SETTLEMENT, null, msgs);
			if (newSettlement != null)
				msgs = ((InternalEObject)newSettlement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.DOCUMENT_TOTALS_TYPE__SETTLEMENT, null, msgs);
			msgs = basicSetSettlement(newSettlement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.DOCUMENT_TOTALS_TYPE__SETTLEMENT, newSettlement, newSettlement));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pt1_01Package.DOCUMENT_TOTALS_TYPE__CURRENCY:
				return basicSetCurrency(null, msgs);
			case Pt1_01Package.DOCUMENT_TOTALS_TYPE__SETTLEMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01Package.DOCUMENT_TOTALS_TYPE__TAX_PAYABLE:
				return getTaxPayable();
			case Pt1_01Package.DOCUMENT_TOTALS_TYPE__NET_TOTAL:
				return getNetTotal();
			case Pt1_01Package.DOCUMENT_TOTALS_TYPE__GROSS_TOTAL:
