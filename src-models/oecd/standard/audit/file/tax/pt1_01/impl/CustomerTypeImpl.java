 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CustomerTypeImpl#getCustomerID <em>Customer ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CustomerTypeImpl#getAccountID <em>Account ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CustomerTypeImpl#getCustomerTaxID <em>Customer Tax ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CustomerTypeImpl#getCompanyName <em>Company Name</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CustomerTypeImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CustomerTypeImpl#getBillingAddress <em>Billing Address</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CustomerTypeImpl#getShipToAddress <em>Ship To Address</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CustomerTypeImpl#getTelephone <em>Telephone</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CustomerTypeImpl#getFax <em>Fax</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CustomerTypeImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CustomerTypeImpl#getWebsite <em>Website</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.CustomerTypeImpl#getSelfBillingIndicator <em>Self Billing Indicator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CustomerTypeImpl extends EObjectImpl implements CustomerType {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.CUSTOMER_TYPE;
	}
	...
	public void setCustomerID(String newCustomerID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__CUSTOMER_ID, oldCustomerID, customerID));
	}
	...
	public void setAccountID(String newAccountID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__ACCOUNT_ID, oldAccountID, accountID));
	}
	...
	public void setCustomerTaxID(String newCustomerTaxID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__CUSTOMER_TAX_ID, oldCustomerTaxID, customerTaxID));
	}
	...
	public void setCompanyName(String newCompanyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__COMPANY_NAME, oldCompanyName, companyName));
	}
	...
	public void setContact(String newContact) {
		...
		contact = newContact;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__CONTACT, oldContact, contact));
	}
	...
	public NotificationChain basicSetBillingAddress(AddressStructure newBillingAddress, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__BILLING_ADDRESS, oldBillingAddress, newBillingAddress);
	...
	public void setBillingAddress(AddressStructure newBillingAddress) {
		if (newBillingAddress != billingAddress) {
			...
			if (billingAddress != null)
				msgs = ((InternalEObject)billingAddress).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.CUSTOMER_TYPE__BILLING_ADDRESS, null, msgs);
			if (newBillingAddress != null)
				msgs = ((InternalEObject)newBillingAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.CUSTOMER_TYPE__BILLING_ADDRESS, null, msgs);
			msgs = basicSetBillingAddress(newBillingAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__BILLING_ADDRESS, newBillingAddress, newBillingAddress));
	}
	...
	public NotificationChain basicSetShipToAddress(AddressStructure newShipToAddress, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__SHIP_TO_ADDRESS, oldShipToAddress, newShipToAddress);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setShipToAddress(AddressStructure newShipToAddress) {
		if (newShipToAddress != shipToAddress) {
			...
			if (shipToAddress != null)
				msgs = ((InternalEObject)shipToAddress).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.CUSTOMER_TYPE__SHIP_TO_ADDRESS, null, msgs);
			if (newShipToAddress != null)
				msgs = ((InternalEObject)newShipToAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.CUSTOMER_TYPE__SHIP_TO_ADDRESS, null, msgs);
			msgs = basicSetShipToAddress(newShipToAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__SHIP_TO_ADDRESS, newShipToAddress, newShipToAddress));
	}
	...
	public void setTelephone(String newTelephone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__TELEPHONE, oldTelephone, telephone));
	}
	...
	public void setFax(String newFax) {
		...
		fax = newFax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__FAX, oldFax, fax));
	}
	...
	public void setEmail(String newEmail) {
		...
		email = newEmail;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__EMAIL, oldEmail, email));
	}
	...
	public void setWebsite(String newWebsite) {
		...
		website = newWebsite;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__WEBSITE, oldWebsite, website));
	}
	...
	public void setSelfBillingIndicator(BigInteger newSelfBillingIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.CUSTOMER_TYPE__SELF_BILLING_INDICATOR, oldSelfBillingIndicator, selfBillingIndicator));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pt1_01Package.CUSTOMER_TYPE__BILLING_ADDRESS:
				return basicSetBillingAddress(null, msgs);
			case Pt1_01Package.CUSTOMER_TYPE__SHIP_TO_ADDRESS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01Package.CUSTOMER_TYPE__CUSTOMER_ID:
				return getCustomerID();
			case Pt1_01Package.CUSTOMER_TYPE__ACCOUNT_ID:
				return getAccountID();
			case Pt1_01Package.CUSTOMER_TYPE__CUSTOMER_TAX_ID:
				return getCustomerTaxID();
			case Pt1_01Package.CUSTOMER_TYPE__COMPANY_NAME:
				return getCompanyName();
			case Pt1_01Package.CUSTOMER_TYPE__CONTACT:
				return getContact();
			case Pt1_01Package.CUSTOMER_TYPE__BILLING_ADDRESS:
				return getBillingAddress();
			case Pt1_01Package.CUSTOMER_TYPE__SHIP_TO_ADDRESS:
				return getShipToAddress();
			case Pt1_01Package.CUSTOMER_TYPE__TELEPHONE:
				return getTelephone();
			case Pt1_01Package.CUSTOMER_TYPE__FAX:
				return getFax();
			case Pt1_01Package.CUSTOMER_TYPE__EMAIL:
				return getEmail();
			case Pt1_01Package.CUSTOMER_TYPE__WEBSITE:
				return getWebsite();
			case Pt1_01Package.CUSTOMER_TYPE__SELF_BILLING_INDICATOR:
