...
import oecd.standard.audit.file.tax.pt1_01.DocumentTotalsType;
...
import oecd.standard.audit.file.tax.pt1_01.LineType;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getInvoiceNo <em>Invoice No</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getInvoiceStatus <em>Invoice Status</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getHash <em>Hash</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getHashControl <em>Hash Control</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getInvoiceDate <em>Invoice Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getInvoiceType <em>Invoice Type</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getSelfBillingIndicator <em>Self Billing Indicator</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getSystemEntryDate <em>System Entry Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getTransactionID <em>Transaction ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getCustomerID <em>Customer ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getShipTo <em>Ship To</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getShipFrom <em>Ship From</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getLine <em>Line</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.InvoiceTypeImpl#getDocumentTotals <em>Document Totals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InvoiceTypeImpl extends EObjectImpl implements InvoiceType {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.INVOICE_TYPE;
	}
	...
	public void setInvoiceNo(String newInvoiceNo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__INVOICE_NO, oldInvoiceNo, invoiceNo));
	}
	...
	public void setInvoiceStatus(InvoiceStatusType newInvoiceStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__INVOICE_STATUS, oldInvoiceStatus, invoiceStatus, !oldInvoiceStatusESet));
	}
	...
	public void unsetInvoiceStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Pt1_01Package.INVOICE_TYPE__INVOICE_STATUS, oldInvoiceStatus, INVOICE_STATUS_EDEFAULT, oldInvoiceStatusESet));
	}
	...
	public void setHash(String newHash) {
		...
		hash = newHash;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__HASH, oldHash, hash));
	}
	...
	public void setHashControl(String newHashControl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__HASH_CONTROL, oldHashControl, hashControl));
	}
	...
	public void setPeriod(BigInteger newPeriod) {
		...
		period = newPeriod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__PERIOD, oldPeriod, period));
	}
	...
	public void setInvoiceDate(XMLGregorianCalendar newInvoiceDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__INVOICE_DATE, oldInvoiceDate, invoiceDate));
	}
	...
	public void setInvoiceType(InvoiceTypeType newInvoiceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__INVOICE_TYPE, oldInvoiceType, invoiceType, !oldInvoiceTypeESet));
	}
	...
	public void unsetInvoiceType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Pt1_01Package.INVOICE_TYPE__INVOICE_TYPE, oldInvoiceType, INVOICE_TYPE_EDEFAULT, oldInvoiceTypeESet));
	}
	...
	public void setSelfBillingIndicator(BigInteger newSelfBillingIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__SELF_BILLING_INDICATOR, oldSelfBillingIndicator, selfBillingIndicator));
	}
	...
	public void setSystemEntryDate(XMLGregorianCalendar newSystemEntryDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__SYSTEM_ENTRY_DATE, oldSystemEntryDate, systemEntryDate));
	}
	...
	public void setTransactionID(String newTransactionID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__TRANSACTION_ID, oldTransactionID, transactionID));
	}
	...
	public void setCustomerID(String newCustomerID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__CUSTOMER_ID, oldCustomerID, customerID));
	}
	...
	public NotificationChain basicSetShipTo(ShippingPointStructure newShipTo, NotificationChain msgs) {
		...
		shipTo = newShipTo;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__SHIP_TO, oldShipTo, newShipTo);
	...
	public void setShipTo(ShippingPointStructure newShipTo) {
		if (newShipTo != shipTo) {
			...
			if (shipTo != null)
				msgs = ((InternalEObject)shipTo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.INVOICE_TYPE__SHIP_TO, null, msgs);
			if (newShipTo != null)
				msgs = ((InternalEObject)newShipTo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.INVOICE_TYPE__SHIP_TO, null, msgs);
			msgs = basicSetShipTo(newShipTo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__SHIP_TO, newShipTo, newShipTo));
	}
	...
	public NotificationChain basicSetShipFrom(ShippingPointStructure newShipFrom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__SHIP_FROM, oldShipFrom, newShipFrom);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setShipFrom(ShippingPointStructure newShipFrom) {
		if (newShipFrom != shipFrom) {
			NotificationChain msgs = null;
			if (shipFrom != null)
				msgs = ((InternalEObject)shipFrom).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.INVOICE_TYPE__SHIP_FROM, null, msgs);
			if (newShipFrom != null)
				msgs = ((InternalEObject)newShipFrom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.INVOICE_TYPE__SHIP_FROM, null, msgs);
			msgs = basicSetShipFrom(newShipFrom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__SHIP_FROM, newShipFrom, newShipFrom));
	}
	...
	public EList<LineType> getLine() {
		if (line == null) {
			line = new EObjectContainmentEList<LineType>(LineType.class, this, Pt1_01Package.INVOICE_TYPE__LINE);
		}
		return line;
	}
	...
	public NotificationChain basicSetDocumentTotals(DocumentTotalsType newDocumentTotals, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__DOCUMENT_TOTALS, oldDocumentTotals, newDocumentTotals);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDocumentTotals(DocumentTotalsType newDocumentTotals) {
		if (newDocumentTotals != documentTotals) {
			...
			if (documentTotals != null)
				msgs = ((InternalEObject)documentTotals).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.INVOICE_TYPE__DOCUMENT_TOTALS, null, msgs);
			if (newDocumentTotals != null)
				msgs = ((InternalEObject)newDocumentTotals).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.INVOICE_TYPE__DOCUMENT_TOTALS, null, msgs);
			msgs = basicSetDocumentTotals(newDocumentTotals, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.INVOICE_TYPE__DOCUMENT_TOTALS, newDocumentTotals, newDocumentTotals));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pt1_01Package.INVOICE_TYPE__SHIP_TO:
				return basicSetShipTo(null, msgs);
			case Pt1_01Package.INVOICE_TYPE__SHIP_FROM:
				return basicSetShipFrom(null, msgs);
			case Pt1_01Package.INVOICE_TYPE__LINE:
				return ((InternalEList<?>)getLine()).basicRemove(otherEnd, msgs);
			case Pt1_01Package.INVOICE_TYPE__DOCUMENT_TOTALS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01Package.INVOICE_TYPE__INVOICE_NO:
				return getInvoiceNo();
			case Pt1_01Package.INVOICE_TYPE__INVOICE_STATUS:
				return getInvoiceStatus();
			case Pt1_01Package.INVOICE_TYPE__HASH:
				return getHash();
			case Pt1_01Package.INVOICE_TYPE__HASH_CONTROL:
				return getHashControl();
			case Pt1_01Package.INVOICE_TYPE__PERIOD:
				return getPeriod();
			case Pt1_01Package.INVOICE_TYPE__INVOICE_DATE:
				return getInvoiceDate();
			case Pt1_01Package.INVOICE_TYPE__INVOICE_TYPE:
				return getInvoiceType();
			case Pt1_01Package.INVOICE_TYPE__SELF_BILLING_INDICATOR:
				return getSelfBillingIndicator();
			case Pt1_01Package.INVOICE_TYPE__SYSTEM_ENTRY_DATE:
				return getSystemEntryDate();
			case Pt1_01Package.INVOICE_TYPE__TRANSACTION_ID:
				return getTransactionID();
			case Pt1_01Package.INVOICE_TYPE__CUSTOMER_ID:
