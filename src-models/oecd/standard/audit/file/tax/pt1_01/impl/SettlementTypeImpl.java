 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SettlementTypeImpl#getSettlementDiscount <em>Settlement Discount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SettlementTypeImpl#getSettlementAmount <em>Settlement Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SettlementTypeImpl#getSettlementDate <em>Settlement Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SettlementTypeImpl#getPaymentMechanism <em>Payment Mechanism</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SettlementTypeImpl extends EObjectImpl implements SettlementType {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.SETTLEMENT_TYPE;
	}
	...
	public void setSettlementDiscount(String newSettlementDiscount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SETTLEMENT_TYPE__SETTLEMENT_DISCOUNT, oldSettlementDiscount, settlementDiscount));
	}
	...
	public void setSettlementAmount(BigDecimal newSettlementAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SETTLEMENT_TYPE__SETTLEMENT_AMOUNT, oldSettlementAmount, settlementAmount));
	}
	...
	public void setSettlementDate(XMLGregorianCalendar newSettlementDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SETTLEMENT_TYPE__SETTLEMENT_DATE, oldSettlementDate, settlementDate));
	}
	...
	public void setPaymentMechanism(PaymentMechanismType newPaymentMechanism) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SETTLEMENT_TYPE__PAYMENT_MECHANISM, oldPaymentMechanism, paymentMechanism, !oldPaymentMechanismESet));
	}
	...
	public void unsetPaymentMechanism() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Pt1_01Package.SETTLEMENT_TYPE__PAYMENT_MECHANISM, oldPaymentMechanism, PAYMENT_MECHANISM_EDEFAULT, oldPaymentMechanismESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01Package.SETTLEMENT_TYPE__SETTLEMENT_DISCOUNT:
				return getSettlementDiscount();
			case Pt1_01Package.SETTLEMENT_TYPE__SETTLEMENT_AMOUNT:
				return getSettlementAmount();
			case Pt1_01Package.SETTLEMENT_TYPE__SETTLEMENT_DATE:
				return getSettlementDate();
			case Pt1_01Package.SETTLEMENT_TYPE__PAYMENT_MECHANISM:
