...
import oecd.standard.audit.file.tax.pt1_01.SupplierAddressStructure;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SupplierTypeImpl#getSupplierID <em>Supplier ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SupplierTypeImpl#getAccountID <em>Account ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SupplierTypeImpl#getSupplierTaxID <em>Supplier Tax ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SupplierTypeImpl#getCompanyName <em>Company Name</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SupplierTypeImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SupplierTypeImpl#getBillingAddress <em>Billing Address</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SupplierTypeImpl#getShipFromAddress <em>Ship From Address</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SupplierTypeImpl#getTelephone <em>Telephone</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SupplierTypeImpl#getFax <em>Fax</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SupplierTypeImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SupplierTypeImpl#getWebsite <em>Website</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01.impl.SupplierTypeImpl#getSelfBillingIndicator <em>Self Billing Indicator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SupplierTypeImpl extends EObjectImpl implements SupplierType {
	...
	protected EClass eStaticClass() {
		return Pt1_01Package.Literals.SUPPLIER_TYPE;
	}
	...
	public void setSupplierID(String newSupplierID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__SUPPLIER_ID, oldSupplierID, supplierID));
	}
	...
	public void setAccountID(String newAccountID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__ACCOUNT_ID, oldAccountID, accountID));
	}
	...
	public void setSupplierTaxID(String newSupplierTaxID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__SUPPLIER_TAX_ID, oldSupplierTaxID, supplierTaxID));
	}
	...
	public void setCompanyName(String newCompanyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__COMPANY_NAME, oldCompanyName, companyName));
	}
	...
	public void setContact(String newContact) {
		...
		contact = newContact;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__CONTACT, oldContact, contact));
	}
	...
	public NotificationChain basicSetBillingAddress(SupplierAddressStructure newBillingAddress, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__BILLING_ADDRESS, oldBillingAddress, newBillingAddress);
	...
	public void setBillingAddress(SupplierAddressStructure newBillingAddress) {
		if (newBillingAddress != billingAddress) {
			...
			if (billingAddress != null)
				msgs = ((InternalEObject)billingAddress).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.SUPPLIER_TYPE__BILLING_ADDRESS, null, msgs);
			if (newBillingAddress != null)
				msgs = ((InternalEObject)newBillingAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.SUPPLIER_TYPE__BILLING_ADDRESS, null, msgs);
			msgs = basicSetBillingAddress(newBillingAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__BILLING_ADDRESS, newBillingAddress, newBillingAddress));
	}
	...
	public NotificationChain basicSetShipFromAddress(SupplierAddressStructure newShipFromAddress, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__SHIP_FROM_ADDRESS, oldShipFromAddress, newShipFromAddress);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setShipFromAddress(SupplierAddressStructure newShipFromAddress) {
		if (newShipFromAddress != shipFromAddress) {
			...
			if (shipFromAddress != null)
				msgs = ((InternalEObject)shipFromAddress).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.SUPPLIER_TYPE__SHIP_FROM_ADDRESS, null, msgs);
			if (newShipFromAddress != null)
				msgs = ((InternalEObject)newShipFromAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pt1_01Package.SUPPLIER_TYPE__SHIP_FROM_ADDRESS, null, msgs);
			msgs = basicSetShipFromAddress(newShipFromAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__SHIP_FROM_ADDRESS, newShipFromAddress, newShipFromAddress));
	}
	...
	public void setTelephone(String newTelephone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__TELEPHONE, oldTelephone, telephone));
	}
	...
	public void setFax(String newFax) {
		...
		fax = newFax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__FAX, oldFax, fax));
	}
	...
	public void setEmail(String newEmail) {
		...
		email = newEmail;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__EMAIL, oldEmail, email));
	}
	...
	public void setWebsite(String newWebsite) {
		...
		website = newWebsite;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__WEBSITE, oldWebsite, website));
	}
	...
	public void setSelfBillingIndicator(BigInteger newSelfBillingIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01Package.SUPPLIER_TYPE__SELF_BILLING_INDICATOR, oldSelfBillingIndicator, selfBillingIndicator));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pt1_01Package.SUPPLIER_TYPE__BILLING_ADDRESS:
				return basicSetBillingAddress(null, msgs);
			case Pt1_01Package.SUPPLIER_TYPE__SHIP_FROM_ADDRESS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01Package.SUPPLIER_TYPE__SUPPLIER_ID:
				return getSupplierID();
			case Pt1_01Package.SUPPLIER_TYPE__ACCOUNT_ID:
				return getAccountID();
			case Pt1_01Package.SUPPLIER_TYPE__SUPPLIER_TAX_ID:
				return getSupplierTaxID();
			case Pt1_01Package.SUPPLIER_TYPE__COMPANY_NAME:
				return getCompanyName();
			case Pt1_01Package.SUPPLIER_TYPE__CONTACT:
				return getContact();
			case Pt1_01Package.SUPPLIER_TYPE__BILLING_ADDRESS:
				return getBillingAddress();
			case Pt1_01Package.SUPPLIER_TYPE__SHIP_FROM_ADDRESS:
				return getShipFromAddress();
			case Pt1_01Package.SUPPLIER_TYPE__TELEPHONE:
				return getTelephone();
			case Pt1_01Package.SUPPLIER_TYPE__FAX:
				return getFax();
			case Pt1_01Package.SUPPLIER_TYPE__EMAIL:
				return getEmail();
			case Pt1_01Package.SUPPLIER_TYPE__WEBSITE:
				return getWebsite();
			case Pt1_01Package.SUPPLIER_TYPE__SELF_BILLING_INDICATOR:
