 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.SalesInvoicesTypeImpl#getNumberOfEntries <em>Number Of Entries</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.SalesInvoicesTypeImpl#getTotalDebit <em>Total Debit</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.SalesInvoicesTypeImpl#getTotalCredit <em>Total Credit</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.SalesInvoicesTypeImpl#getInvoice <em>Invoice</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SalesInvoicesTypeImpl extends EObjectImpl implements SalesInvoicesType {
	...
	protected EClass eStaticClass() {
		return Pt1_01_2Package.Literals.SALES_INVOICES_TYPE;
	}
	...
	public void setNumberOfEntries(BigInteger newNumberOfEntries) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.SALES_INVOICES_TYPE__NUMBER_OF_ENTRIES, oldNumberOfEntries, numberOfEntries));
	}
	...
	public void setTotalDebit(BigDecimal newTotalDebit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.SALES_INVOICES_TYPE__TOTAL_DEBIT, oldTotalDebit, totalDebit));
	}
	...
	public void setTotalCredit(BigDecimal newTotalCredit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.SALES_INVOICES_TYPE__TOTAL_CREDIT, oldTotalCredit, totalCredit));
	}
	...
	public EList<InvoiceType> getInvoice() {
		if (invoice == null) {
			invoice = new EObjectContainmentEList<InvoiceType>(InvoiceType.class, this, Pt1_01_2Package.SALES_INVOICES_TYPE__INVOICE);
		}
		return invoice;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pt1_01_2Package.SALES_INVOICES_TYPE__INVOICE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01_2Package.SALES_INVOICES_TYPE__NUMBER_OF_ENTRIES:
				return getNumberOfEntries();
			case Pt1_01_2Package.SALES_INVOICES_TYPE__TOTAL_DEBIT:
				return getTotalDebit();
			case Pt1_01_2Package.SALES_INVOICES_TYPE__TOTAL_CREDIT:
