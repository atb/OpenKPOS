 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.JournalTypeImpl#getJournalID <em>Journal ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.JournalTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.JournalTypeImpl#getTransaction <em>Transaction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JournalTypeImpl extends EObjectImpl implements JournalType {
	...
	protected EClass eStaticClass() {
		return Pt1_01_2Package.Literals.JOURNAL_TYPE;
	}
	...
	public void setJournalID(String newJournalID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.JOURNAL_TYPE__JOURNAL_ID, oldJournalID, journalID));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.JOURNAL_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<TransactionType> getTransaction() {
		if (transaction == null) {
			transaction = new EObjectContainmentEList<TransactionType>(TransactionType.class, this, Pt1_01_2Package.JOURNAL_TYPE__TRANSACTION);
		}
		return transaction;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pt1_01_2Package.JOURNAL_TYPE__TRANSACTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01_2Package.JOURNAL_TYPE__JOURNAL_ID:
				return getJournalID();
			case Pt1_01_2Package.JOURNAL_TYPE__DESCRIPTION:
