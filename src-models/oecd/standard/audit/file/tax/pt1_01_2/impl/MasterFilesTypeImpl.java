 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.MasterFilesTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.MasterFilesTypeImpl#getGeneralLedger <em>General Ledger</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.MasterFilesTypeImpl#getCustomer <em>Customer</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.MasterFilesTypeImpl#getSupplier <em>Supplier</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.MasterFilesTypeImpl#getProduct <em>Product</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.MasterFilesTypeImpl#getTaxTable <em>Tax Table</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MasterFilesTypeImpl extends EObjectImpl implements MasterFilesType {
	...
	protected EClass eStaticClass() {
		return Pt1_01_2Package.Literals.MASTER_FILES_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, Pt1_01_2Package.MASTER_FILES_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<GeneralLedgerType> getGeneralLedger() {
		return getGroup().list(Pt1_01_2Package.Literals.MASTER_FILES_TYPE__GENERAL_LEDGER);
	}
	...
	public EList<CustomerType> getCustomer() {
		return getGroup().list(Pt1_01_2Package.Literals.MASTER_FILES_TYPE__CUSTOMER);
	}
	...
	public EList<SupplierType> getSupplier() {
		return getGroup().list(Pt1_01_2Package.Literals.MASTER_FILES_TYPE__SUPPLIER);
	}
	...
	public EList<ProductType> getProduct() {
		return getGroup().list(Pt1_01_2Package.Literals.MASTER_FILES_TYPE__PRODUCT);
	}
	...
	public EList<TaxTableType> getTaxTable() {
		return getGroup().list(Pt1_01_2Package.Literals.MASTER_FILES_TYPE__TAX_TABLE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pt1_01_2Package.MASTER_FILES_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case Pt1_01_2Package.MASTER_FILES_TYPE__GENERAL_LEDGER:
				return ((InternalEList<?>)getGeneralLedger()).basicRemove(otherEnd, msgs);
			case Pt1_01_2Package.MASTER_FILES_TYPE__CUSTOMER:
				return ((InternalEList<?>)getCustomer()).basicRemove(otherEnd, msgs);
			case Pt1_01_2Package.MASTER_FILES_TYPE__SUPPLIER:
				return ((InternalEList<?>)getSupplier()).basicRemove(otherEnd, msgs);
			case Pt1_01_2Package.MASTER_FILES_TYPE__PRODUCT:
				return ((InternalEList<?>)getProduct()).basicRemove(otherEnd, msgs);
			case Pt1_01_2Package.MASTER_FILES_TYPE__TAX_TABLE:
