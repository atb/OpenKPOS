 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.AddressStructureImpl#getBuildingNumber <em>Building Number</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.AddressStructureImpl#getStreetName <em>Street Name</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.AddressStructureImpl#getAddressDetail <em>Address Detail</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.AddressStructureImpl#getCity <em>City</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.AddressStructureImpl#getPostalCode <em>Postal Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.AddressStructureImpl#getRegion <em>Region</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.AddressStructureImpl#getCountry <em>Country</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddressStructureImpl extends EObjectImpl implements AddressStructure {
	...
	protected EClass eStaticClass() {
		return Pt1_01_2Package.Literals.ADDRESS_STRUCTURE;
	}
	...
	public void setBuildingNumber(String newBuildingNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.ADDRESS_STRUCTURE__BUILDING_NUMBER, oldBuildingNumber, buildingNumber));
	}
	...
	public void setStreetName(String newStreetName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.ADDRESS_STRUCTURE__STREET_NAME, oldStreetName, streetName));
	}
	...
	public void setAddressDetail(String newAddressDetail) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.ADDRESS_STRUCTURE__ADDRESS_DETAIL, oldAddressDetail, addressDetail));
	}
	...
	public void setCity(String newCity) {
		...
		city = newCity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.ADDRESS_STRUCTURE__CITY, oldCity, city));
	}
	...
	public void setPostalCode(String newPostalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.ADDRESS_STRUCTURE__POSTAL_CODE, oldPostalCode, postalCode));
	}
	...
	public void setRegion(String newRegion) {
		...
		region = newRegion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.ADDRESS_STRUCTURE__REGION, oldRegion, region));
	}
	...
	public void setCountry(String newCountry) {
		...
		country = newCountry;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.ADDRESS_STRUCTURE__COUNTRY, oldCountry, country));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01_2Package.ADDRESS_STRUCTURE__BUILDING_NUMBER:
				return getBuildingNumber();
			case Pt1_01_2Package.ADDRESS_STRUCTURE__STREET_NAME:
				return getStreetName();
			case Pt1_01_2Package.ADDRESS_STRUCTURE__ADDRESS_DETAIL:
				return getAddressDetail();
			case Pt1_01_2Package.ADDRESS_STRUCTURE__CITY:
				return getCity();
			case Pt1_01_2Package.ADDRESS_STRUCTURE__POSTAL_CODE:
				return getPostalCode();
			case Pt1_01_2Package.ADDRESS_STRUCTURE__REGION:
				return getRegion();
			case Pt1_01_2Package.ADDRESS_STRUCTURE__COUNTRY:
				return getCountry();
		}
