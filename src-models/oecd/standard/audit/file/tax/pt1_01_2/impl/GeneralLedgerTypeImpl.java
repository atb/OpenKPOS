 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.GeneralLedgerTypeImpl#getAccountID <em>Account ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.GeneralLedgerTypeImpl#getAccountDescription <em>Account Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.GeneralLedgerTypeImpl#getOpeningDebitBalance <em>Opening Debit Balance</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.GeneralLedgerTypeImpl#getOpeningCreditBalance <em>Opening Credit Balance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralLedgerTypeImpl extends EObjectImpl implements GeneralLedgerType {
	...
	protected EClass eStaticClass() {
		return Pt1_01_2Package.Literals.GENERAL_LEDGER_TYPE;
	}
	...
	public void setAccountID(String newAccountID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.GENERAL_LEDGER_TYPE__ACCOUNT_ID, oldAccountID, accountID));
	}
	...
	public void setAccountDescription(String newAccountDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.GENERAL_LEDGER_TYPE__ACCOUNT_DESCRIPTION, oldAccountDescription, accountDescription));
	}
	...
	public void setOpeningDebitBalance(BigDecimal newOpeningDebitBalance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.GENERAL_LEDGER_TYPE__OPENING_DEBIT_BALANCE, oldOpeningDebitBalance, openingDebitBalance));
	}
	...
	public void setOpeningCreditBalance(BigDecimal newOpeningCreditBalance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.GENERAL_LEDGER_TYPE__OPENING_CREDIT_BALANCE, oldOpeningCreditBalance, openingCreditBalance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01_2Package.GENERAL_LEDGER_TYPE__ACCOUNT_ID:
				return getAccountID();
			case Pt1_01_2Package.GENERAL_LEDGER_TYPE__ACCOUNT_DESCRIPTION:
				return getAccountDescription();
			case Pt1_01_2Package.GENERAL_LEDGER_TYPE__OPENING_DEBIT_BALANCE:
				return getOpeningDebitBalance();
			case Pt1_01_2Package.GENERAL_LEDGER_TYPE__OPENING_CREDIT_BALANCE:
