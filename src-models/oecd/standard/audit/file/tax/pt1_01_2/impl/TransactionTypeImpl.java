 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.TransactionTypeImpl#getTransactionID <em>Transaction ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.TransactionTypeImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.TransactionTypeImpl#getTransactionDate <em>Transaction Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.TransactionTypeImpl#getSourceID <em>Source ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.TransactionTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.TransactionTypeImpl#getDocArchivalNumber <em>Doc Archival Number</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.TransactionTypeImpl#getTransactionType <em>Transaction Type</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.TransactionTypeImpl#getGLPostingDate <em>GL Posting Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.TransactionTypeImpl#getCustomerID <em>Customer ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.TransactionTypeImpl#getSupplierID <em>Supplier ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.pt1_01_2.impl.TransactionTypeImpl#getLine <em>Line</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransactionTypeImpl extends EObjectImpl implements TransactionType {
	...
	protected EClass eStaticClass() {
		return Pt1_01_2Package.Literals.TRANSACTION_TYPE;
	}
	...
	public void setTransactionID(String newTransactionID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.TRANSACTION_TYPE__TRANSACTION_ID, oldTransactionID, transactionID));
	}
	...
	public void setPeriod(BigInteger newPeriod) {
		...
		period = newPeriod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.TRANSACTION_TYPE__PERIOD, oldPeriod, period));
	}
	...
	public void setTransactionDate(XMLGregorianCalendar newTransactionDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.TRANSACTION_TYPE__TRANSACTION_DATE, oldTransactionDate, transactionDate));
	}
	...
	public void setSourceID(String newSourceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.TRANSACTION_TYPE__SOURCE_ID, oldSourceID, sourceID));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.TRANSACTION_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setDocArchivalNumber(String newDocArchivalNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.TRANSACTION_TYPE__DOC_ARCHIVAL_NUMBER, oldDocArchivalNumber, docArchivalNumber));
	}
	...
	public void setTransactionType(TransactionTypeType newTransactionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.TRANSACTION_TYPE__TRANSACTION_TYPE, oldTransactionType, transactionType, !oldTransactionTypeESet));
	}
	...
	public void unsetTransactionType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Pt1_01_2Package.TRANSACTION_TYPE__TRANSACTION_TYPE, oldTransactionType, TRANSACTION_TYPE_EDEFAULT, oldTransactionTypeESet));
	}
	...
	public void setGLPostingDate(XMLGregorianCalendar newGLPostingDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.TRANSACTION_TYPE__GL_POSTING_DATE, oldGLPostingDate, gLPostingDate));
	}
	...
	public void setCustomerID(String newCustomerID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.TRANSACTION_TYPE__CUSTOMER_ID, oldCustomerID, customerID));
	}
	...
	public void setSupplierID(String newSupplierID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pt1_01_2Package.TRANSACTION_TYPE__SUPPLIER_ID, oldSupplierID, supplierID));
	}
	...
	public EList<LineType1> getLine() {
		if (line == null) {
			line = new EObjectContainmentEList<LineType1>(LineType1.class, this, Pt1_01_2Package.TRANSACTION_TYPE__LINE);
		}
		return line;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pt1_01_2Package.TRANSACTION_TYPE__LINE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pt1_01_2Package.TRANSACTION_TYPE__TRANSACTION_ID:
				return getTransactionID();
			case Pt1_01_2Package.TRANSACTION_TYPE__PERIOD:
				return getPeriod();
			case Pt1_01_2Package.TRANSACTION_TYPE__TRANSACTION_DATE:
				return getTransactionDate();
			case Pt1_01_2Package.TRANSACTION_TYPE__SOURCE_ID:
				return getSourceID();
			case Pt1_01_2Package.TRANSACTION_TYPE__DESCRIPTION:
				return getDescription();
			case Pt1_01_2Package.TRANSACTION_TYPE__DOC_ARCHIVAL_NUMBER:
				return getDocArchivalNumber();
			case Pt1_01_2Package.TRANSACTION_TYPE__TRANSACTION_TYPE:
				return getTransactionType();
			case Pt1_01_2Package.TRANSACTION_TYPE__GL_POSTING_DATE:
				return getGLPostingDate();
			case Pt1_01_2Package.TRANSACTION_TYPE__CUSTOMER_ID:
				return getCustomerID();
			case Pt1_01_2Package.TRANSACTION_TYPE__SUPPLIER_ID:
