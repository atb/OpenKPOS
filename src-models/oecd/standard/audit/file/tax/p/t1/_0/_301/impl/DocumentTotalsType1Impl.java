 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType1Impl#getTaxPayable <em>Tax Payable</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType1Impl#getNetTotal <em>Net Total</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType1Impl#getGrossTotal <em>Gross Total</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType1Impl#getCurrency <em>Currency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentTotalsType1Impl extends EObjectImpl implements DocumentTotalsType1 {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getDocumentTotalsType1();
	}
	...
	public void setTaxPayable(BigDecimal newTaxPayable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE1__TAX_PAYABLE, oldTaxPayable, taxPayable));
	}
	...
	public void setNetTotal(BigDecimal newNetTotal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE1__NET_TOTAL, oldNetTotal, netTotal));
	}
	...
	public void setGrossTotal(BigDecimal newGrossTotal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE1__GROSS_TOTAL, oldGrossTotal, grossTotal));
	}
	...
	public NotificationChain basicSetCurrency(Currency newCurrency, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE1__CURRENCY, oldCurrency, newCurrency);
	...
	public void setCurrency(Currency newCurrency) {
		if (newCurrency != currency) {
			...
			if (currency != null)
				msgs = ((InternalEObject)currency).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.DOCUMENT_TOTALS_TYPE1__CURRENCY, null, msgs);
			if (newCurrency != null)
				msgs = ((InternalEObject)newCurrency).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.DOCUMENT_TOTALS_TYPE1__CURRENCY, null, msgs);
			msgs = basicSetCurrency(newCurrency, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE1__CURRENCY, newCurrency, newCurrency));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _301Package.DOCUMENT_TOTALS_TYPE1__CURRENCY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.DOCUMENT_TOTALS_TYPE1__TAX_PAYABLE:
				return getTaxPayable();
			case _301Package.DOCUMENT_TOTALS_TYPE1__NET_TOTAL:
				return getNetTotal();
			case _301Package.DOCUMENT_TOTALS_TYPE1__GROSS_TOTAL:
