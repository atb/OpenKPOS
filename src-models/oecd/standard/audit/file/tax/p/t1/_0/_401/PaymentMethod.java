 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.PaymentMethod#getPaymentMechanism <em>Payment Mechanism</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.PaymentMethod#getPaymentAmount <em>Payment Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.PaymentMethod#getPaymentDate <em>Payment Date</em>}</li>
 * </ul>
 * </p>
 *
 * @see oecd.standard.audit.file.tax.p.t1._0._401._401Package#getPaymentMethod()
...
public interface PaymentMethod extends EObject {
	 ...
	 * @see oecd.standard.audit.file.tax.p.t1._0._401._401Package#getPaymentMethod_PaymentMechanism()
	...
	/**
	 * Sets the value of the '{@link oecd.standard.audit.file.tax.p.t1._0._401.PaymentMethod#getPaymentMechanism <em>Payment Mechanism</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link oecd.standard.audit.file.tax.p.t1._0._401.PaymentMethod#getPaymentMechanism <em>Payment Mechanism</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetPaymentMechanism()
	 * @see #getPaymentMechanism()
	...
	/**
	 * Returns whether the value of the '{@link oecd.standard.audit.file.tax.p.t1._0._401.PaymentMethod#getPaymentMechanism <em>Payment Mechanism</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see oecd.standard.audit.file.tax.p.t1._0._401._401Package#getPaymentMethod_PaymentAmount()
	...
	/**
	 * Sets the value of the '{@link oecd.standard.audit.file.tax.p.t1._0._401.PaymentMethod#getPaymentAmount <em>Payment Amount</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see oecd.standard.audit.file.tax.p.t1._0._401._401Package#getPaymentMethod_PaymentDate()
	...
	/**
	 * Sets the value of the '{@link oecd.standard.audit.file.tax.p.t1._0._401.PaymentMethod#getPaymentDate <em>Payment Date</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
