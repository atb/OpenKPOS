 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.PaymentImpl#getPaymentMechanism <em>Payment Mechanism</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.PaymentImpl#getPaymentAmount <em>Payment Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.PaymentImpl#getPaymentDate <em>Payment Date</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PaymentImpl extends EObjectImpl implements Payment {
	...
	protected EClass eStaticClass() {
		return _201Package.eINSTANCE.getPayment();
	}
	...
	public void setPaymentMechanism(PaymentMechanismType newPaymentMechanism) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.PAYMENT__PAYMENT_MECHANISM, oldPaymentMechanism, paymentMechanism, !oldPaymentMechanismESet));
	}
	...
	public void unsetPaymentMechanism() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _201Package.PAYMENT__PAYMENT_MECHANISM, oldPaymentMechanism, PAYMENT_MECHANISM_EDEFAULT, oldPaymentMechanismESet));
	}
	...
	public void setPaymentAmount(BigDecimal newPaymentAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.PAYMENT__PAYMENT_AMOUNT, oldPaymentAmount, paymentAmount));
	}
	...
	public void setPaymentDate(XMLGregorianCalendar newPaymentDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.PAYMENT__PAYMENT_DATE, oldPaymentDate, paymentDate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _201Package.PAYMENT__PAYMENT_MECHANISM:
				return getPaymentMechanism();
			case _201Package.PAYMENT__PAYMENT_AMOUNT:
				return getPaymentAmount();
			case _201Package.PAYMENT__PAYMENT_DATE:
