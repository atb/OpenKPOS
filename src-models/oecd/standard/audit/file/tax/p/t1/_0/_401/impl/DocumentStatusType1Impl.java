 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType1Impl#getMovementStatus <em>Movement Status</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType1Impl#getMovementStatusDate <em>Movement Status Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType1Impl#getReason <em>Reason</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType1Impl#getSourceID <em>Source ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType1Impl#getSourceBilling <em>Source Billing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentStatusType1Impl extends EObjectImpl implements DocumentStatusType1 {
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getDocumentStatusType1();
	}
	...
	public void setMovementStatus(MovementStatusType newMovementStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE1__MOVEMENT_STATUS, oldMovementStatus, movementStatus, !oldMovementStatusESet));
	}
	...
	public void unsetMovementStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _401Package.DOCUMENT_STATUS_TYPE1__MOVEMENT_STATUS, oldMovementStatus, MOVEMENT_STATUS_EDEFAULT, oldMovementStatusESet));
	}
	...
	public void setMovementStatusDate(XMLGregorianCalendar newMovementStatusDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE1__MOVEMENT_STATUS_DATE, oldMovementStatusDate, movementStatusDate));
	}
	...
	public void setReason(String newReason) {
		...
		reason = newReason;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE1__REASON, oldReason, reason));
	}
	...
	public void setSourceID(String newSourceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE1__SOURCE_ID, oldSourceID, sourceID));
	}
	...
	public void setSourceBilling(SAFTPTSourceBilling newSourceBilling) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE1__SOURCE_BILLING, oldSourceBilling, sourceBilling, !oldSourceBillingESet));
	}
	...
	public void unsetSourceBilling() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _401Package.DOCUMENT_STATUS_TYPE1__SOURCE_BILLING, oldSourceBilling, SOURCE_BILLING_EDEFAULT, oldSourceBillingESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.DOCUMENT_STATUS_TYPE1__MOVEMENT_STATUS:
				return getMovementStatus();
			case _401Package.DOCUMENT_STATUS_TYPE1__MOVEMENT_STATUS_DATE:
				return getMovementStatusDate();
			case _401Package.DOCUMENT_STATUS_TYPE1__REASON:
				return getReason();
			case _401Package.DOCUMENT_STATUS_TYPE1__SOURCE_ID:
				return getSourceID();
			case _401Package.DOCUMENT_STATUS_TYPE1__SOURCE_BILLING:
