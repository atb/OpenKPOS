 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.ProductTypeImpl#getProductType <em>Product Type</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.ProductTypeImpl#getProductCode <em>Product Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.ProductTypeImpl#getProductGroup <em>Product Group</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.ProductTypeImpl#getProductDescription <em>Product Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.ProductTypeImpl#getProductNumberCode <em>Product Number Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProductTypeImpl extends EObjectImpl implements ProductType {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getProductType();
	}
	...
	public void setProductType(ProductTypeType newProductType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.PRODUCT_TYPE__PRODUCT_TYPE, oldProductType, productType, !oldProductTypeESet));
	}
	...
	public void unsetProductType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _301Package.PRODUCT_TYPE__PRODUCT_TYPE, oldProductType, PRODUCT_TYPE_EDEFAULT, oldProductTypeESet));
	}
	...
	public void setProductCode(String newProductCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.PRODUCT_TYPE__PRODUCT_CODE, oldProductCode, productCode));
	}
	...
	public void setProductGroup(String newProductGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.PRODUCT_TYPE__PRODUCT_GROUP, oldProductGroup, productGroup));
	}
	...
	public void setProductDescription(String newProductDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.PRODUCT_TYPE__PRODUCT_DESCRIPTION, oldProductDescription, productDescription));
	}
	...
	public void setProductNumberCode(String newProductNumberCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.PRODUCT_TYPE__PRODUCT_NUMBER_CODE, oldProductNumberCode, productNumberCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.PRODUCT_TYPE__PRODUCT_TYPE:
				return getProductType();
			case _301Package.PRODUCT_TYPE__PRODUCT_CODE:
				return getProductCode();
			case _301Package.PRODUCT_TYPE__PRODUCT_GROUP:
				return getProductGroup();
			case _301Package.PRODUCT_TYPE__PRODUCT_DESCRIPTION:
				return getProductDescription();
			case _301Package.PRODUCT_TYPE__PRODUCT_NUMBER_CODE:
