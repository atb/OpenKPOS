...
import oecd.standard.audit.file.tax.p.t1._0._301.SAFTPTMovementTaxType;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.MovementTaxImpl#getTaxType <em>Tax Type</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.MovementTaxImpl#getTaxCountryRegion <em>Tax Country Region</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.MovementTaxImpl#getTaxCode <em>Tax Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.MovementTaxImpl#getTaxPercentage <em>Tax Percentage</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MovementTaxImpl extends EObjectImpl implements MovementTax {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getMovementTax();
	}
	...
	public void setTaxType(SAFTPTMovementTaxType newTaxType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.MOVEMENT_TAX__TAX_TYPE, oldTaxType, taxType, !oldTaxTypeESet));
	}
	...
	public void unsetTaxType() {
		...
		taxTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _301Package.MOVEMENT_TAX__TAX_TYPE, oldTaxType, TAX_TYPE_EDEFAULT, oldTaxTypeESet));
	}
	...
	public void setTaxCountryRegion(String newTaxCountryRegion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.MOVEMENT_TAX__TAX_COUNTRY_REGION, oldTaxCountryRegion, taxCountryRegion));
	}
	...
	public void setTaxCode(String newTaxCode) {
		...
		taxCode = newTaxCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.MOVEMENT_TAX__TAX_CODE, oldTaxCode, taxCode));
	}
	...
	public void setTaxPercentage(BigDecimal newTaxPercentage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.MOVEMENT_TAX__TAX_PERCENTAGE, oldTaxPercentage, taxPercentage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.MOVEMENT_TAX__TAX_TYPE:
				return getTaxType();
			case _301Package.MOVEMENT_TAX__TAX_COUNTRY_REGION:
				return getTaxCountryRegion();
			case _301Package.MOVEMENT_TAX__TAX_CODE:
				return getTaxCode();
			case _301Package.MOVEMENT_TAX__TAX_PERCENTAGE:
