...
import oecd.standard.audit.file.tax.p.t1._0._301.DocumentStatusType;
import oecd.standard.audit.file.tax.p.t1._0._301.DocumentTotalsType;
import oecd.standard.audit.file.tax.p.t1._0._301.LineType3;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.WorkDocumentTypeImpl#getDocumentNumber <em>Document Number</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.WorkDocumentTypeImpl#getDocumentStatus <em>Document Status</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.WorkDocumentTypeImpl#getHash <em>Hash</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.WorkDocumentTypeImpl#getHashControl <em>Hash Control</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.WorkDocumentTypeImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.WorkDocumentTypeImpl#getWorkDate <em>Work Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.WorkDocumentTypeImpl#getWorkType <em>Work Type</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.WorkDocumentTypeImpl#getSourceID <em>Source ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.WorkDocumentTypeImpl#getEACCode <em>EAC Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.WorkDocumentTypeImpl#getSystemEntryDate <em>System Entry Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.WorkDocumentTypeImpl#getCustomerID <em>Customer ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.WorkDocumentTypeImpl#getLine <em>Line</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.WorkDocumentTypeImpl#getDocumentTotals <em>Document Totals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WorkDocumentTypeImpl extends EObjectImpl implements WorkDocumentType {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getWorkDocumentType();
	}
	...
	public void setDocumentNumber(String newDocumentNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__DOCUMENT_NUMBER, oldDocumentNumber, documentNumber));
	}
	...
	public NotificationChain basicSetDocumentStatus(DocumentStatusType newDocumentStatus, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__DOCUMENT_STATUS, oldDocumentStatus, newDocumentStatus);
	...
	public void setDocumentStatus(DocumentStatusType newDocumentStatus) {
		if (newDocumentStatus != documentStatus) {
			...
			if (documentStatus != null)
				msgs = ((InternalEObject)documentStatus).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.WORK_DOCUMENT_TYPE__DOCUMENT_STATUS, null, msgs);
			if (newDocumentStatus != null)
				msgs = ((InternalEObject)newDocumentStatus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.WORK_DOCUMENT_TYPE__DOCUMENT_STATUS, null, msgs);
			msgs = basicSetDocumentStatus(newDocumentStatus, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__DOCUMENT_STATUS, newDocumentStatus, newDocumentStatus));
	}
	...
	public void setHash(String newHash) {
		...
		hash = newHash;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__HASH, oldHash, hash));
	}
	...
	public void setHashControl(String newHashControl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__HASH_CONTROL, oldHashControl, hashControl));
	}
	...
	public void setPeriod(BigInteger newPeriod) {
		...
		period = newPeriod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__PERIOD, oldPeriod, period));
	}
	...
	public void setWorkDate(XMLGregorianCalendar newWorkDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__WORK_DATE, oldWorkDate, workDate));
	}
	...
	public void setWorkType(WorkTypeType newWorkType) {
		...
		workTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__WORK_TYPE, oldWorkType, workType, !oldWorkTypeESet));
	}
	...
	public void unsetWorkType() {
		...
		workTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _301Package.WORK_DOCUMENT_TYPE__WORK_TYPE, oldWorkType, WORK_TYPE_EDEFAULT, oldWorkTypeESet));
	}
	...
	public void setSourceID(String newSourceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__SOURCE_ID, oldSourceID, sourceID));
	}
	...
	public void setEACCode(String newEACCode) {
		...
		eACCode = newEACCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__EAC_CODE, oldEACCode, eACCode));
	}
	...
	public void setSystemEntryDate(XMLGregorianCalendar newSystemEntryDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__SYSTEM_ENTRY_DATE, oldSystemEntryDate, systemEntryDate));
	}
	...
	public void setCustomerID(String newCustomerID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__CUSTOMER_ID, oldCustomerID, customerID));
	}
	...
	public EList<LineType3> getLine() {
		if (line == null) {
			line = new EObjectContainmentEList<LineType3>(LineType3.class, this, _301Package.WORK_DOCUMENT_TYPE__LINE);
		}
		return line;
	}
	...
	public NotificationChain basicSetDocumentTotals(DocumentTotalsType newDocumentTotals, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__DOCUMENT_TOTALS, oldDocumentTotals, newDocumentTotals);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDocumentTotals(DocumentTotalsType newDocumentTotals) {
		if (newDocumentTotals != documentTotals) {
			...
			if (documentTotals != null)
				msgs = ((InternalEObject)documentTotals).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.WORK_DOCUMENT_TYPE__DOCUMENT_TOTALS, null, msgs);
			if (newDocumentTotals != null)
				msgs = ((InternalEObject)newDocumentTotals).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.WORK_DOCUMENT_TYPE__DOCUMENT_TOTALS, null, msgs);
			msgs = basicSetDocumentTotals(newDocumentTotals, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.WORK_DOCUMENT_TYPE__DOCUMENT_TOTALS, newDocumentTotals, newDocumentTotals));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _301Package.WORK_DOCUMENT_TYPE__DOCUMENT_STATUS:
				return basicSetDocumentStatus(null, msgs);
			case _301Package.WORK_DOCUMENT_TYPE__LINE:
				return ((InternalEList<?>)getLine()).basicRemove(otherEnd, msgs);
			case _301Package.WORK_DOCUMENT_TYPE__DOCUMENT_TOTALS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.WORK_DOCUMENT_TYPE__DOCUMENT_NUMBER:
				return getDocumentNumber();
			case _301Package.WORK_DOCUMENT_TYPE__DOCUMENT_STATUS:
				return getDocumentStatus();
			case _301Package.WORK_DOCUMENT_TYPE__HASH:
				return getHash();
			case _301Package.WORK_DOCUMENT_TYPE__HASH_CONTROL:
				return getHashControl();
			case _301Package.WORK_DOCUMENT_TYPE__PERIOD:
				return getPeriod();
			case _301Package.WORK_DOCUMENT_TYPE__WORK_DATE:
				return getWorkDate();
			case _301Package.WORK_DOCUMENT_TYPE__WORK_TYPE:
				return getWorkType();
			case _301Package.WORK_DOCUMENT_TYPE__SOURCE_ID:
				return getSourceID();
			case _301Package.WORK_DOCUMENT_TYPE__EAC_CODE:
				return getEACCode();
			case _301Package.WORK_DOCUMENT_TYPE__SYSTEM_ENTRY_DATE:
				return getSystemEntryDate();
			case _301Package.WORK_DOCUMENT_TYPE__CUSTOMER_ID:
