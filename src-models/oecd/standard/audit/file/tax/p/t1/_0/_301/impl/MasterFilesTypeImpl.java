 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.MasterFilesTypeImpl#getGeneralLedger <em>General Ledger</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.MasterFilesTypeImpl#getCustomer <em>Customer</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.MasterFilesTypeImpl#getSupplier <em>Supplier</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.MasterFilesTypeImpl#getProduct <em>Product</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.MasterFilesTypeImpl#getTaxTable <em>Tax Table</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MasterFilesTypeImpl extends EObjectImpl implements MasterFilesType {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getMasterFilesType();
	}
	...
	public EList<GeneralLedgerType> getGeneralLedger() {
		if (generalLedger == null) {
			generalLedger = new EObjectContainmentEList<GeneralLedgerType>(GeneralLedgerType.class, this, _301Package.MASTER_FILES_TYPE__GENERAL_LEDGER);
		}
	...
	public EList<CustomerType> getCustomer() {
		if (customer == null) {
			customer = new EObjectContainmentEList<CustomerType>(CustomerType.class, this, _301Package.MASTER_FILES_TYPE__CUSTOMER);
		}
		return customer;
	}
	...
	public EList<SupplierType> getSupplier() {
		if (supplier == null) {
			supplier = new EObjectContainmentEList<SupplierType>(SupplierType.class, this, _301Package.MASTER_FILES_TYPE__SUPPLIER);
		}
		return supplier;
	}
	...
	public EList<ProductType> getProduct() {
		if (product == null) {
			product = new EObjectContainmentEList<ProductType>(ProductType.class, this, _301Package.MASTER_FILES_TYPE__PRODUCT);
		}
		return product;
	}
	...
	public NotificationChain basicSetTaxTable(TaxTableType newTaxTable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.MASTER_FILES_TYPE__TAX_TABLE, oldTaxTable, newTaxTable);
	...
	public void setTaxTable(TaxTableType newTaxTable) {
		if (newTaxTable != taxTable) {
			...
			if (taxTable != null)
				msgs = ((InternalEObject)taxTable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.MASTER_FILES_TYPE__TAX_TABLE, null, msgs);
			if (newTaxTable != null)
				msgs = ((InternalEObject)newTaxTable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.MASTER_FILES_TYPE__TAX_TABLE, null, msgs);
			msgs = basicSetTaxTable(newTaxTable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.MASTER_FILES_TYPE__TAX_TABLE, newTaxTable, newTaxTable));
	}
