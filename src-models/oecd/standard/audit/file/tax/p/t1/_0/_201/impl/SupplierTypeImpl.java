...
import oecd.standard.audit.file.tax.p.t1._0._201.SupplierAddressStructure;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.SupplierTypeImpl#getSupplierID <em>Supplier ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.SupplierTypeImpl#getAccountID <em>Account ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.SupplierTypeImpl#getSupplierTaxID <em>Supplier Tax ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.SupplierTypeImpl#getCompanyName <em>Company Name</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.SupplierTypeImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.SupplierTypeImpl#getBillingAddress <em>Billing Address</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.SupplierTypeImpl#getShipFromAddress <em>Ship From Address</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.SupplierTypeImpl#getTelephone <em>Telephone</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.SupplierTypeImpl#getFax <em>Fax</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.SupplierTypeImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.SupplierTypeImpl#getWebsite <em>Website</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.SupplierTypeImpl#getSelfBillingIndicator <em>Self Billing Indicator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SupplierTypeImpl extends EObjectImpl implements SupplierType {
	...
	protected EClass eStaticClass() {
		return _201Package.eINSTANCE.getSupplierType();
	}
	...
	public void setSupplierID(String newSupplierID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.SUPPLIER_TYPE__SUPPLIER_ID, oldSupplierID, supplierID));
	}
	...
	public void setAccountID(String newAccountID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.SUPPLIER_TYPE__ACCOUNT_ID, oldAccountID, accountID));
	}
	...
	public void setSupplierTaxID(String newSupplierTaxID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.SUPPLIER_TYPE__SUPPLIER_TAX_ID, oldSupplierTaxID, supplierTaxID));
	}
	...
	public void setCompanyName(String newCompanyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.SUPPLIER_TYPE__COMPANY_NAME, oldCompanyName, companyName));
	}
	...
	public void setContact(String newContact) {
		...
		contact = newContact;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.SUPPLIER_TYPE__CONTACT, oldContact, contact));
	}
	...
	public NotificationChain basicSetBillingAddress(SupplierAddressStructure newBillingAddress, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _201Package.SUPPLIER_TYPE__BILLING_ADDRESS, oldBillingAddress, newBillingAddress);
	...
	public void setBillingAddress(SupplierAddressStructure newBillingAddress) {
		if (newBillingAddress != billingAddress) {
			...
			if (billingAddress != null)
				msgs = ((InternalEObject)billingAddress).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _201Package.SUPPLIER_TYPE__BILLING_ADDRESS, null, msgs);
			if (newBillingAddress != null)
				msgs = ((InternalEObject)newBillingAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _201Package.SUPPLIER_TYPE__BILLING_ADDRESS, null, msgs);
			msgs = basicSetBillingAddress(newBillingAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.SUPPLIER_TYPE__BILLING_ADDRESS, newBillingAddress, newBillingAddress));
	}
	...
	public EList<SupplierAddressStructure> getShipFromAddress() {
		if (shipFromAddress == null) {
			shipFromAddress = new EObjectContainmentEList<SupplierAddressStructure>(SupplierAddressStructure.class, this, _201Package.SUPPLIER_TYPE__SHIP_FROM_ADDRESS);
		}
	...
	public void setTelephone(String newTelephone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.SUPPLIER_TYPE__TELEPHONE, oldTelephone, telephone));
	}
	...
	public void setFax(String newFax) {
		...
		fax = newFax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.SUPPLIER_TYPE__FAX, oldFax, fax));
	}
	...
	public void setEmail(String newEmail) {
		...
		email = newEmail;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.SUPPLIER_TYPE__EMAIL, oldEmail, email));
	}
	...
	public void setWebsite(String newWebsite) {
		...
		website = newWebsite;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.SUPPLIER_TYPE__WEBSITE, oldWebsite, website));
	}
	...
	public void setSelfBillingIndicator(BigInteger newSelfBillingIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.SUPPLIER_TYPE__SELF_BILLING_INDICATOR, oldSelfBillingIndicator, selfBillingIndicator));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _201Package.SUPPLIER_TYPE__BILLING_ADDRESS:
				return basicSetBillingAddress(null, msgs);
			case _201Package.SUPPLIER_TYPE__SHIP_FROM_ADDRESS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _201Package.SUPPLIER_TYPE__SUPPLIER_ID:
				return getSupplierID();
			case _201Package.SUPPLIER_TYPE__ACCOUNT_ID:
				return getAccountID();
			case _201Package.SUPPLIER_TYPE__SUPPLIER_TAX_ID:
				return getSupplierTaxID();
			case _201Package.SUPPLIER_TYPE__COMPANY_NAME:
				return getCompanyName();
			case _201Package.SUPPLIER_TYPE__CONTACT:
				return getContact();
			case _201Package.SUPPLIER_TYPE__BILLING_ADDRESS:
				return getBillingAddress();
			case _201Package.SUPPLIER_TYPE__SHIP_FROM_ADDRESS:
				return getShipFromAddress();
			case _201Package.SUPPLIER_TYPE__TELEPHONE:
				return getTelephone();
			case _201Package.SUPPLIER_TYPE__FAX:
				return getFax();
			case _201Package.SUPPLIER_TYPE__EMAIL:
				return getEmail();
			case _201Package.SUPPLIER_TYPE__WEBSITE:
				return getWebsite();
			case _201Package.SUPPLIER_TYPE__SELF_BILLING_INDICATOR:
