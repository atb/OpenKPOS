 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType3Impl#getInvoiceStatus <em>Invoice Status</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType3Impl#getInvoiceStatusDate <em>Invoice Status Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType3Impl#getReason <em>Reason</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType3Impl#getSourceID <em>Source ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType3Impl#getSourceBilling <em>Source Billing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentStatusType3Impl extends EObjectImpl implements DocumentStatusType3 {
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getDocumentStatusType3();
	}
	...
	public void setInvoiceStatus(InvoiceStatusType newInvoiceStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE3__INVOICE_STATUS, oldInvoiceStatus, invoiceStatus, !oldInvoiceStatusESet));
	}
	...
	public void unsetInvoiceStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _401Package.DOCUMENT_STATUS_TYPE3__INVOICE_STATUS, oldInvoiceStatus, INVOICE_STATUS_EDEFAULT, oldInvoiceStatusESet));
	}
	...
	public void setInvoiceStatusDate(XMLGregorianCalendar newInvoiceStatusDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE3__INVOICE_STATUS_DATE, oldInvoiceStatusDate, invoiceStatusDate));
	}
	...
	public void setReason(String newReason) {
		...
		reason = newReason;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE3__REASON, oldReason, reason));
	}
	...
	public void setSourceID(String newSourceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE3__SOURCE_ID, oldSourceID, sourceID));
	}
	...
	public void setSourceBilling(SAFTPTSourceBilling newSourceBilling) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE3__SOURCE_BILLING, oldSourceBilling, sourceBilling, !oldSourceBillingESet));
	}
	...
	public void unsetSourceBilling() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _401Package.DOCUMENT_STATUS_TYPE3__SOURCE_BILLING, oldSourceBilling, SOURCE_BILLING_EDEFAULT, oldSourceBillingESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.DOCUMENT_STATUS_TYPE3__INVOICE_STATUS:
				return getInvoiceStatus();
			case _401Package.DOCUMENT_STATUS_TYPE3__INVOICE_STATUS_DATE:
				return getInvoiceStatusDate();
			case _401Package.DOCUMENT_STATUS_TYPE3__REASON:
				return getReason();
			case _401Package.DOCUMENT_STATUS_TYPE3__SOURCE_ID:
				return getSourceID();
			case _401Package.DOCUMENT_STATUS_TYPE3__SOURCE_BILLING:
