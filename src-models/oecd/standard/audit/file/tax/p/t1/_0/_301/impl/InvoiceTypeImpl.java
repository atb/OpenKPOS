...
import oecd.standard.audit.file.tax.p.t1._0._301.DocumentTotalsType3;
...
import oecd.standard.audit.file.tax.p.t1._0._301.LineType2;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getInvoiceNo <em>Invoice No</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getDocumentStatus <em>Document Status</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getHash <em>Hash</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getHashControl <em>Hash Control</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getInvoiceDate <em>Invoice Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getInvoiceType <em>Invoice Type</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getSpecialRegimes <em>Special Regimes</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getSourceID <em>Source ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getEACCode <em>EAC Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getSystemEntryDate <em>System Entry Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getTransactionID <em>Transaction ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getCustomerID <em>Customer ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getShipTo <em>Ship To</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getShipFrom <em>Ship From</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getMovementEndTime <em>Movement End Time</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getMovementStartTime <em>Movement Start Time</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getLine <em>Line</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getDocumentTotals <em>Document Totals</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.InvoiceTypeImpl#getWithholdingTax <em>Withholding Tax</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InvoiceTypeImpl extends EObjectImpl implements InvoiceType {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getInvoiceType();
	}
	...
	public void setInvoiceNo(String newInvoiceNo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__INVOICE_NO, oldInvoiceNo, invoiceNo));
	}
	...
	public NotificationChain basicSetDocumentStatus(DocumentStatusType3 newDocumentStatus, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__DOCUMENT_STATUS, oldDocumentStatus, newDocumentStatus);
	...
	public void setDocumentStatus(DocumentStatusType3 newDocumentStatus) {
		if (newDocumentStatus != documentStatus) {
			...
			if (documentStatus != null)
				msgs = ((InternalEObject)documentStatus).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.INVOICE_TYPE__DOCUMENT_STATUS, null, msgs);
			if (newDocumentStatus != null)
				msgs = ((InternalEObject)newDocumentStatus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.INVOICE_TYPE__DOCUMENT_STATUS, null, msgs);
			msgs = basicSetDocumentStatus(newDocumentStatus, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__DOCUMENT_STATUS, newDocumentStatus, newDocumentStatus));
	}
	...
	public void setHash(String newHash) {
		...
		hash = newHash;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__HASH, oldHash, hash));
	}
	...
	public void setHashControl(String newHashControl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__HASH_CONTROL, oldHashControl, hashControl));
	}
	...
	public void setPeriod(BigInteger newPeriod) {
		...
		period = newPeriod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__PERIOD, oldPeriod, period));
	}
	...
	public void setInvoiceDate(XMLGregorianCalendar newInvoiceDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__INVOICE_DATE, oldInvoiceDate, invoiceDate));
	}
	...
	public void setInvoiceType(InvoiceTypeType newInvoiceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__INVOICE_TYPE, oldInvoiceType, invoiceType, !oldInvoiceTypeESet));
	}
	...
	public void unsetInvoiceType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _301Package.INVOICE_TYPE__INVOICE_TYPE, oldInvoiceType, INVOICE_TYPE_EDEFAULT, oldInvoiceTypeESet));
	}
	...
	public NotificationChain basicSetSpecialRegimes(SpecialRegimes newSpecialRegimes, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__SPECIAL_REGIMES, oldSpecialRegimes, newSpecialRegimes);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSpecialRegimes(SpecialRegimes newSpecialRegimes) {
		if (newSpecialRegimes != specialRegimes) {
			...
			if (specialRegimes != null)
				msgs = ((InternalEObject)specialRegimes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.INVOICE_TYPE__SPECIAL_REGIMES, null, msgs);
			if (newSpecialRegimes != null)
				msgs = ((InternalEObject)newSpecialRegimes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.INVOICE_TYPE__SPECIAL_REGIMES, null, msgs);
			msgs = basicSetSpecialRegimes(newSpecialRegimes, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__SPECIAL_REGIMES, newSpecialRegimes, newSpecialRegimes));
	}
	...
	public void setSourceID(String newSourceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__SOURCE_ID, oldSourceID, sourceID));
	}
	...
	public void setEACCode(String newEACCode) {
		...
		eACCode = newEACCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__EAC_CODE, oldEACCode, eACCode));
	}
	...
	public void setSystemEntryDate(XMLGregorianCalendar newSystemEntryDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__SYSTEM_ENTRY_DATE, oldSystemEntryDate, systemEntryDate));
	}
	...
	public void setTransactionID(String newTransactionID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__TRANSACTION_ID, oldTransactionID, transactionID));
	}
	...
	public void setCustomerID(String newCustomerID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__CUSTOMER_ID, oldCustomerID, customerID));
	}
	...
	public NotificationChain basicSetShipTo(ShippingPointStructure newShipTo, NotificationChain msgs) {
		...
		shipTo = newShipTo;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__SHIP_TO, oldShipTo, newShipTo);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setShipTo(ShippingPointStructure newShipTo) {
		if (newShipTo != shipTo) {
			NotificationChain msgs = null;
			if (shipTo != null)
				msgs = ((InternalEObject)shipTo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.INVOICE_TYPE__SHIP_TO, null, msgs);
			if (newShipTo != null)
				msgs = ((InternalEObject)newShipTo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.INVOICE_TYPE__SHIP_TO, null, msgs);
			msgs = basicSetShipTo(newShipTo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__SHIP_TO, newShipTo, newShipTo));
	}
	...
	public NotificationChain basicSetShipFrom(ShippingPointStructure newShipFrom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__SHIP_FROM, oldShipFrom, newShipFrom);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setShipFrom(ShippingPointStructure newShipFrom) {
		if (newShipFrom != shipFrom) {
			NotificationChain msgs = null;
			if (shipFrom != null)
				msgs = ((InternalEObject)shipFrom).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.INVOICE_TYPE__SHIP_FROM, null, msgs);
			if (newShipFrom != null)
				msgs = ((InternalEObject)newShipFrom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.INVOICE_TYPE__SHIP_FROM, null, msgs);
			msgs = basicSetShipFrom(newShipFrom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__SHIP_FROM, newShipFrom, newShipFrom));
	}
	...
	public void setMovementEndTime(XMLGregorianCalendar newMovementEndTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__MOVEMENT_END_TIME, oldMovementEndTime, movementEndTime));
	}
	...
	public void setMovementStartTime(XMLGregorianCalendar newMovementStartTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__MOVEMENT_START_TIME, oldMovementStartTime, movementStartTime));
	}
	...
	public EList<LineType2> getLine() {
		if (line == null) {
			line = new EObjectContainmentEList<LineType2>(LineType2.class, this, _301Package.INVOICE_TYPE__LINE);
		}
		return line;
	}
	...
	public NotificationChain basicSetDocumentTotals(DocumentTotalsType3 newDocumentTotals, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__DOCUMENT_TOTALS, oldDocumentTotals, newDocumentTotals);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDocumentTotals(DocumentTotalsType3 newDocumentTotals) {
		if (newDocumentTotals != documentTotals) {
			...
			if (documentTotals != null)
				msgs = ((InternalEObject)documentTotals).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.INVOICE_TYPE__DOCUMENT_TOTALS, null, msgs);
			if (newDocumentTotals != null)
				msgs = ((InternalEObject)newDocumentTotals).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.INVOICE_TYPE__DOCUMENT_TOTALS, null, msgs);
			msgs = basicSetDocumentTotals(newDocumentTotals, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.INVOICE_TYPE__DOCUMENT_TOTALS, newDocumentTotals, newDocumentTotals));
	}
	...
	public EList<WithholdingTax> getWithholdingTax() {
		if (withholdingTax == null) {
			withholdingTax = new EObjectContainmentEList<WithholdingTax>(WithholdingTax.class, this, _301Package.INVOICE_TYPE__WITHHOLDING_TAX);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _301Package.INVOICE_TYPE__DOCUMENT_STATUS:
				return basicSetDocumentStatus(null, msgs);
			case _301Package.INVOICE_TYPE__SPECIAL_REGIMES:
				return basicSetSpecialRegimes(null, msgs);
			case _301Package.INVOICE_TYPE__SHIP_TO:
				return basicSetShipTo(null, msgs);
			case _301Package.INVOICE_TYPE__SHIP_FROM:
				return basicSetShipFrom(null, msgs);
			case _301Package.INVOICE_TYPE__LINE:
				return ((InternalEList<?>)getLine()).basicRemove(otherEnd, msgs);
			case _301Package.INVOICE_TYPE__DOCUMENT_TOTALS:
				return basicSetDocumentTotals(null, msgs);
			case _301Package.INVOICE_TYPE__WITHHOLDING_TAX:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.INVOICE_TYPE__INVOICE_NO:
				return getInvoiceNo();
			case _301Package.INVOICE_TYPE__DOCUMENT_STATUS:
				return getDocumentStatus();
			case _301Package.INVOICE_TYPE__HASH:
				return getHash();
			case _301Package.INVOICE_TYPE__HASH_CONTROL:
				return getHashControl();
			case _301Package.INVOICE_TYPE__PERIOD:
				return getPeriod();
			case _301Package.INVOICE_TYPE__INVOICE_DATE:
				return getInvoiceDate();
			case _301Package.INVOICE_TYPE__INVOICE_TYPE:
				return getInvoiceType();
			case _301Package.INVOICE_TYPE__SPECIAL_REGIMES:
				return getSpecialRegimes();
			case _301Package.INVOICE_TYPE__SOURCE_ID:
				return getSourceID();
			case _301Package.INVOICE_TYPE__EAC_CODE:
				return getEACCode();
			case _301Package.INVOICE_TYPE__SYSTEM_ENTRY_DATE:
				return getSystemEntryDate();
			case _301Package.INVOICE_TYPE__TRANSACTION_ID:
				return getTransactionID();
			case _301Package.INVOICE_TYPE__CUSTOMER_ID:
				return getCustomerID();
			case _301Package.INVOICE_TYPE__SHIP_TO:
				return getShipTo();
			case _301Package.INVOICE_TYPE__SHIP_FROM:
				return getShipFrom();
			case _301Package.INVOICE_TYPE__MOVEMENT_END_TIME:
				return getMovementEndTime();
			case _301Package.INVOICE_TYPE__MOVEMENT_START_TIME:
