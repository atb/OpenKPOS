 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.PaymentsTypeImpl#getNumberOfEntries <em>Number Of Entries</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.PaymentsTypeImpl#getTotalDebit <em>Total Debit</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.PaymentsTypeImpl#getTotalCredit <em>Total Credit</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.PaymentsTypeImpl#getPayment <em>Payment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PaymentsTypeImpl extends EObjectImpl implements PaymentsType {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getPaymentsType();
	}
	...
	public void setNumberOfEntries(BigInteger newNumberOfEntries) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.PAYMENTS_TYPE__NUMBER_OF_ENTRIES, oldNumberOfEntries, numberOfEntries));
	}
	...
	public void setTotalDebit(BigDecimal newTotalDebit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.PAYMENTS_TYPE__TOTAL_DEBIT, oldTotalDebit, totalDebit));
	}
	...
	public void setTotalCredit(BigDecimal newTotalCredit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.PAYMENTS_TYPE__TOTAL_CREDIT, oldTotalCredit, totalCredit));
	}
	...
	public EList<PaymentType> getPayment() {
		if (payment == null) {
			payment = new EObjectContainmentEList<PaymentType>(PaymentType.class, this, _301Package.PAYMENTS_TYPE__PAYMENT);
		}
		return payment;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _301Package.PAYMENTS_TYPE__PAYMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.PAYMENTS_TYPE__NUMBER_OF_ENTRIES:
				return getNumberOfEntries();
			case _301Package.PAYMENTS_TYPE__TOTAL_DEBIT:
				return getTotalDebit();
			case _301Package.PAYMENTS_TYPE__TOTAL_CREDIT:
