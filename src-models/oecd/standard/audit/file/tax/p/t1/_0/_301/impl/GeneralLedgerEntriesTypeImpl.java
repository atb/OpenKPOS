...
import oecd.standard.audit.file.tax.p.t1._0._301.JournalType;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.GeneralLedgerEntriesTypeImpl#getNumberOfEntries <em>Number Of Entries</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.GeneralLedgerEntriesTypeImpl#getTotalDebit <em>Total Debit</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.GeneralLedgerEntriesTypeImpl#getTotalCredit <em>Total Credit</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.GeneralLedgerEntriesTypeImpl#getJournal <em>Journal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralLedgerEntriesTypeImpl extends EObjectImpl implements GeneralLedgerEntriesType {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getGeneralLedgerEntriesType();
	}
	...
	public void setNumberOfEntries(BigInteger newNumberOfEntries) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.GENERAL_LEDGER_ENTRIES_TYPE__NUMBER_OF_ENTRIES, oldNumberOfEntries, numberOfEntries));
	}
	...
	public void setTotalDebit(BigDecimal newTotalDebit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.GENERAL_LEDGER_ENTRIES_TYPE__TOTAL_DEBIT, oldTotalDebit, totalDebit));
	}
	...
	public void setTotalCredit(BigDecimal newTotalCredit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.GENERAL_LEDGER_ENTRIES_TYPE__TOTAL_CREDIT, oldTotalCredit, totalCredit));
	}
	...
	public EList<JournalType> getJournal() {
		if (journal == null) {
			journal = new EObjectContainmentEList<JournalType>(JournalType.class, this, _301Package.GENERAL_LEDGER_ENTRIES_TYPE__JOURNAL);
		}
		return journal;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _301Package.GENERAL_LEDGER_ENTRIES_TYPE__JOURNAL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.GENERAL_LEDGER_ENTRIES_TYPE__NUMBER_OF_ENTRIES:
				return getNumberOfEntries();
			case _301Package.GENERAL_LEDGER_ENTRIES_TYPE__TOTAL_DEBIT:
				return getTotalDebit();
			case _301Package.GENERAL_LEDGER_ENTRIES_TYPE__TOTAL_CREDIT:
