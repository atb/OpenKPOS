 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.WithholdingTaxImpl#getWithholdingTaxType <em>Withholding Tax Type</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.WithholdingTaxImpl#getWithholdingTaxDescription <em>Withholding Tax Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.WithholdingTaxImpl#getWithholdingTaxAmount <em>Withholding Tax Amount</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WithholdingTaxImpl extends EObjectImpl implements WithholdingTax {
	...
	protected EClass eStaticClass() {
		return _201Package.eINSTANCE.getWithholdingTax();
	}
	...
	public void setWithholdingTaxType(WithholdingTaxTypeType newWithholdingTaxType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.WITHHOLDING_TAX__WITHHOLDING_TAX_TYPE, oldWithholdingTaxType, withholdingTaxType, !oldWithholdingTaxTypeESet));
	}
	...
	public void unsetWithholdingTaxType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _201Package.WITHHOLDING_TAX__WITHHOLDING_TAX_TYPE, oldWithholdingTaxType, WITHHOLDING_TAX_TYPE_EDEFAULT, oldWithholdingTaxTypeESet));
	}
	...
	public void setWithholdingTaxDescription(String newWithholdingTaxDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.WITHHOLDING_TAX__WITHHOLDING_TAX_DESCRIPTION, oldWithholdingTaxDescription, withholdingTaxDescription));
	}
	...
	public void setWithholdingTaxAmount(BigDecimal newWithholdingTaxAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.WITHHOLDING_TAX__WITHHOLDING_TAX_AMOUNT, oldWithholdingTaxAmount, withholdingTaxAmount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _201Package.WITHHOLDING_TAX__WITHHOLDING_TAX_TYPE:
				return getWithholdingTaxType();
			case _201Package.WITHHOLDING_TAX__WITHHOLDING_TAX_DESCRIPTION:
				return getWithholdingTaxDescription();
			case _201Package.WITHHOLDING_TAX__WITHHOLDING_TAX_AMOUNT:
