...
import oecd.standard.audit.file.tax.p.t1._0._301.MasterFilesType;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.AuditFileTypeImpl#getHeader <em>Header</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.AuditFileTypeImpl#getMasterFiles <em>Master Files</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.AuditFileTypeImpl#getGeneralLedgerEntries <em>General Ledger Entries</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.AuditFileTypeImpl#getSourceDocuments <em>Source Documents</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AuditFileTypeImpl extends EObjectImpl implements AuditFileType {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getAuditFileType();
	}
	...
	public NotificationChain basicSetHeader(HeaderType newHeader, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.AUDIT_FILE_TYPE__HEADER, oldHeader, newHeader);
	...
	public void setHeader(HeaderType newHeader) {
		if (newHeader != header) {
			...
			if (header != null)
				msgs = ((InternalEObject)header).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.AUDIT_FILE_TYPE__HEADER, null, msgs);
			if (newHeader != null)
				msgs = ((InternalEObject)newHeader).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.AUDIT_FILE_TYPE__HEADER, null, msgs);
			msgs = basicSetHeader(newHeader, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.AUDIT_FILE_TYPE__HEADER, newHeader, newHeader));
	}
	...
	public NotificationChain basicSetMasterFiles(MasterFilesType newMasterFiles, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.AUDIT_FILE_TYPE__MASTER_FILES, oldMasterFiles, newMasterFiles);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMasterFiles(MasterFilesType newMasterFiles) {
		if (newMasterFiles != masterFiles) {
			NotificationChain msgs = null;
			if (masterFiles != null)
				msgs = ((InternalEObject)masterFiles).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.AUDIT_FILE_TYPE__MASTER_FILES, null, msgs);
			if (newMasterFiles != null)
				msgs = ((InternalEObject)newMasterFiles).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.AUDIT_FILE_TYPE__MASTER_FILES, null, msgs);
			msgs = basicSetMasterFiles(newMasterFiles, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.AUDIT_FILE_TYPE__MASTER_FILES, newMasterFiles, newMasterFiles));
	}
	...
	public NotificationChain basicSetGeneralLedgerEntries(GeneralLedgerEntriesType newGeneralLedgerEntries, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.AUDIT_FILE_TYPE__GENERAL_LEDGER_ENTRIES, oldGeneralLedgerEntries, newGeneralLedgerEntries);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGeneralLedgerEntries(GeneralLedgerEntriesType newGeneralLedgerEntries) {
		if (newGeneralLedgerEntries != generalLedgerEntries) {
			...
			if (generalLedgerEntries != null)
				msgs = ((InternalEObject)generalLedgerEntries).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.AUDIT_FILE_TYPE__GENERAL_LEDGER_ENTRIES, null, msgs);
			if (newGeneralLedgerEntries != null)
				msgs = ((InternalEObject)newGeneralLedgerEntries).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.AUDIT_FILE_TYPE__GENERAL_LEDGER_ENTRIES, null, msgs);
			msgs = basicSetGeneralLedgerEntries(newGeneralLedgerEntries, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.AUDIT_FILE_TYPE__GENERAL_LEDGER_ENTRIES, newGeneralLedgerEntries, newGeneralLedgerEntries));
	}
	...
	public NotificationChain basicSetSourceDocuments(SourceDocumentsType newSourceDocuments, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.AUDIT_FILE_TYPE__SOURCE_DOCUMENTS, oldSourceDocuments, newSourceDocuments);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSourceDocuments(SourceDocumentsType newSourceDocuments) {
		if (newSourceDocuments != sourceDocuments) {
			...
			if (sourceDocuments != null)
				msgs = ((InternalEObject)sourceDocuments).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.AUDIT_FILE_TYPE__SOURCE_DOCUMENTS, null, msgs);
			if (newSourceDocuments != null)
				msgs = ((InternalEObject)newSourceDocuments).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.AUDIT_FILE_TYPE__SOURCE_DOCUMENTS, null, msgs);
			msgs = basicSetSourceDocuments(newSourceDocuments, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.AUDIT_FILE_TYPE__SOURCE_DOCUMENTS, newSourceDocuments, newSourceDocuments));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _301Package.AUDIT_FILE_TYPE__HEADER:
				return basicSetHeader(null, msgs);
			case _301Package.AUDIT_FILE_TYPE__MASTER_FILES:
				return basicSetMasterFiles(null, msgs);
			case _301Package.AUDIT_FILE_TYPE__GENERAL_LEDGER_ENTRIES:
				return basicSetGeneralLedgerEntries(null, msgs);
			case _301Package.AUDIT_FILE_TYPE__SOURCE_DOCUMENTS:
