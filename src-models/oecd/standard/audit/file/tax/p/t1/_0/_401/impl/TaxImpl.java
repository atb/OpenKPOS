 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TaxImpl#getTaxType <em>Tax Type</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TaxImpl#getTaxCountryRegion <em>Tax Country Region</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TaxImpl#getTaxCode <em>Tax Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TaxImpl#getTaxPercentage <em>Tax Percentage</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TaxImpl#getTaxAmount <em>Tax Amount</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TaxImpl extends EObjectImpl implements Tax {
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getTax();
	}
	...
	public void setTaxType(TaxTypeType newTaxType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TAX__TAX_TYPE, oldTaxType, taxType, !oldTaxTypeESet));
	}
	...
	public void unsetTaxType() {
		...
		taxTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _401Package.TAX__TAX_TYPE, oldTaxType, TAX_TYPE_EDEFAULT, oldTaxTypeESet));
	}
	...
	public void setTaxCountryRegion(String newTaxCountryRegion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TAX__TAX_COUNTRY_REGION, oldTaxCountryRegion, taxCountryRegion));
	}
	...
	public void setTaxCode(String newTaxCode) {
		...
		taxCode = newTaxCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TAX__TAX_CODE, oldTaxCode, taxCode));
	}
	...
	public void setTaxPercentage(BigDecimal newTaxPercentage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TAX__TAX_PERCENTAGE, oldTaxPercentage, taxPercentage));
	}
	...
	public void setTaxAmount(BigDecimal newTaxAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TAX__TAX_AMOUNT, oldTaxAmount, taxAmount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.TAX__TAX_TYPE:
				return getTaxType();
			case _401Package.TAX__TAX_COUNTRY_REGION:
				return getTaxCountryRegion();
			case _401Package.TAX__TAX_CODE:
				return getTaxCode();
			case _401Package.TAX__TAX_PERCENTAGE:
				return getTaxPercentage();
			case _401Package.TAX__TAX_AMOUNT:
				return getTaxAmount();
		}
