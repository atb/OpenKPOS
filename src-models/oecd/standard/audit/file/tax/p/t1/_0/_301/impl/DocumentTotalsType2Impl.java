...
import oecd.standard.audit.file.tax.p.t1._0._301.SettlementType;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType2Impl#getTaxPayable <em>Tax Payable</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType2Impl#getNetTotal <em>Net Total</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType2Impl#getGrossTotal <em>Gross Total</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType2Impl#getSettlement <em>Settlement</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType2Impl#getCurrency <em>Currency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentTotalsType2Impl extends EObjectImpl implements DocumentTotalsType2 {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getDocumentTotalsType2();
	}
	...
	public void setTaxPayable(BigDecimal newTaxPayable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE2__TAX_PAYABLE, oldTaxPayable, taxPayable));
	}
	...
	public void setNetTotal(BigDecimal newNetTotal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE2__NET_TOTAL, oldNetTotal, netTotal));
	}
	...
	public void setGrossTotal(BigDecimal newGrossTotal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE2__GROSS_TOTAL, oldGrossTotal, grossTotal));
	}
	...
	public NotificationChain basicSetSettlement(SettlementType newSettlement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE2__SETTLEMENT, oldSettlement, newSettlement);
	...
	public void setSettlement(SettlementType newSettlement) {
		if (newSettlement != settlement) {
			...
			if (settlement != null)
				msgs = ((InternalEObject)settlement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.DOCUMENT_TOTALS_TYPE2__SETTLEMENT, null, msgs);
			if (newSettlement != null)
				msgs = ((InternalEObject)newSettlement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.DOCUMENT_TOTALS_TYPE2__SETTLEMENT, null, msgs);
			msgs = basicSetSettlement(newSettlement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE2__SETTLEMENT, newSettlement, newSettlement));
	}
	...
	public NotificationChain basicSetCurrency(Currency newCurrency, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE2__CURRENCY, oldCurrency, newCurrency);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCurrency(Currency newCurrency) {
		if (newCurrency != currency) {
			NotificationChain msgs = null;
			if (currency != null)
				msgs = ((InternalEObject)currency).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.DOCUMENT_TOTALS_TYPE2__CURRENCY, null, msgs);
			if (newCurrency != null)
				msgs = ((InternalEObject)newCurrency).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.DOCUMENT_TOTALS_TYPE2__CURRENCY, null, msgs);
			msgs = basicSetCurrency(newCurrency, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE2__CURRENCY, newCurrency, newCurrency));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _301Package.DOCUMENT_TOTALS_TYPE2__SETTLEMENT:
				return basicSetSettlement(null, msgs);
			case _301Package.DOCUMENT_TOTALS_TYPE2__CURRENCY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.DOCUMENT_TOTALS_TYPE2__TAX_PAYABLE:
				return getTaxPayable();
			case _301Package.DOCUMENT_TOTALS_TYPE2__NET_TOTAL:
				return getNetTotal();
			case _301Package.DOCUMENT_TOTALS_TYPE2__GROSS_TOTAL:
