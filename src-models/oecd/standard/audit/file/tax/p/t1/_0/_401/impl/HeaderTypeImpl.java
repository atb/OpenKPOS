 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getAuditFileVersion <em>Audit File Version</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getCompanyID <em>Company ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getTaxRegistrationNumber <em>Tax Registration Number</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getTaxAccountingBasis <em>Tax Accounting Basis</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getCompanyName <em>Company Name</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getBusinessName <em>Business Name</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getCompanyAddress <em>Company Address</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getFiscalYear <em>Fiscal Year</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getStartDate <em>Start Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getEndDate <em>End Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getCurrencyCode <em>Currency Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getDateCreated <em>Date Created</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getTaxEntity <em>Tax Entity</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getProductCompanyTaxID <em>Product Company Tax ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getSoftwareCertificateNumber <em>Software Certificate Number</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getProductID <em>Product ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getProductVersion <em>Product Version</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getHeaderComment <em>Header Comment</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getTelephone <em>Telephone</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getFax <em>Fax</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.HeaderTypeImpl#getWebsite <em>Website</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HeaderTypeImpl extends EObjectImpl implements HeaderType {
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getHeaderType();
	}
	...
	public void setAuditFileVersion(String newAuditFileVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__AUDIT_FILE_VERSION, oldAuditFileVersion, auditFileVersion));
	}
	...
	public void setCompanyID(String newCompanyID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__COMPANY_ID, oldCompanyID, companyID));
	}
	...
	public void setTaxRegistrationNumber(BigInteger newTaxRegistrationNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__TAX_REGISTRATION_NUMBER, oldTaxRegistrationNumber, taxRegistrationNumber));
	}
	...
	public void setTaxAccountingBasis(TaxAccountingBasisType newTaxAccountingBasis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__TAX_ACCOUNTING_BASIS, oldTaxAccountingBasis, taxAccountingBasis, !oldTaxAccountingBasisESet));
	}
	...
	public void unsetTaxAccountingBasis() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _401Package.HEADER_TYPE__TAX_ACCOUNTING_BASIS, oldTaxAccountingBasis, TAX_ACCOUNTING_BASIS_EDEFAULT, oldTaxAccountingBasisESet));
	}
	...
	public void setCompanyName(String newCompanyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__COMPANY_NAME, oldCompanyName, companyName));
	}
	...
	public void setBusinessName(String newBusinessName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__BUSINESS_NAME, oldBusinessName, businessName));
	}
	...
	public NotificationChain basicSetCompanyAddress(AddressStructurePT newCompanyAddress, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__COMPANY_ADDRESS, oldCompanyAddress, newCompanyAddress);
	...
	public void setCompanyAddress(AddressStructurePT newCompanyAddress) {
		if (newCompanyAddress != companyAddress) {
			...
			if (companyAddress != null)
				msgs = ((InternalEObject)companyAddress).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _401Package.HEADER_TYPE__COMPANY_ADDRESS, null, msgs);
			if (newCompanyAddress != null)
				msgs = ((InternalEObject)newCompanyAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _401Package.HEADER_TYPE__COMPANY_ADDRESS, null, msgs);
			msgs = basicSetCompanyAddress(newCompanyAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__COMPANY_ADDRESS, newCompanyAddress, newCompanyAddress));
	}
	...
	public void setFiscalYear(BigInteger newFiscalYear) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__FISCAL_YEAR, oldFiscalYear, fiscalYear));
	}
	...
	public void setStartDate(XMLGregorianCalendar newStartDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__START_DATE, oldStartDate, startDate));
	}
	...
	public void setEndDate(XMLGregorianCalendar newEndDate) {
		...
		endDate = newEndDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__END_DATE, oldEndDate, endDate));
	}
	...
	public void setCurrencyCode(String newCurrencyCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__CURRENCY_CODE, oldCurrencyCode, currencyCode, !oldCurrencyCodeESet));
	}
	...
	public void unsetCurrencyCode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _401Package.HEADER_TYPE__CURRENCY_CODE, oldCurrencyCode, CURRENCY_CODE_EDEFAULT, oldCurrencyCodeESet));
	}
	...
	public void setDateCreated(XMLGregorianCalendar newDateCreated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__DATE_CREATED, oldDateCreated, dateCreated));
	}
	...
	public void setTaxEntity(String newTaxEntity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__TAX_ENTITY, oldTaxEntity, taxEntity));
	}
	...
	public void setProductCompanyTaxID(String newProductCompanyTaxID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__PRODUCT_COMPANY_TAX_ID, oldProductCompanyTaxID, productCompanyTaxID));
	}
	...
	public void setSoftwareCertificateNumber(BigInteger newSoftwareCertificateNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__SOFTWARE_CERTIFICATE_NUMBER, oldSoftwareCertificateNumber, softwareCertificateNumber));
	}
	...
	public void setProductID(String newProductID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__PRODUCT_ID, oldProductID, productID));
	}
	...
	public void setProductVersion(String newProductVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__PRODUCT_VERSION, oldProductVersion, productVersion));
	}
	...
	public void setHeaderComment(String newHeaderComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__HEADER_COMMENT, oldHeaderComment, headerComment));
	}
	...
	public void setTelephone(String newTelephone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__TELEPHONE, oldTelephone, telephone));
	}
	...
	public void setFax(String newFax) {
		...
		fax = newFax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__FAX, oldFax, fax));
	}
	...
	public void setEmail(String newEmail) {
		...
		email = newEmail;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__EMAIL, oldEmail, email));
	}
	...
	public void setWebsite(String newWebsite) {
		...
		website = newWebsite;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.HEADER_TYPE__WEBSITE, oldWebsite, website));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _401Package.HEADER_TYPE__COMPANY_ADDRESS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.HEADER_TYPE__AUDIT_FILE_VERSION:
				return getAuditFileVersion();
			case _401Package.HEADER_TYPE__COMPANY_ID:
				return getCompanyID();
			case _401Package.HEADER_TYPE__TAX_REGISTRATION_NUMBER:
				return getTaxRegistrationNumber();
			case _401Package.HEADER_TYPE__TAX_ACCOUNTING_BASIS:
				return getTaxAccountingBasis();
			case _401Package.HEADER_TYPE__COMPANY_NAME:
				return getCompanyName();
			case _401Package.HEADER_TYPE__BUSINESS_NAME:
				return getBusinessName();
			case _401Package.HEADER_TYPE__COMPANY_ADDRESS:
				return getCompanyAddress();
			case _401Package.HEADER_TYPE__FISCAL_YEAR:
				return getFiscalYear();
			case _401Package.HEADER_TYPE__START_DATE:
				return getStartDate();
			case _401Package.HEADER_TYPE__END_DATE:
				return getEndDate();
			case _401Package.HEADER_TYPE__CURRENCY_CODE:
				return getCurrencyCode();
			case _401Package.HEADER_TYPE__DATE_CREATED:
				return getDateCreated();
			case _401Package.HEADER_TYPE__TAX_ENTITY:
				return getTaxEntity();
			case _401Package.HEADER_TYPE__PRODUCT_COMPANY_TAX_ID:
				return getProductCompanyTaxID();
			case _401Package.HEADER_TYPE__SOFTWARE_CERTIFICATE_NUMBER:
				return getSoftwareCertificateNumber();
			case _401Package.HEADER_TYPE__PRODUCT_ID:
				return getProductID();
			case _401Package.HEADER_TYPE__PRODUCT_VERSION:
				return getProductVersion();
			case _401Package.HEADER_TYPE__HEADER_COMMENT:
				return getHeaderComment();
			case _401Package.HEADER_TYPE__TELEPHONE:
				return getTelephone();
			case _401Package.HEADER_TYPE__FAX:
				return getFax();
			case _401Package.HEADER_TYPE__EMAIL:
				return getEmail();
			case _401Package.HEADER_TYPE__WEBSITE:
				return getWebsite();
		}
