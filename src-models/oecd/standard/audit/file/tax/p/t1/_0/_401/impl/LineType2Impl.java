...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Line Type2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getLineNumber <em>Line Number</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getOrderReferences <em>Order References</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getProductCode <em>Product Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getProductDescription <em>Product Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getUnitOfMeasure <em>Unit Of Measure</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getTaxBase <em>Tax Base</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getTaxPointDate <em>Tax Point Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getReferences <em>References</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getDescription <em>Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getProductSerialNumber <em>Product Serial Number</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getDebitAmount <em>Debit Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getCreditAmount <em>Credit Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getTax <em>Tax</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getTaxExemptionReason <em>Tax Exemption Reason</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getTaxExemptionCode <em>Tax Exemption Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getSettlementAmount <em>Settlement Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.LineType2Impl#getCustomsInformation <em>Customs Information</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LineType2Impl extends EObjectImpl implements LineType2 {
	/**
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getLineType2();
	}
	...
	public void setLineNumber(BigInteger newLineNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__LINE_NUMBER, oldLineNumber, lineNumber));
	}
	...
	public EList<OrderReferences> getOrderReferences() {
		if (orderReferences == null) {
			orderReferences = new EObjectContainmentEList<OrderReferences>(OrderReferences.class, this, _401Package.LINE_TYPE2__ORDER_REFERENCES);
		}
	...
	public void setProductCode(String newProductCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__PRODUCT_CODE, oldProductCode, productCode));
	}
	...
	public void setProductDescription(String newProductDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__PRODUCT_DESCRIPTION, oldProductDescription, productDescription));
	}
	...
	public void setQuantity(BigDecimal newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__QUANTITY, oldQuantity, quantity));
	}
	...
	public void setUnitOfMeasure(String newUnitOfMeasure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__UNIT_OF_MEASURE, oldUnitOfMeasure, unitOfMeasure));
	}
	...
	public void setUnitPrice(BigDecimal newUnitPrice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__UNIT_PRICE, oldUnitPrice, unitPrice));
	}
	...
	public void setTaxBase(BigDecimal newTaxBase) {
		...
		taxBase = newTaxBase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__TAX_BASE, oldTaxBase, taxBase));
	}
	...
	public void setTaxPointDate(XMLGregorianCalendar newTaxPointDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__TAX_POINT_DATE, oldTaxPointDate, taxPointDate));
	}
	...
	public EList<References> getReferences() {
		if (references == null) {
			references = new EObjectContainmentEList<References>(References.class, this, _401Package.LINE_TYPE2__REFERENCES);
		}
		return references;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetProductSerialNumber(ProductSerialNumber newProductSerialNumber, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__PRODUCT_SERIAL_NUMBER, oldProductSerialNumber, newProductSerialNumber);
	...
	public void setProductSerialNumber(ProductSerialNumber newProductSerialNumber) {
		if (newProductSerialNumber != productSerialNumber) {
			...
			if (productSerialNumber != null)
				msgs = ((InternalEObject)productSerialNumber).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _401Package.LINE_TYPE2__PRODUCT_SERIAL_NUMBER, null, msgs);
			if (newProductSerialNumber != null)
				msgs = ((InternalEObject)newProductSerialNumber).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _401Package.LINE_TYPE2__PRODUCT_SERIAL_NUMBER, null, msgs);
			msgs = basicSetProductSerialNumber(newProductSerialNumber, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__PRODUCT_SERIAL_NUMBER, newProductSerialNumber, newProductSerialNumber));
	}
	...
	public void setDebitAmount(BigDecimal newDebitAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__DEBIT_AMOUNT, oldDebitAmount, debitAmount));
	}
	...
	public void setCreditAmount(BigDecimal newCreditAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__CREDIT_AMOUNT, oldCreditAmount, creditAmount));
	}
	...
	public NotificationChain basicSetTax(Tax newTax, NotificationChain msgs) {
		...
		tax = newTax;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__TAX, oldTax, newTax);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTax(Tax newTax) {
		if (newTax != tax) {
			NotificationChain msgs = null;
			if (tax != null)
				msgs = ((InternalEObject)tax).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _401Package.LINE_TYPE2__TAX, null, msgs);
			if (newTax != null)
				msgs = ((InternalEObject)newTax).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _401Package.LINE_TYPE2__TAX, null, msgs);
			msgs = basicSetTax(newTax, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__TAX, newTax, newTax));
	}
	...
	public void setTaxExemptionReason(String newTaxExemptionReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__TAX_EXEMPTION_REASON, oldTaxExemptionReason, taxExemptionReason));
	}
	...
	public void setTaxExemptionCode(String newTaxExemptionCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__TAX_EXEMPTION_CODE, oldTaxExemptionCode, taxExemptionCode));
	}
	...
	public void setSettlementAmount(BigDecimal newSettlementAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__SETTLEMENT_AMOUNT, oldSettlementAmount, settlementAmount));
	}
	...
	public NotificationChain basicSetCustomsInformation(CustomsInformation newCustomsInformation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__CUSTOMS_INFORMATION, oldCustomsInformation, newCustomsInformation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCustomsInformation(CustomsInformation newCustomsInformation) {
		if (newCustomsInformation != customsInformation) {
			...
			if (customsInformation != null)
				msgs = ((InternalEObject)customsInformation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _401Package.LINE_TYPE2__CUSTOMS_INFORMATION, null, msgs);
			if (newCustomsInformation != null)
				msgs = ((InternalEObject)newCustomsInformation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _401Package.LINE_TYPE2__CUSTOMS_INFORMATION, null, msgs);
			msgs = basicSetCustomsInformation(newCustomsInformation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.LINE_TYPE2__CUSTOMS_INFORMATION, newCustomsInformation, newCustomsInformation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _401Package.LINE_TYPE2__ORDER_REFERENCES:
				return ((InternalEList<?>)getOrderReferences()).basicRemove(otherEnd, msgs);
			case _401Package.LINE_TYPE2__REFERENCES:
				return ((InternalEList<?>)getReferences()).basicRemove(otherEnd, msgs);
			case _401Package.LINE_TYPE2__PRODUCT_SERIAL_NUMBER:
				return basicSetProductSerialNumber(null, msgs);
			case _401Package.LINE_TYPE2__TAX:
				return basicSetTax(null, msgs);
			case _401Package.LINE_TYPE2__CUSTOMS_INFORMATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.LINE_TYPE2__LINE_NUMBER:
				return getLineNumber();
			case _401Package.LINE_TYPE2__ORDER_REFERENCES:
				return getOrderReferences();
			case _401Package.LINE_TYPE2__PRODUCT_CODE:
				return getProductCode();
			case _401Package.LINE_TYPE2__PRODUCT_DESCRIPTION:
				return getProductDescription();
			case _401Package.LINE_TYPE2__QUANTITY:
				return getQuantity();
			case _401Package.LINE_TYPE2__UNIT_OF_MEASURE:
				return getUnitOfMeasure();
			case _401Package.LINE_TYPE2__UNIT_PRICE:
				return getUnitPrice();
			case _401Package.LINE_TYPE2__TAX_BASE:
				return getTaxBase();
			case _401Package.LINE_TYPE2__TAX_POINT_DATE:
				return getTaxPointDate();
			case _401Package.LINE_TYPE2__REFERENCES:
				return getReferences();
			case _401Package.LINE_TYPE2__DESCRIPTION:
				return getDescription();
			case _401Package.LINE_TYPE2__PRODUCT_SERIAL_NUMBER:
				return getProductSerialNumber();
			case _401Package.LINE_TYPE2__DEBIT_AMOUNT:
				return getDebitAmount();
			case _401Package.LINE_TYPE2__CREDIT_AMOUNT:
				return getCreditAmount();
			case _401Package.LINE_TYPE2__TAX:
				return getTax();
			case _401Package.LINE_TYPE2__TAX_EXEMPTION_REASON:
				return getTaxExemptionReason();
			case _401Package.LINE_TYPE2__TAX_EXEMPTION_CODE:
				return getTaxExemptionCode();
			case _401Package.LINE_TYPE2__SETTLEMENT_AMOUNT:
