...
import oecd.standard.audit.file.tax.p.t1._0._401.SAFTPTSourcePayment;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType2Impl#getPaymentStatus <em>Payment Status</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType2Impl#getPaymentStatusDate <em>Payment Status Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType2Impl#getReason <em>Reason</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType2Impl#getSourceID <em>Source ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentStatusType2Impl#getSourcePayment <em>Source Payment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentStatusType2Impl extends EObjectImpl implements DocumentStatusType2 {
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getDocumentStatusType2();
	}
	...
	public void setPaymentStatus(PaymentStatusType newPaymentStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE2__PAYMENT_STATUS, oldPaymentStatus, paymentStatus, !oldPaymentStatusESet));
	}
	...
	public void unsetPaymentStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _401Package.DOCUMENT_STATUS_TYPE2__PAYMENT_STATUS, oldPaymentStatus, PAYMENT_STATUS_EDEFAULT, oldPaymentStatusESet));
	}
	...
	public void setPaymentStatusDate(XMLGregorianCalendar newPaymentStatusDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE2__PAYMENT_STATUS_DATE, oldPaymentStatusDate, paymentStatusDate));
	}
	...
	public void setReason(String newReason) {
		...
		reason = newReason;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE2__REASON, oldReason, reason));
	}
	...
	public void setSourceID(String newSourceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE2__SOURCE_ID, oldSourceID, sourceID));
	}
	...
	public void setSourcePayment(SAFTPTSourcePayment newSourcePayment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_STATUS_TYPE2__SOURCE_PAYMENT, oldSourcePayment, sourcePayment, !oldSourcePaymentESet));
	}
	...
	public void unsetSourcePayment() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _401Package.DOCUMENT_STATUS_TYPE2__SOURCE_PAYMENT, oldSourcePayment, SOURCE_PAYMENT_EDEFAULT, oldSourcePaymentESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.DOCUMENT_STATUS_TYPE2__PAYMENT_STATUS:
				return getPaymentStatus();
			case _401Package.DOCUMENT_STATUS_TYPE2__PAYMENT_STATUS_DATE:
				return getPaymentStatusDate();
			case _401Package.DOCUMENT_STATUS_TYPE2__REASON:
				return getReason();
			case _401Package.DOCUMENT_STATUS_TYPE2__SOURCE_ID:
				return getSourceID();
			case _401Package.DOCUMENT_STATUS_TYPE2__SOURCE_PAYMENT:
