 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.PaymentMethodImpl#getPaymentMechanism <em>Payment Mechanism</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.PaymentMethodImpl#getPaymentAmount <em>Payment Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.PaymentMethodImpl#getPaymentDate <em>Payment Date</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PaymentMethodImpl extends EObjectImpl implements PaymentMethod {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getPaymentMethod();
	}
	...
	public void setPaymentMechanism(PaymentMechanismType newPaymentMechanism) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.PAYMENT_METHOD__PAYMENT_MECHANISM, oldPaymentMechanism, paymentMechanism, !oldPaymentMechanismESet));
	}
	...
	public void unsetPaymentMechanism() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _301Package.PAYMENT_METHOD__PAYMENT_MECHANISM, oldPaymentMechanism, PAYMENT_MECHANISM_EDEFAULT, oldPaymentMechanismESet));
	}
	...
	public void setPaymentAmount(BigDecimal newPaymentAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.PAYMENT_METHOD__PAYMENT_AMOUNT, oldPaymentAmount, paymentAmount));
	}
	...
	public void setPaymentDate(XMLGregorianCalendar newPaymentDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.PAYMENT_METHOD__PAYMENT_DATE, oldPaymentDate, paymentDate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.PAYMENT_METHOD__PAYMENT_MECHANISM:
				return getPaymentMechanism();
			case _301Package.PAYMENT_METHOD__PAYMENT_AMOUNT:
				return getPaymentAmount();
			case _301Package.PAYMENT_METHOD__PAYMENT_DATE:
