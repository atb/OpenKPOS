...
import oecd.standard.audit.file.tax.p.t1._0._401.DocumentStatusType2;
...
import oecd.standard.audit.file.tax.p.t1._0._401.SAFTPTPaymentType;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getPaymentRefNo <em>Payment Ref No</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getATCUD <em>ATCUD</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getTransactionID <em>Transaction ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getTransactionDate <em>Transaction Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getPaymentType <em>Payment Type</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getSystemID <em>System ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getDocumentStatus <em>Document Status</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getPaymentMethod <em>Payment Method</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getSourceID <em>Source ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getSystemEntryDate <em>System Entry Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getCustomerID <em>Customer ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getLine <em>Line</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getDocumentTotals <em>Document Totals</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.PaymentTypeImpl#getWithholdingTax <em>Withholding Tax</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PaymentTypeImpl extends EObjectImpl implements PaymentType {
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getPaymentType();
	}
	...
	public void setPaymentRefNo(String newPaymentRefNo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__PAYMENT_REF_NO, oldPaymentRefNo, paymentRefNo));
	}
	...
	public void setATCUD(String newATCUD) {
		...
		aTCUD = newATCUD;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__ATCUD, oldATCUD, aTCUD));
	}
	...
	public void setPeriod(BigInteger newPeriod) {
		...
		period = newPeriod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__PERIOD, oldPeriod, period));
	}
	...
	public void setTransactionID(String newTransactionID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__TRANSACTION_ID, oldTransactionID, transactionID));
	}
	...
	public void setTransactionDate(XMLGregorianCalendar newTransactionDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__TRANSACTION_DATE, oldTransactionDate, transactionDate));
	}
	...
	public void setPaymentType(SAFTPTPaymentType newPaymentType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__PAYMENT_TYPE, oldPaymentType, paymentType, !oldPaymentTypeESet));
	}
	...
	public void unsetPaymentType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _401Package.PAYMENT_TYPE__PAYMENT_TYPE, oldPaymentType, PAYMENT_TYPE_EDEFAULT, oldPaymentTypeESet));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setSystemID(String newSystemID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__SYSTEM_ID, oldSystemID, systemID));
	}
	...
	public NotificationChain basicSetDocumentStatus(DocumentStatusType2 newDocumentStatus, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__DOCUMENT_STATUS, oldDocumentStatus, newDocumentStatus);
	...
	public void setDocumentStatus(DocumentStatusType2 newDocumentStatus) {
		if (newDocumentStatus != documentStatus) {
			...
			if (documentStatus != null)
				msgs = ((InternalEObject)documentStatus).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _401Package.PAYMENT_TYPE__DOCUMENT_STATUS, null, msgs);
			if (newDocumentStatus != null)
				msgs = ((InternalEObject)newDocumentStatus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _401Package.PAYMENT_TYPE__DOCUMENT_STATUS, null, msgs);
			msgs = basicSetDocumentStatus(newDocumentStatus, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__DOCUMENT_STATUS, newDocumentStatus, newDocumentStatus));
	}
	...
	public EList<PaymentMethod> getPaymentMethod() {
		if (paymentMethod == null) {
			paymentMethod = new EObjectContainmentEList<PaymentMethod>(PaymentMethod.class, this, _401Package.PAYMENT_TYPE__PAYMENT_METHOD);
		}
	...
	public void setSourceID(String newSourceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__SOURCE_ID, oldSourceID, sourceID));
	}
	...
	public void setSystemEntryDate(XMLGregorianCalendar newSystemEntryDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__SYSTEM_ENTRY_DATE, oldSystemEntryDate, systemEntryDate));
	}
	...
	public void setCustomerID(String newCustomerID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__CUSTOMER_ID, oldCustomerID, customerID));
	}
	...
	public EList<LineType> getLine() {
		if (line == null) {
			line = new EObjectContainmentEList<LineType>(LineType.class, this, _401Package.PAYMENT_TYPE__LINE);
		}
		return line;
	}
	...
	public NotificationChain basicSetDocumentTotals(DocumentTotalsType1 newDocumentTotals, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__DOCUMENT_TOTALS, oldDocumentTotals, newDocumentTotals);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDocumentTotals(DocumentTotalsType1 newDocumentTotals) {
		if (newDocumentTotals != documentTotals) {
			...
			if (documentTotals != null)
				msgs = ((InternalEObject)documentTotals).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _401Package.PAYMENT_TYPE__DOCUMENT_TOTALS, null, msgs);
			if (newDocumentTotals != null)
				msgs = ((InternalEObject)newDocumentTotals).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _401Package.PAYMENT_TYPE__DOCUMENT_TOTALS, null, msgs);
			msgs = basicSetDocumentTotals(newDocumentTotals, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.PAYMENT_TYPE__DOCUMENT_TOTALS, newDocumentTotals, newDocumentTotals));
	}
	...
	public EList<WithholdingTax> getWithholdingTax() {
		if (withholdingTax == null) {
			withholdingTax = new EObjectContainmentEList<WithholdingTax>(WithholdingTax.class, this, _401Package.PAYMENT_TYPE__WITHHOLDING_TAX);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _401Package.PAYMENT_TYPE__DOCUMENT_STATUS:
				return basicSetDocumentStatus(null, msgs);
			case _401Package.PAYMENT_TYPE__PAYMENT_METHOD:
				return ((InternalEList<?>)getPaymentMethod()).basicRemove(otherEnd, msgs);
			case _401Package.PAYMENT_TYPE__LINE:
				return ((InternalEList<?>)getLine()).basicRemove(otherEnd, msgs);
			case _401Package.PAYMENT_TYPE__DOCUMENT_TOTALS:
				return basicSetDocumentTotals(null, msgs);
			case _401Package.PAYMENT_TYPE__WITHHOLDING_TAX:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.PAYMENT_TYPE__PAYMENT_REF_NO:
				return getPaymentRefNo();
			case _401Package.PAYMENT_TYPE__ATCUD:
				return getATCUD();
			case _401Package.PAYMENT_TYPE__PERIOD:
				return getPeriod();
			case _401Package.PAYMENT_TYPE__TRANSACTION_ID:
				return getTransactionID();
			case _401Package.PAYMENT_TYPE__TRANSACTION_DATE:
				return getTransactionDate();
			case _401Package.PAYMENT_TYPE__PAYMENT_TYPE:
				return getPaymentType();
			case _401Package.PAYMENT_TYPE__DESCRIPTION:
				return getDescription();
			case _401Package.PAYMENT_TYPE__SYSTEM_ID:
				return getSystemID();
			case _401Package.PAYMENT_TYPE__DOCUMENT_STATUS:
				return getDocumentStatus();
			case _401Package.PAYMENT_TYPE__PAYMENT_METHOD:
				return getPaymentMethod();
			case _401Package.PAYMENT_TYPE__SOURCE_ID:
				return getSourceID();
			case _401Package.PAYMENT_TYPE__SYSTEM_ENTRY_DATE:
				return getSystemEntryDate();
			case _401Package.PAYMENT_TYPE__CUSTOMER_ID:
