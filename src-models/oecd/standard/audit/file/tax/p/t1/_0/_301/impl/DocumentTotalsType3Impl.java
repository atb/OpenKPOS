...
import oecd.standard.audit.file.tax.p.t1._0._301.Settlement;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType3Impl#getTaxPayable <em>Tax Payable</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType3Impl#getNetTotal <em>Net Total</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType3Impl#getGrossTotal <em>Gross Total</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType3Impl#getCurrency <em>Currency</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType3Impl#getSettlement <em>Settlement</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentTotalsType3Impl#getPayment <em>Payment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentTotalsType3Impl extends EObjectImpl implements DocumentTotalsType3 {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getDocumentTotalsType3();
	}
	...
	public void setTaxPayable(BigDecimal newTaxPayable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE3__TAX_PAYABLE, oldTaxPayable, taxPayable));
	}
	...
	public void setNetTotal(BigDecimal newNetTotal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE3__NET_TOTAL, oldNetTotal, netTotal));
	}
	...
	public void setGrossTotal(BigDecimal newGrossTotal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE3__GROSS_TOTAL, oldGrossTotal, grossTotal));
	}
	...
	public NotificationChain basicSetCurrency(Currency newCurrency, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE3__CURRENCY, oldCurrency, newCurrency);
	...
	public void setCurrency(Currency newCurrency) {
		if (newCurrency != currency) {
			...
			if (currency != null)
				msgs = ((InternalEObject)currency).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.DOCUMENT_TOTALS_TYPE3__CURRENCY, null, msgs);
			if (newCurrency != null)
				msgs = ((InternalEObject)newCurrency).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.DOCUMENT_TOTALS_TYPE3__CURRENCY, null, msgs);
			msgs = basicSetCurrency(newCurrency, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_TOTALS_TYPE3__CURRENCY, newCurrency, newCurrency));
	}
	...
	public EList<Settlement> getSettlement() {
		if (settlement == null) {
			settlement = new EObjectContainmentEList<Settlement>(Settlement.class, this, _301Package.DOCUMENT_TOTALS_TYPE3__SETTLEMENT);
		}
		return settlement;
	}
	...
	public EList<PaymentMethod> getPayment() {
		if (payment == null) {
			payment = new EObjectContainmentEList<PaymentMethod>(PaymentMethod.class, this, _301Package.DOCUMENT_TOTALS_TYPE3__PAYMENT);
		}
		return payment;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _301Package.DOCUMENT_TOTALS_TYPE3__CURRENCY:
				return basicSetCurrency(null, msgs);
			case _301Package.DOCUMENT_TOTALS_TYPE3__SETTLEMENT:
				return ((InternalEList<?>)getSettlement()).basicRemove(otherEnd, msgs);
			case _301Package.DOCUMENT_TOTALS_TYPE3__PAYMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.DOCUMENT_TOTALS_TYPE3__TAX_PAYABLE:
				return getTaxPayable();
			case _301Package.DOCUMENT_TOTALS_TYPE3__NET_TOTAL:
				return getNetTotal();
			case _301Package.DOCUMENT_TOTALS_TYPE3__GROSS_TOTAL:
