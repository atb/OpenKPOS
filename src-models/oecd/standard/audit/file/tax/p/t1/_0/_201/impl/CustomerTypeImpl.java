 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.CustomerTypeImpl#getCustomerID <em>Customer ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.CustomerTypeImpl#getAccountID <em>Account ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.CustomerTypeImpl#getCustomerTaxID <em>Customer Tax ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.CustomerTypeImpl#getCompanyName <em>Company Name</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.CustomerTypeImpl#getContact <em>Contact</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.CustomerTypeImpl#getBillingAddress <em>Billing Address</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.CustomerTypeImpl#getShipToAddress <em>Ship To Address</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.CustomerTypeImpl#getTelephone <em>Telephone</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.CustomerTypeImpl#getFax <em>Fax</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.CustomerTypeImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.CustomerTypeImpl#getWebsite <em>Website</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.CustomerTypeImpl#getSelfBillingIndicator <em>Self Billing Indicator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CustomerTypeImpl extends EObjectImpl implements CustomerType {
	...
	protected EClass eStaticClass() {
		return _201Package.eINSTANCE.getCustomerType();
	}
	...
	public void setCustomerID(String newCustomerID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.CUSTOMER_TYPE__CUSTOMER_ID, oldCustomerID, customerID));
	}
	...
	public void setAccountID(String newAccountID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.CUSTOMER_TYPE__ACCOUNT_ID, oldAccountID, accountID));
	}
	...
	public void setCustomerTaxID(String newCustomerTaxID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.CUSTOMER_TYPE__CUSTOMER_TAX_ID, oldCustomerTaxID, customerTaxID));
	}
	...
	public void setCompanyName(String newCompanyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.CUSTOMER_TYPE__COMPANY_NAME, oldCompanyName, companyName));
	}
	...
	public void setContact(String newContact) {
		...
		contact = newContact;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.CUSTOMER_TYPE__CONTACT, oldContact, contact));
	}
	...
	public NotificationChain basicSetBillingAddress(AddressStructure newBillingAddress, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _201Package.CUSTOMER_TYPE__BILLING_ADDRESS, oldBillingAddress, newBillingAddress);
	...
	public void setBillingAddress(AddressStructure newBillingAddress) {
		if (newBillingAddress != billingAddress) {
			...
			if (billingAddress != null)
				msgs = ((InternalEObject)billingAddress).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _201Package.CUSTOMER_TYPE__BILLING_ADDRESS, null, msgs);
			if (newBillingAddress != null)
				msgs = ((InternalEObject)newBillingAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _201Package.CUSTOMER_TYPE__BILLING_ADDRESS, null, msgs);
			msgs = basicSetBillingAddress(newBillingAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.CUSTOMER_TYPE__BILLING_ADDRESS, newBillingAddress, newBillingAddress));
	}
	...
	public EList<AddressStructure> getShipToAddress() {
		if (shipToAddress == null) {
			shipToAddress = new EObjectContainmentEList<AddressStructure>(AddressStructure.class, this, _201Package.CUSTOMER_TYPE__SHIP_TO_ADDRESS);
		}
	...
	public void setTelephone(String newTelephone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.CUSTOMER_TYPE__TELEPHONE, oldTelephone, telephone));
	}
	...
	public void setFax(String newFax) {
		...
		fax = newFax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.CUSTOMER_TYPE__FAX, oldFax, fax));
	}
	...
	public void setEmail(String newEmail) {
		...
		email = newEmail;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.CUSTOMER_TYPE__EMAIL, oldEmail, email));
	}
	...
	public void setWebsite(String newWebsite) {
		...
		website = newWebsite;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.CUSTOMER_TYPE__WEBSITE, oldWebsite, website));
	}
	...
	public void setSelfBillingIndicator(BigInteger newSelfBillingIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.CUSTOMER_TYPE__SELF_BILLING_INDICATOR, oldSelfBillingIndicator, selfBillingIndicator));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _201Package.CUSTOMER_TYPE__BILLING_ADDRESS:
				return basicSetBillingAddress(null, msgs);
			case _201Package.CUSTOMER_TYPE__SHIP_TO_ADDRESS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _201Package.CUSTOMER_TYPE__CUSTOMER_ID:
				return getCustomerID();
			case _201Package.CUSTOMER_TYPE__ACCOUNT_ID:
				return getAccountID();
			case _201Package.CUSTOMER_TYPE__CUSTOMER_TAX_ID:
				return getCustomerTaxID();
			case _201Package.CUSTOMER_TYPE__COMPANY_NAME:
				return getCompanyName();
			case _201Package.CUSTOMER_TYPE__CONTACT:
				return getContact();
			case _201Package.CUSTOMER_TYPE__BILLING_ADDRESS:
				return getBillingAddress();
			case _201Package.CUSTOMER_TYPE__SHIP_TO_ADDRESS:
				return getShipToAddress();
			case _201Package.CUSTOMER_TYPE__TELEPHONE:
				return getTelephone();
			case _201Package.CUSTOMER_TYPE__FAX:
				return getFax();
			case _201Package.CUSTOMER_TYPE__EMAIL:
				return getEmail();
			case _201Package.CUSTOMER_TYPE__WEBSITE:
				return getWebsite();
			case _201Package.CUSTOMER_TYPE__SELF_BILLING_INDICATOR:
