 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.TaxTableTypeImpl#getTaxTableEntry <em>Tax Table Entry</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TaxTableTypeImpl extends EObjectImpl implements TaxTableType {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getTaxTableType();
	}
	...
	public EList<TaxTableEntryType> getTaxTableEntry() {
		if (taxTableEntry == null) {
			taxTableEntry = new EObjectContainmentEList<TaxTableEntryType>(TaxTableEntryType.class, this, _301Package.TAX_TABLE_TYPE__TAX_TABLE_ENTRY);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _301Package.TAX_TABLE_TYPE__TAX_TABLE_ENTRY:
