 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.WorkingDocumentsTypeImpl#getNumberOfEntries <em>Number Of Entries</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.WorkingDocumentsTypeImpl#getTotalDebit <em>Total Debit</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.WorkingDocumentsTypeImpl#getTotalCredit <em>Total Credit</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.WorkingDocumentsTypeImpl#getWorkDocument <em>Work Document</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WorkingDocumentsTypeImpl extends EObjectImpl implements WorkingDocumentsType {
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getWorkingDocumentsType();
	}
	...
	public void setNumberOfEntries(BigInteger newNumberOfEntries) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.WORKING_DOCUMENTS_TYPE__NUMBER_OF_ENTRIES, oldNumberOfEntries, numberOfEntries));
	}
	...
	public void setTotalDebit(BigDecimal newTotalDebit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.WORKING_DOCUMENTS_TYPE__TOTAL_DEBIT, oldTotalDebit, totalDebit));
	}
	...
	public void setTotalCredit(BigDecimal newTotalCredit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.WORKING_DOCUMENTS_TYPE__TOTAL_CREDIT, oldTotalCredit, totalCredit));
	}
	...
	public EList<WorkDocumentType> getWorkDocument() {
		if (workDocument == null) {
			workDocument = new EObjectContainmentEList<WorkDocumentType>(WorkDocumentType.class, this, _401Package.WORKING_DOCUMENTS_TYPE__WORK_DOCUMENT);
		}
		return workDocument;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _401Package.WORKING_DOCUMENTS_TYPE__WORK_DOCUMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.WORKING_DOCUMENTS_TYPE__NUMBER_OF_ENTRIES:
				return getNumberOfEntries();
			case _401Package.WORKING_DOCUMENTS_TYPE__TOTAL_DEBIT:
				return getTotalDebit();
			case _401Package.WORKING_DOCUMENTS_TYPE__TOTAL_CREDIT:
