 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.MovementOfGoodsTypeImpl#getNumberOfMovementLines <em>Number Of Movement Lines</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.MovementOfGoodsTypeImpl#getTotalQuantityIssued <em>Total Quantity Issued</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.MovementOfGoodsTypeImpl#getStockMovement <em>Stock Movement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MovementOfGoodsTypeImpl extends EObjectImpl implements MovementOfGoodsType {
	...
	protected EClass eStaticClass() {
		return _201Package.eINSTANCE.getMovementOfGoodsType();
	}
	...
	public void setNumberOfMovementLines(BigInteger newNumberOfMovementLines) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.MOVEMENT_OF_GOODS_TYPE__NUMBER_OF_MOVEMENT_LINES, oldNumberOfMovementLines, numberOfMovementLines));
	}
	...
	public void setTotalQuantityIssued(BigDecimal newTotalQuantityIssued) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.MOVEMENT_OF_GOODS_TYPE__TOTAL_QUANTITY_ISSUED, oldTotalQuantityIssued, totalQuantityIssued));
	}
	...
	public EList<StockMovementType> getStockMovement() {
		if (stockMovement == null) {
			stockMovement = new EObjectContainmentEList<StockMovementType>(StockMovementType.class, this, _201Package.MOVEMENT_OF_GOODS_TYPE__STOCK_MOVEMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _201Package.MOVEMENT_OF_GOODS_TYPE__STOCK_MOVEMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _201Package.MOVEMENT_OF_GOODS_TYPE__NUMBER_OF_MOVEMENT_LINES:
				return getNumberOfMovementLines();
			case _201Package.MOVEMENT_OF_GOODS_TYPE__TOTAL_QUANTITY_ISSUED:
