 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.AddressStructurePTImpl#getBuildingNumber <em>Building Number</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.AddressStructurePTImpl#getStreetName <em>Street Name</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.AddressStructurePTImpl#getAddressDetail <em>Address Detail</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.AddressStructurePTImpl#getCity <em>City</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.AddressStructurePTImpl#getPostalCode <em>Postal Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.AddressStructurePTImpl#getRegion <em>Region</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.AddressStructurePTImpl#getCountry <em>Country</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddressStructurePTImpl extends EObjectImpl implements AddressStructurePT {
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getAddressStructurePT();
	}
	...
	public void setBuildingNumber(String newBuildingNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.ADDRESS_STRUCTURE_PT__BUILDING_NUMBER, oldBuildingNumber, buildingNumber));
	}
	...
	public void setStreetName(String newStreetName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.ADDRESS_STRUCTURE_PT__STREET_NAME, oldStreetName, streetName));
	}
	...
	public void setAddressDetail(String newAddressDetail) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.ADDRESS_STRUCTURE_PT__ADDRESS_DETAIL, oldAddressDetail, addressDetail));
	}
	...
	public void setCity(String newCity) {
		...
		city = newCity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.ADDRESS_STRUCTURE_PT__CITY, oldCity, city));
	}
	...
	public void setPostalCode(String newPostalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.ADDRESS_STRUCTURE_PT__POSTAL_CODE, oldPostalCode, postalCode));
	}
	...
	public void setRegion(String newRegion) {
		...
		region = newRegion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.ADDRESS_STRUCTURE_PT__REGION, oldRegion, region));
	}
	...
	public void setCountry(String newCountry) {
		...
		countryESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.ADDRESS_STRUCTURE_PT__COUNTRY, oldCountry, country, !oldCountryESet));
	}
	...
	public void unsetCountry() {
		...
		countryESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _401Package.ADDRESS_STRUCTURE_PT__COUNTRY, oldCountry, COUNTRY_EDEFAULT, oldCountryESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.ADDRESS_STRUCTURE_PT__BUILDING_NUMBER:
				return getBuildingNumber();
			case _401Package.ADDRESS_STRUCTURE_PT__STREET_NAME:
				return getStreetName();
			case _401Package.ADDRESS_STRUCTURE_PT__ADDRESS_DETAIL:
				return getAddressDetail();
			case _401Package.ADDRESS_STRUCTURE_PT__CITY:
				return getCity();
			case _401Package.ADDRESS_STRUCTURE_PT__POSTAL_CODE:
				return getPostalCode();
			case _401Package.ADDRESS_STRUCTURE_PT__REGION:
				return getRegion();
			case _401Package.ADDRESS_STRUCTURE_PT__COUNTRY:
				return getCountry();
		}
