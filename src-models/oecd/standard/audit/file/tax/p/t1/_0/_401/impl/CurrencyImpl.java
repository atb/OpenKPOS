 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.CurrencyImpl#getCurrencyCode <em>Currency Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.CurrencyImpl#getCurrencyAmount <em>Currency Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.CurrencyImpl#getExchangeRate <em>Exchange Rate</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CurrencyImpl extends EObjectImpl implements Currency {
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getCurrency();
	}
	...
	public void setCurrencyCode(String newCurrencyCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.CURRENCY__CURRENCY_CODE, oldCurrencyCode, currencyCode));
	}
	...
	public void setCurrencyAmount(BigDecimal newCurrencyAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.CURRENCY__CURRENCY_AMOUNT, oldCurrencyAmount, currencyAmount));
	}
	...
	public void setExchangeRate(BigDecimal newExchangeRate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.CURRENCY__EXCHANGE_RATE, oldExchangeRate, exchangeRate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.CURRENCY__CURRENCY_CODE:
				return getCurrencyCode();
			case _401Package.CURRENCY__CURRENCY_AMOUNT:
				return getCurrencyAmount();
			case _401Package.CURRENCY__EXCHANGE_RATE:
