 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.GeneralLedgerTypeImpl#getAccountID <em>Account ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.GeneralLedgerTypeImpl#getAccountDescription <em>Account Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.GeneralLedgerTypeImpl#getOpeningDebitBalance <em>Opening Debit Balance</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.GeneralLedgerTypeImpl#getOpeningCreditBalance <em>Opening Credit Balance</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.GeneralLedgerTypeImpl#getClosingDebitBalance <em>Closing Debit Balance</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.GeneralLedgerTypeImpl#getClosingCreditBalance <em>Closing Credit Balance</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.GeneralLedgerTypeImpl#getGroupingCategory <em>Grouping Category</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.GeneralLedgerTypeImpl#getGroupingCode <em>Grouping Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralLedgerTypeImpl extends EObjectImpl implements GeneralLedgerType {
	...
	protected EClass eStaticClass() {
		return _201Package.eINSTANCE.getGeneralLedgerType();
	}
	...
	public void setAccountID(String newAccountID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.GENERAL_LEDGER_TYPE__ACCOUNT_ID, oldAccountID, accountID));
	}
	...
	public void setAccountDescription(String newAccountDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.GENERAL_LEDGER_TYPE__ACCOUNT_DESCRIPTION, oldAccountDescription, accountDescription));
	}
	...
	public void setOpeningDebitBalance(BigDecimal newOpeningDebitBalance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.GENERAL_LEDGER_TYPE__OPENING_DEBIT_BALANCE, oldOpeningDebitBalance, openingDebitBalance));
	}
	...
	public void setOpeningCreditBalance(BigDecimal newOpeningCreditBalance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.GENERAL_LEDGER_TYPE__OPENING_CREDIT_BALANCE, oldOpeningCreditBalance, openingCreditBalance));
	}
	...
	public void setClosingDebitBalance(BigDecimal newClosingDebitBalance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.GENERAL_LEDGER_TYPE__CLOSING_DEBIT_BALANCE, oldClosingDebitBalance, closingDebitBalance));
	}
	...
	public void setClosingCreditBalance(BigDecimal newClosingCreditBalance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.GENERAL_LEDGER_TYPE__CLOSING_CREDIT_BALANCE, oldClosingCreditBalance, closingCreditBalance));
	}
	...
	public void setGroupingCategory(GroupingCategoryType newGroupingCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.GENERAL_LEDGER_TYPE__GROUPING_CATEGORY, oldGroupingCategory, groupingCategory, !oldGroupingCategoryESet));
	}
	...
	public void unsetGroupingCategory() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _201Package.GENERAL_LEDGER_TYPE__GROUPING_CATEGORY, oldGroupingCategory, GROUPING_CATEGORY_EDEFAULT, oldGroupingCategoryESet));
	}
	...
	public void setGroupingCode(String newGroupingCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.GENERAL_LEDGER_TYPE__GROUPING_CODE, oldGroupingCode, groupingCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _201Package.GENERAL_LEDGER_TYPE__ACCOUNT_ID:
				return getAccountID();
			case _201Package.GENERAL_LEDGER_TYPE__ACCOUNT_DESCRIPTION:
				return getAccountDescription();
			case _201Package.GENERAL_LEDGER_TYPE__OPENING_DEBIT_BALANCE:
				return getOpeningDebitBalance();
			case _201Package.GENERAL_LEDGER_TYPE__OPENING_CREDIT_BALANCE:
				return getOpeningCreditBalance();
			case _201Package.GENERAL_LEDGER_TYPE__CLOSING_DEBIT_BALANCE:
				return getClosingDebitBalance();
			case _201Package.GENERAL_LEDGER_TYPE__CLOSING_CREDIT_BALANCE:
				return getClosingCreditBalance();
			case _201Package.GENERAL_LEDGER_TYPE__GROUPING_CATEGORY:
				return getGroupingCategory();
			case _201Package.GENERAL_LEDGER_TYPE__GROUPING_CODE:
