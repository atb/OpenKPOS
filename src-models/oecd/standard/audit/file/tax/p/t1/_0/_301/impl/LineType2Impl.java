...
import oecd.standard.audit.file.tax.p.t1._0._301.References;
import oecd.standard.audit.file.tax.p.t1._0._301.Tax;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getLineNumber <em>Line Number</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getOrderReferences <em>Order References</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getProductCode <em>Product Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getProductDescription <em>Product Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getUnitOfMeasure <em>Unit Of Measure</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getTaxPointDate <em>Tax Point Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getReferences <em>References</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getDescription <em>Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getDebitAmount <em>Debit Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getCreditAmount <em>Credit Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getTax <em>Tax</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getTaxExemptionReason <em>Tax Exemption Reason</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType2Impl#getSettlementAmount <em>Settlement Amount</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LineType2Impl extends EObjectImpl implements LineType2 {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getLineType2();
	}
	...
	public void setLineNumber(BigInteger newLineNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__LINE_NUMBER, oldLineNumber, lineNumber));
	}
	...
	public EList<OrderReferences> getOrderReferences() {
		if (orderReferences == null) {
			orderReferences = new EObjectContainmentEList<OrderReferences>(OrderReferences.class, this, _301Package.LINE_TYPE2__ORDER_REFERENCES);
		}
	...
	public void setProductCode(String newProductCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__PRODUCT_CODE, oldProductCode, productCode));
	}
	...
	public void setProductDescription(String newProductDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__PRODUCT_DESCRIPTION, oldProductDescription, productDescription));
	}
	...
	public void setQuantity(BigDecimal newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__QUANTITY, oldQuantity, quantity));
	}
	...
	public void setUnitOfMeasure(String newUnitOfMeasure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__UNIT_OF_MEASURE, oldUnitOfMeasure, unitOfMeasure));
	}
	...
	public void setUnitPrice(BigDecimal newUnitPrice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__UNIT_PRICE, oldUnitPrice, unitPrice));
	}
	...
	public void setTaxPointDate(XMLGregorianCalendar newTaxPointDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__TAX_POINT_DATE, oldTaxPointDate, taxPointDate));
	}
	...
	public EList<References> getReferences() {
		if (references == null) {
			references = new EObjectContainmentEList<References>(References.class, this, _301Package.LINE_TYPE2__REFERENCES);
		}
		return references;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__DESCRIPTION, oldDescription, description));
	}
	...
	public void setDebitAmount(BigDecimal newDebitAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__DEBIT_AMOUNT, oldDebitAmount, debitAmount));
	}
	...
	public void setCreditAmount(BigDecimal newCreditAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__CREDIT_AMOUNT, oldCreditAmount, creditAmount));
	}
	...
	public NotificationChain basicSetTax(Tax newTax, NotificationChain msgs) {
		...
		tax = newTax;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__TAX, oldTax, newTax);
	...
	public void setTax(Tax newTax) {
		if (newTax != tax) {
			...
			if (tax != null)
				msgs = ((InternalEObject)tax).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.LINE_TYPE2__TAX, null, msgs);
			if (newTax != null)
				msgs = ((InternalEObject)newTax).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.LINE_TYPE2__TAX, null, msgs);
			msgs = basicSetTax(newTax, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__TAX, newTax, newTax));
	}
	...
	public void setTaxExemptionReason(String newTaxExemptionReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__TAX_EXEMPTION_REASON, oldTaxExemptionReason, taxExemptionReason));
	}
	...
	public void setSettlementAmount(BigDecimal newSettlementAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE2__SETTLEMENT_AMOUNT, oldSettlementAmount, settlementAmount));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _301Package.LINE_TYPE2__ORDER_REFERENCES:
				return ((InternalEList<?>)getOrderReferences()).basicRemove(otherEnd, msgs);
			case _301Package.LINE_TYPE2__REFERENCES:
				return ((InternalEList<?>)getReferences()).basicRemove(otherEnd, msgs);
			case _301Package.LINE_TYPE2__TAX:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.LINE_TYPE2__LINE_NUMBER:
				return getLineNumber();
			case _301Package.LINE_TYPE2__ORDER_REFERENCES:
				return getOrderReferences();
			case _301Package.LINE_TYPE2__PRODUCT_CODE:
				return getProductCode();
			case _301Package.LINE_TYPE2__PRODUCT_DESCRIPTION:
				return getProductDescription();
			case _301Package.LINE_TYPE2__QUANTITY:
				return getQuantity();
			case _301Package.LINE_TYPE2__UNIT_OF_MEASURE:
				return getUnitOfMeasure();
			case _301Package.LINE_TYPE2__UNIT_PRICE:
				return getUnitPrice();
			case _301Package.LINE_TYPE2__TAX_POINT_DATE:
				return getTaxPointDate();
			case _301Package.LINE_TYPE2__REFERENCES:
				return getReferences();
			case _301Package.LINE_TYPE2__DESCRIPTION:
				return getDescription();
			case _301Package.LINE_TYPE2__DEBIT_AMOUNT:
				return getDebitAmount();
			case _301Package.LINE_TYPE2__CREDIT_AMOUNT:
				return getCreditAmount();
			case _301Package.LINE_TYPE2__TAX:
				return getTax();
			case _301Package.LINE_TYPE2__TAX_EXEMPTION_REASON:
				return getTaxExemptionReason();
			case _301Package.LINE_TYPE2__SETTLEMENT_AMOUNT:
