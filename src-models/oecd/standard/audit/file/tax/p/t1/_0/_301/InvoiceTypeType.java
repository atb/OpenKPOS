...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Invoice Type Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see oecd.standard.audit.file.tax.p.t1._0._301._301Package#getInvoiceTypeType()
 * @model extendedMetaData="name='InvoiceType_._type'"
 * @generated
 */
public enum InvoiceTypeType implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int ND_VALUE = 3;
	 ...
	 * @ordered
	 */
	public static final int NC_VALUE = 4;
	 ...
	 * @ordered
	 */
	public static final int VD_VALUE = 5;
	 ...
	 * @ordered
	 */
	public static final int TD_VALUE = 7;
	 ...
	 * @ordered
	 */
	public static final int AA_VALUE = 8;
	 ...
	 * @ordered
	 */
	public static final int RP_VALUE = 10;
	 ...
	 * @ordered
	 */
	public static final int RE_VALUE = 11;
	 ...
	 * @ordered
	 */
	public static final int LD_VALUE = 13;
	...
	/**
	 * An array of all the '<em><b>Invoice Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final InvoiceTypeType[] VALUES_ARRAY =
		new InvoiceTypeType[] {
			FT,
			FS,
			FR,
	...
	/**
	 * A public read-only list of all the '<em><b>Invoice Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<InvoiceTypeType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Invoice Type Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static InvoiceTypeType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			InvoiceTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Invoice Type Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static InvoiceTypeType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			InvoiceTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Invoice Type Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static InvoiceTypeType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private InvoiceTypeType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
