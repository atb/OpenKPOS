 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.SettlementImpl#getSettlementDiscount <em>Settlement Discount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.SettlementImpl#getSettlementAmount <em>Settlement Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.SettlementImpl#getSettlementDate <em>Settlement Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.SettlementImpl#getPaymentTerms <em>Payment Terms</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SettlementImpl extends EObjectImpl implements Settlement {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getSettlement();
	}
	...
	public void setSettlementDiscount(String newSettlementDiscount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.SETTLEMENT__SETTLEMENT_DISCOUNT, oldSettlementDiscount, settlementDiscount));
	}
	...
	public void setSettlementAmount(BigDecimal newSettlementAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.SETTLEMENT__SETTLEMENT_AMOUNT, oldSettlementAmount, settlementAmount));
	}
	...
	public void setSettlementDate(XMLGregorianCalendar newSettlementDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.SETTLEMENT__SETTLEMENT_DATE, oldSettlementDate, settlementDate));
	}
	...
	public void setPaymentTerms(String newPaymentTerms) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.SETTLEMENT__PAYMENT_TERMS, oldPaymentTerms, paymentTerms));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.SETTLEMENT__SETTLEMENT_DISCOUNT:
				return getSettlementDiscount();
			case _301Package.SETTLEMENT__SETTLEMENT_AMOUNT:
				return getSettlementAmount();
			case _301Package.SETTLEMENT__SETTLEMENT_DATE:
				return getSettlementDate();
			case _301Package.SETTLEMENT__PAYMENT_TERMS:
