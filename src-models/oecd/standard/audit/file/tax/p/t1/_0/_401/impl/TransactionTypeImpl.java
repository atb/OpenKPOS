 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TransactionTypeImpl#getTransactionID <em>Transaction ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TransactionTypeImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TransactionTypeImpl#getTransactionDate <em>Transaction Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TransactionTypeImpl#getSourceID <em>Source ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TransactionTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TransactionTypeImpl#getDocArchivalNumber <em>Doc Archival Number</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TransactionTypeImpl#getTransactionType <em>Transaction Type</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TransactionTypeImpl#getGLPostingDate <em>GL Posting Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TransactionTypeImpl#getCustomerID <em>Customer ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TransactionTypeImpl#getSupplierID <em>Supplier ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.TransactionTypeImpl#getLines <em>Lines</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransactionTypeImpl extends EObjectImpl implements TransactionType {
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getTransactionType();
	}
	...
	public void setTransactionID(String newTransactionID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TRANSACTION_TYPE__TRANSACTION_ID, oldTransactionID, transactionID));
	}
	...
	public void setPeriod(BigInteger newPeriod) {
		...
		period = newPeriod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TRANSACTION_TYPE__PERIOD, oldPeriod, period));
	}
	...
	public void setTransactionDate(XMLGregorianCalendar newTransactionDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TRANSACTION_TYPE__TRANSACTION_DATE, oldTransactionDate, transactionDate));
	}
	...
	public void setSourceID(String newSourceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TRANSACTION_TYPE__SOURCE_ID, oldSourceID, sourceID));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TRANSACTION_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setDocArchivalNumber(String newDocArchivalNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TRANSACTION_TYPE__DOC_ARCHIVAL_NUMBER, oldDocArchivalNumber, docArchivalNumber));
	}
	...
	public void setTransactionType(TransactionTypeType newTransactionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TRANSACTION_TYPE__TRANSACTION_TYPE, oldTransactionType, transactionType, !oldTransactionTypeESet));
	}
	...
	public void unsetTransactionType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _401Package.TRANSACTION_TYPE__TRANSACTION_TYPE, oldTransactionType, TRANSACTION_TYPE_EDEFAULT, oldTransactionTypeESet));
	}
	...
	public void setGLPostingDate(XMLGregorianCalendar newGLPostingDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TRANSACTION_TYPE__GL_POSTING_DATE, oldGLPostingDate, gLPostingDate));
	}
	...
	public void setCustomerID(String newCustomerID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TRANSACTION_TYPE__CUSTOMER_ID, oldCustomerID, customerID));
	}
	...
	public void setSupplierID(String newSupplierID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TRANSACTION_TYPE__SUPPLIER_ID, oldSupplierID, supplierID));
	}
	...
	public NotificationChain basicSetLines(LinesType newLines, NotificationChain msgs) {
		LinesType oldLines = lines;
		lines = newLines;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _401Package.TRANSACTION_TYPE__LINES, oldLines, newLines);
	...
	public void setLines(LinesType newLines) {
		if (newLines != lines) {
			...
			if (lines != null)
				msgs = ((InternalEObject)lines).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _401Package.TRANSACTION_TYPE__LINES, null, msgs);
			if (newLines != null)
				msgs = ((InternalEObject)newLines).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _401Package.TRANSACTION_TYPE__LINES, null, msgs);
			msgs = basicSetLines(newLines, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.TRANSACTION_TYPE__LINES, newLines, newLines));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _401Package.TRANSACTION_TYPE__LINES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.TRANSACTION_TYPE__TRANSACTION_ID:
				return getTransactionID();
			case _401Package.TRANSACTION_TYPE__PERIOD:
				return getPeriod();
			case _401Package.TRANSACTION_TYPE__TRANSACTION_DATE:
				return getTransactionDate();
			case _401Package.TRANSACTION_TYPE__SOURCE_ID:
				return getSourceID();
			case _401Package.TRANSACTION_TYPE__DESCRIPTION:
				return getDescription();
			case _401Package.TRANSACTION_TYPE__DOC_ARCHIVAL_NUMBER:
				return getDocArchivalNumber();
			case _401Package.TRANSACTION_TYPE__TRANSACTION_TYPE:
				return getTransactionType();
			case _401Package.TRANSACTION_TYPE__GL_POSTING_DATE:
				return getGLPostingDate();
			case _401Package.TRANSACTION_TYPE__CUSTOMER_ID:
				return getCustomerID();
			case _401Package.TRANSACTION_TYPE__SUPPLIER_ID:
