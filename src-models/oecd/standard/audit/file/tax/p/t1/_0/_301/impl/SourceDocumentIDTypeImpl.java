 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.SourceDocumentIDTypeImpl#getOriginatingON <em>Originating ON</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.SourceDocumentIDTypeImpl#getInvoiceDate <em>Invoice Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.SourceDocumentIDTypeImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SourceDocumentIDTypeImpl extends EObjectImpl implements SourceDocumentIDType {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getSourceDocumentIDType();
	}
	...
	public void setOriginatingON(String newOriginatingON) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.SOURCE_DOCUMENT_ID_TYPE__ORIGINATING_ON, oldOriginatingON, originatingON));
	}
	...
	public void setInvoiceDate(XMLGregorianCalendar newInvoiceDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.SOURCE_DOCUMENT_ID_TYPE__INVOICE_DATE, oldInvoiceDate, invoiceDate));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.SOURCE_DOCUMENT_ID_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.SOURCE_DOCUMENT_ID_TYPE__ORIGINATING_ON:
				return getOriginatingON();
			case _301Package.SOURCE_DOCUMENT_ID_TYPE__INVOICE_DATE:
				return getInvoiceDate();
			case _301Package.SOURCE_DOCUMENT_ID_TYPE__DESCRIPTION:
