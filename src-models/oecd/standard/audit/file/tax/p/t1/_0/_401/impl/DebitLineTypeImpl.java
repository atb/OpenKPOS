...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Debit Line Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DebitLineTypeImpl#getRecordID <em>Record ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DebitLineTypeImpl#getAccountID <em>Account ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DebitLineTypeImpl#getSourceDocumentID <em>Source Document ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DebitLineTypeImpl#getSystemEntryDate <em>System Entry Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DebitLineTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DebitLineTypeImpl#getDebitAmount <em>Debit Amount</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DebitLineTypeImpl extends EObjectImpl implements DebitLineType {
	/**
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getDebitLineType();
	}
	...
	public void setRecordID(String newRecordID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DEBIT_LINE_TYPE__RECORD_ID, oldRecordID, recordID));
	}
	...
	public void setAccountID(String newAccountID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DEBIT_LINE_TYPE__ACCOUNT_ID, oldAccountID, accountID));
	}
	...
	public void setSourceDocumentID(String newSourceDocumentID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DEBIT_LINE_TYPE__SOURCE_DOCUMENT_ID, oldSourceDocumentID, sourceDocumentID));
	}
	...
	public void setSystemEntryDate(XMLGregorianCalendar newSystemEntryDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DEBIT_LINE_TYPE__SYSTEM_ENTRY_DATE, oldSystemEntryDate, systemEntryDate));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DEBIT_LINE_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setDebitAmount(BigDecimal newDebitAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DEBIT_LINE_TYPE__DEBIT_AMOUNT, oldDebitAmount, debitAmount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.DEBIT_LINE_TYPE__RECORD_ID:
				return getRecordID();
			case _401Package.DEBIT_LINE_TYPE__ACCOUNT_ID:
				return getAccountID();
			case _401Package.DEBIT_LINE_TYPE__SOURCE_DOCUMENT_ID:
				return getSourceDocumentID();
			case _401Package.DEBIT_LINE_TYPE__SYSTEM_ENTRY_DATE:
				return getSystemEntryDate();
			case _401Package.DEBIT_LINE_TYPE__DESCRIPTION:
				return getDescription();
			case _401Package.DEBIT_LINE_TYPE__DEBIT_AMOUNT:
