 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getLineNumber <em>Line Number</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getOrderReferences <em>Order References</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getProductCode <em>Product Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getProductDescription <em>Product Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getUnitOfMeasure <em>Unit Of Measure</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getTaxPointDate <em>Tax Point Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getDescription <em>Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getDebitAmount <em>Debit Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getCreditAmount <em>Credit Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getTax <em>Tax</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getTaxExemptionReason <em>Tax Exemption Reason</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.LineType3Impl#getSettlementAmount <em>Settlement Amount</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LineType3Impl extends EObjectImpl implements LineType3 {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getLineType3();
	}
	...
	public void setLineNumber(BigInteger newLineNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__LINE_NUMBER, oldLineNumber, lineNumber));
	}
	...
	public EList<OrderReferences> getOrderReferences() {
		if (orderReferences == null) {
			orderReferences = new EObjectContainmentEList<OrderReferences>(OrderReferences.class, this, _301Package.LINE_TYPE3__ORDER_REFERENCES);
		}
	...
	public void setProductCode(String newProductCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__PRODUCT_CODE, oldProductCode, productCode));
	}
	...
	public void setProductDescription(String newProductDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__PRODUCT_DESCRIPTION, oldProductDescription, productDescription));
	}
	...
	public void setQuantity(BigDecimal newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__QUANTITY, oldQuantity, quantity));
	}
	...
	public void setUnitOfMeasure(String newUnitOfMeasure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__UNIT_OF_MEASURE, oldUnitOfMeasure, unitOfMeasure));
	}
	...
	public void setUnitPrice(BigDecimal newUnitPrice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__UNIT_PRICE, oldUnitPrice, unitPrice));
	}
	...
	public void setTaxPointDate(XMLGregorianCalendar newTaxPointDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__TAX_POINT_DATE, oldTaxPointDate, taxPointDate));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__DESCRIPTION, oldDescription, description));
	}
	...
	public void setDebitAmount(BigDecimal newDebitAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__DEBIT_AMOUNT, oldDebitAmount, debitAmount));
	}
	...
	public void setCreditAmount(BigDecimal newCreditAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__CREDIT_AMOUNT, oldCreditAmount, creditAmount));
	}
	...
	public NotificationChain basicSetTax(Tax newTax, NotificationChain msgs) {
		...
		tax = newTax;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__TAX, oldTax, newTax);
	...
	public void setTax(Tax newTax) {
		if (newTax != tax) {
			...
			if (tax != null)
				msgs = ((InternalEObject)tax).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.LINE_TYPE3__TAX, null, msgs);
			if (newTax != null)
				msgs = ((InternalEObject)newTax).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.LINE_TYPE3__TAX, null, msgs);
			msgs = basicSetTax(newTax, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__TAX, newTax, newTax));
	}
	...
	public void setTaxExemptionReason(String newTaxExemptionReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__TAX_EXEMPTION_REASON, oldTaxExemptionReason, taxExemptionReason));
	}
	...
	public void setSettlementAmount(BigDecimal newSettlementAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.LINE_TYPE3__SETTLEMENT_AMOUNT, oldSettlementAmount, settlementAmount));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _301Package.LINE_TYPE3__ORDER_REFERENCES:
				return ((InternalEList<?>)getOrderReferences()).basicRemove(otherEnd, msgs);
			case _301Package.LINE_TYPE3__TAX:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.LINE_TYPE3__LINE_NUMBER:
				return getLineNumber();
			case _301Package.LINE_TYPE3__ORDER_REFERENCES:
				return getOrderReferences();
			case _301Package.LINE_TYPE3__PRODUCT_CODE:
				return getProductCode();
			case _301Package.LINE_TYPE3__PRODUCT_DESCRIPTION:
				return getProductDescription();
			case _301Package.LINE_TYPE3__QUANTITY:
				return getQuantity();
			case _301Package.LINE_TYPE3__UNIT_OF_MEASURE:
				return getUnitOfMeasure();
			case _301Package.LINE_TYPE3__UNIT_PRICE:
				return getUnitPrice();
			case _301Package.LINE_TYPE3__TAX_POINT_DATE:
				return getTaxPointDate();
			case _301Package.LINE_TYPE3__DESCRIPTION:
				return getDescription();
			case _301Package.LINE_TYPE3__DEBIT_AMOUNT:
				return getDebitAmount();
			case _301Package.LINE_TYPE3__CREDIT_AMOUNT:
				return getCreditAmount();
			case _301Package.LINE_TYPE3__TAX:
				return getTax();
			case _301Package.LINE_TYPE3__TAX_EXEMPTION_REASON:
				return getTaxExemptionReason();
			case _301Package.LINE_TYPE3__SETTLEMENT_AMOUNT:
