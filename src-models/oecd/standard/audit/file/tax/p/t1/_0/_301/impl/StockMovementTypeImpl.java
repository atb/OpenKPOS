...
import oecd.standard.audit.file.tax.p.t1._0._301.DocumentStatusType2;
import oecd.standard.audit.file.tax.p.t1._0._301.DocumentTotalsType1;
...
import oecd.standard.audit.file.tax.p.t1._0._301.StockMovementType;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getDocumentNumber <em>Document Number</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getDocumentStatus <em>Document Status</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getHash <em>Hash</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getHashControl <em>Hash Control</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getMovementDate <em>Movement Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getMovementType <em>Movement Type</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getSystemEntryDate <em>System Entry Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getTransactionID <em>Transaction ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getCustomerID <em>Customer ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getSupplierID <em>Supplier ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getSourceID <em>Source ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getEACCode <em>EAC Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getMovementComments <em>Movement Comments</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getShipTo <em>Ship To</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getShipFrom <em>Ship From</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getMovementEndTime <em>Movement End Time</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getMovementStartTime <em>Movement Start Time</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getATDocCodeID <em>AT Doc Code ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getLine <em>Line</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.StockMovementTypeImpl#getDocumentTotals <em>Document Totals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StockMovementTypeImpl extends EObjectImpl implements StockMovementType {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getStockMovementType();
	}
	...
	public void setDocumentNumber(String newDocumentNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__DOCUMENT_NUMBER, oldDocumentNumber, documentNumber));
	}
	...
	public NotificationChain basicSetDocumentStatus(DocumentStatusType2 newDocumentStatus, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__DOCUMENT_STATUS, oldDocumentStatus, newDocumentStatus);
	...
	public void setDocumentStatus(DocumentStatusType2 newDocumentStatus) {
		if (newDocumentStatus != documentStatus) {
			...
			if (documentStatus != null)
				msgs = ((InternalEObject)documentStatus).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.STOCK_MOVEMENT_TYPE__DOCUMENT_STATUS, null, msgs);
			if (newDocumentStatus != null)
				msgs = ((InternalEObject)newDocumentStatus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.STOCK_MOVEMENT_TYPE__DOCUMENT_STATUS, null, msgs);
			msgs = basicSetDocumentStatus(newDocumentStatus, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__DOCUMENT_STATUS, newDocumentStatus, newDocumentStatus));
	}
	...
	public void setHash(String newHash) {
		...
		hash = newHash;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__HASH, oldHash, hash));
	}
	...
	public void setHashControl(String newHashControl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__HASH_CONTROL, oldHashControl, hashControl));
	}
	...
	public void setPeriod(BigInteger newPeriod) {
		...
		period = newPeriod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__PERIOD, oldPeriod, period));
	}
	...
	public void setMovementDate(XMLGregorianCalendar newMovementDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__MOVEMENT_DATE, oldMovementDate, movementDate));
	}
	...
	public void setMovementType(MovementTypeType newMovementType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__MOVEMENT_TYPE, oldMovementType, movementType, !oldMovementTypeESet));
	}
	...
	public void unsetMovementType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _301Package.STOCK_MOVEMENT_TYPE__MOVEMENT_TYPE, oldMovementType, MOVEMENT_TYPE_EDEFAULT, oldMovementTypeESet));
	}
	...
	public void setSystemEntryDate(XMLGregorianCalendar newSystemEntryDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__SYSTEM_ENTRY_DATE, oldSystemEntryDate, systemEntryDate));
	}
	...
	public void setTransactionID(String newTransactionID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__TRANSACTION_ID, oldTransactionID, transactionID));
	}
	...
	public void setCustomerID(String newCustomerID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__CUSTOMER_ID, oldCustomerID, customerID));
	}
	...
	public void setSupplierID(String newSupplierID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__SUPPLIER_ID, oldSupplierID, supplierID));
	}
	...
	public void setSourceID(String newSourceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__SOURCE_ID, oldSourceID, sourceID));
	}
	...
	public void setEACCode(String newEACCode) {
		...
		eACCode = newEACCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__EAC_CODE, oldEACCode, eACCode));
	}
	...
	public void setMovementComments(String newMovementComments) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__MOVEMENT_COMMENTS, oldMovementComments, movementComments));
	}
	...
	public NotificationChain basicSetShipTo(ShippingPointStructure newShipTo, NotificationChain msgs) {
		...
		shipTo = newShipTo;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__SHIP_TO, oldShipTo, newShipTo);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setShipTo(ShippingPointStructure newShipTo) {
		if (newShipTo != shipTo) {
			NotificationChain msgs = null;
			if (shipTo != null)
				msgs = ((InternalEObject)shipTo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.STOCK_MOVEMENT_TYPE__SHIP_TO, null, msgs);
			if (newShipTo != null)
				msgs = ((InternalEObject)newShipTo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.STOCK_MOVEMENT_TYPE__SHIP_TO, null, msgs);
			msgs = basicSetShipTo(newShipTo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__SHIP_TO, newShipTo, newShipTo));
	}
	...
	public NotificationChain basicSetShipFrom(ShippingPointStructure newShipFrom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__SHIP_FROM, oldShipFrom, newShipFrom);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setShipFrom(ShippingPointStructure newShipFrom) {
		if (newShipFrom != shipFrom) {
			NotificationChain msgs = null;
			if (shipFrom != null)
				msgs = ((InternalEObject)shipFrom).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.STOCK_MOVEMENT_TYPE__SHIP_FROM, null, msgs);
			if (newShipFrom != null)
				msgs = ((InternalEObject)newShipFrom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.STOCK_MOVEMENT_TYPE__SHIP_FROM, null, msgs);
			msgs = basicSetShipFrom(newShipFrom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__SHIP_FROM, newShipFrom, newShipFrom));
	}
	...
	public void setMovementEndTime(XMLGregorianCalendar newMovementEndTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__MOVEMENT_END_TIME, oldMovementEndTime, movementEndTime));
	}
	...
	public void setMovementStartTime(XMLGregorianCalendar newMovementStartTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__MOVEMENT_START_TIME, oldMovementStartTime, movementStartTime));
	}
	...
	public void setATDocCodeID(String newATDocCodeID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__AT_DOC_CODE_ID, oldATDocCodeID, aTDocCodeID));
	}
	...
	public EList<LineType> getLine() {
		if (line == null) {
			line = new EObjectContainmentEList<LineType>(LineType.class, this, _301Package.STOCK_MOVEMENT_TYPE__LINE);
		}
		return line;
	}
	...
	public NotificationChain basicSetDocumentTotals(DocumentTotalsType1 newDocumentTotals, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__DOCUMENT_TOTALS, oldDocumentTotals, newDocumentTotals);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDocumentTotals(DocumentTotalsType1 newDocumentTotals) {
		if (newDocumentTotals != documentTotals) {
			...
			if (documentTotals != null)
				msgs = ((InternalEObject)documentTotals).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.STOCK_MOVEMENT_TYPE__DOCUMENT_TOTALS, null, msgs);
			if (newDocumentTotals != null)
				msgs = ((InternalEObject)newDocumentTotals).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.STOCK_MOVEMENT_TYPE__DOCUMENT_TOTALS, null, msgs);
			msgs = basicSetDocumentTotals(newDocumentTotals, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.STOCK_MOVEMENT_TYPE__DOCUMENT_TOTALS, newDocumentTotals, newDocumentTotals));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _301Package.STOCK_MOVEMENT_TYPE__DOCUMENT_STATUS:
				return basicSetDocumentStatus(null, msgs);
			case _301Package.STOCK_MOVEMENT_TYPE__SHIP_TO:
				return basicSetShipTo(null, msgs);
			case _301Package.STOCK_MOVEMENT_TYPE__SHIP_FROM:
				return basicSetShipFrom(null, msgs);
			case _301Package.STOCK_MOVEMENT_TYPE__LINE:
				return ((InternalEList<?>)getLine()).basicRemove(otherEnd, msgs);
			case _301Package.STOCK_MOVEMENT_TYPE__DOCUMENT_TOTALS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.STOCK_MOVEMENT_TYPE__DOCUMENT_NUMBER:
				return getDocumentNumber();
			case _301Package.STOCK_MOVEMENT_TYPE__DOCUMENT_STATUS:
				return getDocumentStatus();
			case _301Package.STOCK_MOVEMENT_TYPE__HASH:
				return getHash();
			case _301Package.STOCK_MOVEMENT_TYPE__HASH_CONTROL:
				return getHashControl();
			case _301Package.STOCK_MOVEMENT_TYPE__PERIOD:
				return getPeriod();
			case _301Package.STOCK_MOVEMENT_TYPE__MOVEMENT_DATE:
				return getMovementDate();
			case _301Package.STOCK_MOVEMENT_TYPE__MOVEMENT_TYPE:
				return getMovementType();
			case _301Package.STOCK_MOVEMENT_TYPE__SYSTEM_ENTRY_DATE:
				return getSystemEntryDate();
			case _301Package.STOCK_MOVEMENT_TYPE__TRANSACTION_ID:
				return getTransactionID();
			case _301Package.STOCK_MOVEMENT_TYPE__CUSTOMER_ID:
				return getCustomerID();
			case _301Package.STOCK_MOVEMENT_TYPE__SUPPLIER_ID:
				return getSupplierID();
			case _301Package.STOCK_MOVEMENT_TYPE__SOURCE_ID:
				return getSourceID();
			case _301Package.STOCK_MOVEMENT_TYPE__EAC_CODE:
				return getEACCode();
			case _301Package.STOCK_MOVEMENT_TYPE__MOVEMENT_COMMENTS:
				return getMovementComments();
			case _301Package.STOCK_MOVEMENT_TYPE__SHIP_TO:
				return getShipTo();
			case _301Package.STOCK_MOVEMENT_TYPE__SHIP_FROM:
				return getShipFrom();
			case _301Package.STOCK_MOVEMENT_TYPE__MOVEMENT_END_TIME:
				return getMovementEndTime();
			case _301Package.STOCK_MOVEMENT_TYPE__MOVEMENT_START_TIME:
				return getMovementStartTime();
			case _301Package.STOCK_MOVEMENT_TYPE__AT_DOC_CODE_ID:
