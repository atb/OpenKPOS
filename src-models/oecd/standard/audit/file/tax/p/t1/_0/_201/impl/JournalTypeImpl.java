 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.JournalTypeImpl#getJournalID <em>Journal ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.JournalTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.JournalTypeImpl#getTransaction <em>Transaction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JournalTypeImpl extends EObjectImpl implements JournalType {
	...
	protected EClass eStaticClass() {
		return _201Package.eINSTANCE.getJournalType();
	}
	...
	public void setJournalID(String newJournalID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.JOURNAL_TYPE__JOURNAL_ID, oldJournalID, journalID));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.JOURNAL_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<TransactionType> getTransaction() {
		if (transaction == null) {
			transaction = new EObjectContainmentEList<TransactionType>(TransactionType.class, this, _201Package.JOURNAL_TYPE__TRANSACTION);
		}
		return transaction;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _201Package.JOURNAL_TYPE__TRANSACTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _201Package.JOURNAL_TYPE__JOURNAL_ID:
				return getJournalID();
			case _201Package.JOURNAL_TYPE__DESCRIPTION:
