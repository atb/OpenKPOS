 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentStatusType2Impl#getMovementStatus <em>Movement Status</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentStatusType2Impl#getMovementStatusDate <em>Movement Status Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentStatusType2Impl#getReason <em>Reason</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentStatusType2Impl#getSourceID <em>Source ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentStatusType2Impl#getSourceBilling <em>Source Billing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentStatusType2Impl extends EObjectImpl implements DocumentStatusType2 {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getDocumentStatusType2();
	}
	...
	public void setMovementStatus(MovementStatusType newMovementStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_STATUS_TYPE2__MOVEMENT_STATUS, oldMovementStatus, movementStatus, !oldMovementStatusESet));
	}
	...
	public void unsetMovementStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _301Package.DOCUMENT_STATUS_TYPE2__MOVEMENT_STATUS, oldMovementStatus, MOVEMENT_STATUS_EDEFAULT, oldMovementStatusESet));
	}
	...
	public void setMovementStatusDate(XMLGregorianCalendar newMovementStatusDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_STATUS_TYPE2__MOVEMENT_STATUS_DATE, oldMovementStatusDate, movementStatusDate));
	}
	...
	public void setReason(String newReason) {
		...
		reason = newReason;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_STATUS_TYPE2__REASON, oldReason, reason));
	}
	...
	public void setSourceID(String newSourceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_STATUS_TYPE2__SOURCE_ID, oldSourceID, sourceID));
	}
	...
	public void setSourceBilling(SAFTPTSourceBilling newSourceBilling) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_STATUS_TYPE2__SOURCE_BILLING, oldSourceBilling, sourceBilling, !oldSourceBillingESet));
	}
	...
	public void unsetSourceBilling() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _301Package.DOCUMENT_STATUS_TYPE2__SOURCE_BILLING, oldSourceBilling, SOURCE_BILLING_EDEFAULT, oldSourceBillingESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.DOCUMENT_STATUS_TYPE2__MOVEMENT_STATUS:
				return getMovementStatus();
			case _301Package.DOCUMENT_STATUS_TYPE2__MOVEMENT_STATUS_DATE:
				return getMovementStatusDate();
			case _301Package.DOCUMENT_STATUS_TYPE2__REASON:
				return getReason();
			case _301Package.DOCUMENT_STATUS_TYPE2__SOURCE_ID:
				return getSourceID();
			case _301Package.DOCUMENT_STATUS_TYPE2__SOURCE_BILLING:
