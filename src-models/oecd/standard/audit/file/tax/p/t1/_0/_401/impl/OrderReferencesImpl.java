 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.OrderReferencesImpl#getOriginatingON <em>Originating ON</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.OrderReferencesImpl#getOrderDate <em>Order Date</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrderReferencesImpl extends EObjectImpl implements OrderReferences {
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getOrderReferences();
	}
	...
	public void setOriginatingON(String newOriginatingON) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.ORDER_REFERENCES__ORIGINATING_ON, oldOriginatingON, originatingON));
	}
	...
	public void setOrderDate(XMLGregorianCalendar newOrderDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.ORDER_REFERENCES__ORDER_DATE, oldOrderDate, orderDate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.ORDER_REFERENCES__ORIGINATING_ON:
				return getOriginatingON();
			case _401Package.ORDER_REFERENCES__ORDER_DATE:
				return getOrderDate();
		}
