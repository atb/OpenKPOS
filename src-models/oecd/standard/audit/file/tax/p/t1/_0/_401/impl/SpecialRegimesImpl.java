 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.SpecialRegimesImpl#getSelfBillingIndicator <em>Self Billing Indicator</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.SpecialRegimesImpl#getCashVATSchemeIndicator <em>Cash VAT Scheme Indicator</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.SpecialRegimesImpl#getThirdPartiesBillingIndicator <em>Third Parties Billing Indicator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SpecialRegimesImpl extends EObjectImpl implements SpecialRegimes {
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getSpecialRegimes();
	}
	...
	public void setSelfBillingIndicator(BigInteger newSelfBillingIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.SPECIAL_REGIMES__SELF_BILLING_INDICATOR, oldSelfBillingIndicator, selfBillingIndicator));
	}
	...
	public void setCashVATSchemeIndicator(BigInteger newCashVATSchemeIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.SPECIAL_REGIMES__CASH_VAT_SCHEME_INDICATOR, oldCashVATSchemeIndicator, cashVATSchemeIndicator));
	}
	...
	public void setThirdPartiesBillingIndicator(BigInteger newThirdPartiesBillingIndicator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.SPECIAL_REGIMES__THIRD_PARTIES_BILLING_INDICATOR, oldThirdPartiesBillingIndicator, thirdPartiesBillingIndicator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.SPECIAL_REGIMES__SELF_BILLING_INDICATOR:
				return getSelfBillingIndicator();
			case _401Package.SPECIAL_REGIMES__CASH_VAT_SCHEME_INDICATOR:
				return getCashVATSchemeIndicator();
			case _401Package.SPECIAL_REGIMES__THIRD_PARTIES_BILLING_INDICATOR:
