 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.LineType3Impl#getRecordID <em>Record ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.LineType3Impl#getAccountID <em>Account ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.LineType3Impl#getSourceDocumentID <em>Source Document ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.LineType3Impl#getSystemEntryDate <em>System Entry Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.LineType3Impl#getDescription <em>Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.LineType3Impl#getDebitAmount <em>Debit Amount</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.LineType3Impl#getCreditAmount <em>Credit Amount</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LineType3Impl extends EObjectImpl implements LineType3 {
	...
	protected EClass eStaticClass() {
		return _201Package.eINSTANCE.getLineType3();
	}
	...
	public void setRecordID(String newRecordID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.LINE_TYPE3__RECORD_ID, oldRecordID, recordID));
	}
	...
	public void setAccountID(String newAccountID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.LINE_TYPE3__ACCOUNT_ID, oldAccountID, accountID));
	}
	...
	public void setSourceDocumentID(String newSourceDocumentID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.LINE_TYPE3__SOURCE_DOCUMENT_ID, oldSourceDocumentID, sourceDocumentID));
	}
	...
	public void setSystemEntryDate(XMLGregorianCalendar newSystemEntryDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.LINE_TYPE3__SYSTEM_ENTRY_DATE, oldSystemEntryDate, systemEntryDate));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.LINE_TYPE3__DESCRIPTION, oldDescription, description));
	}
	...
	public void setDebitAmount(BigDecimal newDebitAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.LINE_TYPE3__DEBIT_AMOUNT, oldDebitAmount, debitAmount));
	}
	...
	public void setCreditAmount(BigDecimal newCreditAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.LINE_TYPE3__CREDIT_AMOUNT, oldCreditAmount, creditAmount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _201Package.LINE_TYPE3__RECORD_ID:
				return getRecordID();
			case _201Package.LINE_TYPE3__ACCOUNT_ID:
				return getAccountID();
			case _201Package.LINE_TYPE3__SOURCE_DOCUMENT_ID:
				return getSourceDocumentID();
			case _201Package.LINE_TYPE3__SYSTEM_ENTRY_DATE:
				return getSystemEntryDate();
			case _201Package.LINE_TYPE3__DESCRIPTION:
				return getDescription();
			case _201Package.LINE_TYPE3__DEBIT_AMOUNT:
				return getDebitAmount();
			case _201Package.LINE_TYPE3__CREDIT_AMOUNT:
