 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentTotalsTypeImpl#getTaxPayable <em>Tax Payable</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentTotalsTypeImpl#getNetTotal <em>Net Total</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentTotalsTypeImpl#getGrossTotal <em>Gross Total</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._401.impl.DocumentTotalsTypeImpl#getCurrency <em>Currency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentTotalsTypeImpl extends EObjectImpl implements DocumentTotalsType {
	...
	protected EClass eStaticClass() {
		return _401Package.eINSTANCE.getDocumentTotalsType();
	}
	...
	public void setTaxPayable(BigDecimal newTaxPayable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_TOTALS_TYPE__TAX_PAYABLE, oldTaxPayable, taxPayable));
	}
	...
	public void setNetTotal(BigDecimal newNetTotal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_TOTALS_TYPE__NET_TOTAL, oldNetTotal, netTotal));
	}
	...
	public void setGrossTotal(BigDecimal newGrossTotal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_TOTALS_TYPE__GROSS_TOTAL, oldGrossTotal, grossTotal));
	}
	...
	public NotificationChain basicSetCurrency(Currency newCurrency, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_TOTALS_TYPE__CURRENCY, oldCurrency, newCurrency);
	...
	public void setCurrency(Currency newCurrency) {
		if (newCurrency != currency) {
			...
			if (currency != null)
				msgs = ((InternalEObject)currency).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _401Package.DOCUMENT_TOTALS_TYPE__CURRENCY, null, msgs);
			if (newCurrency != null)
				msgs = ((InternalEObject)newCurrency).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _401Package.DOCUMENT_TOTALS_TYPE__CURRENCY, null, msgs);
			msgs = basicSetCurrency(newCurrency, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _401Package.DOCUMENT_TOTALS_TYPE__CURRENCY, newCurrency, newCurrency));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _401Package.DOCUMENT_TOTALS_TYPE__CURRENCY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _401Package.DOCUMENT_TOTALS_TYPE__TAX_PAYABLE:
				return getTaxPayable();
			case _401Package.DOCUMENT_TOTALS_TYPE__NET_TOTAL:
				return getNetTotal();
			case _401Package.DOCUMENT_TOTALS_TYPE__GROSS_TOTAL:
