 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentStatusTypeImpl#getWorkStatus <em>Work Status</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentStatusTypeImpl#getWorkStatusDate <em>Work Status Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentStatusTypeImpl#getReason <em>Reason</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentStatusTypeImpl#getSourceID <em>Source ID</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.DocumentStatusTypeImpl#getSourceBilling <em>Source Billing</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentStatusTypeImpl extends EObjectImpl implements DocumentStatusType {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getDocumentStatusType();
	}
	...
	public void setWorkStatus(WorkStatusType newWorkStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_STATUS_TYPE__WORK_STATUS, oldWorkStatus, workStatus, !oldWorkStatusESet));
	}
	...
	public void unsetWorkStatus() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _301Package.DOCUMENT_STATUS_TYPE__WORK_STATUS, oldWorkStatus, WORK_STATUS_EDEFAULT, oldWorkStatusESet));
	}
	...
	public void setWorkStatusDate(XMLGregorianCalendar newWorkStatusDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_STATUS_TYPE__WORK_STATUS_DATE, oldWorkStatusDate, workStatusDate));
	}
	...
	public void setReason(String newReason) {
		...
		reason = newReason;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_STATUS_TYPE__REASON, oldReason, reason));
	}
	...
	public void setSourceID(String newSourceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_STATUS_TYPE__SOURCE_ID, oldSourceID, sourceID));
	}
	...
	public void setSourceBilling(SAFTPTSourceBilling newSourceBilling) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.DOCUMENT_STATUS_TYPE__SOURCE_BILLING, oldSourceBilling, sourceBilling, !oldSourceBillingESet));
	}
	...
	public void unsetSourceBilling() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _301Package.DOCUMENT_STATUS_TYPE__SOURCE_BILLING, oldSourceBilling, SOURCE_BILLING_EDEFAULT, oldSourceBillingESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.DOCUMENT_STATUS_TYPE__WORK_STATUS:
				return getWorkStatus();
			case _301Package.DOCUMENT_STATUS_TYPE__WORK_STATUS_DATE:
				return getWorkStatusDate();
			case _301Package.DOCUMENT_STATUS_TYPE__REASON:
				return getReason();
			case _301Package.DOCUMENT_STATUS_TYPE__SOURCE_ID:
				return getSourceID();
			case _301Package.DOCUMENT_STATUS_TYPE__SOURCE_BILLING:
