 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.TaxTableEntryTypeImpl#getTaxType <em>Tax Type</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.TaxTableEntryTypeImpl#getTaxCountryRegion <em>Tax Country Region</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.TaxTableEntryTypeImpl#getTaxCode <em>Tax Code</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.TaxTableEntryTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.TaxTableEntryTypeImpl#getTaxExpirationDate <em>Tax Expiration Date</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.TaxTableEntryTypeImpl#getTaxPercentage <em>Tax Percentage</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._201.impl.TaxTableEntryTypeImpl#getTaxAmount <em>Tax Amount</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TaxTableEntryTypeImpl extends EObjectImpl implements TaxTableEntryType {
	...
	protected EClass eStaticClass() {
		return _201Package.eINSTANCE.getTaxTableEntryType();
	}
	...
	public void setTaxType(TaxTypeType newTaxType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.TAX_TABLE_ENTRY_TYPE__TAX_TYPE, oldTaxType, taxType, !oldTaxTypeESet));
	}
	...
	public void unsetTaxType() {
		...
		taxTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _201Package.TAX_TABLE_ENTRY_TYPE__TAX_TYPE, oldTaxType, TAX_TYPE_EDEFAULT, oldTaxTypeESet));
	}
	...
	public void setTaxCountryRegion(String newTaxCountryRegion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.TAX_TABLE_ENTRY_TYPE__TAX_COUNTRY_REGION, oldTaxCountryRegion, taxCountryRegion));
	}
	...
	public void setTaxCode(String newTaxCode) {
		...
		taxCode = newTaxCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.TAX_TABLE_ENTRY_TYPE__TAX_CODE, oldTaxCode, taxCode));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.TAX_TABLE_ENTRY_TYPE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setTaxExpirationDate(XMLGregorianCalendar newTaxExpirationDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.TAX_TABLE_ENTRY_TYPE__TAX_EXPIRATION_DATE, oldTaxExpirationDate, taxExpirationDate));
	}
	...
	public void setTaxPercentage(BigDecimal newTaxPercentage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.TAX_TABLE_ENTRY_TYPE__TAX_PERCENTAGE, oldTaxPercentage, taxPercentage));
	}
	...
	public void setTaxAmount(BigDecimal newTaxAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _201Package.TAX_TABLE_ENTRY_TYPE__TAX_AMOUNT, oldTaxAmount, taxAmount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _201Package.TAX_TABLE_ENTRY_TYPE__TAX_TYPE:
				return getTaxType();
			case _201Package.TAX_TABLE_ENTRY_TYPE__TAX_COUNTRY_REGION:
				return getTaxCountryRegion();
			case _201Package.TAX_TABLE_ENTRY_TYPE__TAX_CODE:
				return getTaxCode();
			case _201Package.TAX_TABLE_ENTRY_TYPE__DESCRIPTION:
				return getDescription();
			case _201Package.TAX_TABLE_ENTRY_TYPE__TAX_EXPIRATION_DATE:
				return getTaxExpirationDate();
			case _201Package.TAX_TABLE_ENTRY_TYPE__TAX_PERCENTAGE:
				return getTaxPercentage();
			case _201Package.TAX_TABLE_ENTRY_TYPE__TAX_AMOUNT:
				return getTaxAmount();
		}
