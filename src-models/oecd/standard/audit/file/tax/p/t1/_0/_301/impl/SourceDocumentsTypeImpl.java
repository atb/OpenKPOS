...
import oecd.standard.audit.file.tax.p.t1._0._301.MovementOfGoodsType;
import oecd.standard.audit.file.tax.p.t1._0._301.PaymentsType;
 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.SourceDocumentsTypeImpl#getSalesInvoices <em>Sales Invoices</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.SourceDocumentsTypeImpl#getMovementOfGoods <em>Movement Of Goods</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.SourceDocumentsTypeImpl#getWorkingDocuments <em>Working Documents</em>}</li>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.SourceDocumentsTypeImpl#getPayments <em>Payments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SourceDocumentsTypeImpl extends EObjectImpl implements SourceDocumentsType {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getSourceDocumentsType();
	}
	...
	public NotificationChain basicSetSalesInvoices(SalesInvoicesType newSalesInvoices, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.SOURCE_DOCUMENTS_TYPE__SALES_INVOICES, oldSalesInvoices, newSalesInvoices);
	...
	public void setSalesInvoices(SalesInvoicesType newSalesInvoices) {
		if (newSalesInvoices != salesInvoices) {
			...
			if (salesInvoices != null)
				msgs = ((InternalEObject)salesInvoices).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.SOURCE_DOCUMENTS_TYPE__SALES_INVOICES, null, msgs);
			if (newSalesInvoices != null)
				msgs = ((InternalEObject)newSalesInvoices).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.SOURCE_DOCUMENTS_TYPE__SALES_INVOICES, null, msgs);
			msgs = basicSetSalesInvoices(newSalesInvoices, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.SOURCE_DOCUMENTS_TYPE__SALES_INVOICES, newSalesInvoices, newSalesInvoices));
	}
	...
	public NotificationChain basicSetMovementOfGoods(MovementOfGoodsType newMovementOfGoods, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.SOURCE_DOCUMENTS_TYPE__MOVEMENT_OF_GOODS, oldMovementOfGoods, newMovementOfGoods);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMovementOfGoods(MovementOfGoodsType newMovementOfGoods) {
		if (newMovementOfGoods != movementOfGoods) {
			...
			if (movementOfGoods != null)
				msgs = ((InternalEObject)movementOfGoods).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.SOURCE_DOCUMENTS_TYPE__MOVEMENT_OF_GOODS, null, msgs);
			if (newMovementOfGoods != null)
				msgs = ((InternalEObject)newMovementOfGoods).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.SOURCE_DOCUMENTS_TYPE__MOVEMENT_OF_GOODS, null, msgs);
			msgs = basicSetMovementOfGoods(newMovementOfGoods, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.SOURCE_DOCUMENTS_TYPE__MOVEMENT_OF_GOODS, newMovementOfGoods, newMovementOfGoods));
	}
	...
	public NotificationChain basicSetWorkingDocuments(WorkingDocumentsType newWorkingDocuments, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.SOURCE_DOCUMENTS_TYPE__WORKING_DOCUMENTS, oldWorkingDocuments, newWorkingDocuments);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWorkingDocuments(WorkingDocumentsType newWorkingDocuments) {
		if (newWorkingDocuments != workingDocuments) {
			...
			if (workingDocuments != null)
				msgs = ((InternalEObject)workingDocuments).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.SOURCE_DOCUMENTS_TYPE__WORKING_DOCUMENTS, null, msgs);
			if (newWorkingDocuments != null)
				msgs = ((InternalEObject)newWorkingDocuments).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.SOURCE_DOCUMENTS_TYPE__WORKING_DOCUMENTS, null, msgs);
			msgs = basicSetWorkingDocuments(newWorkingDocuments, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.SOURCE_DOCUMENTS_TYPE__WORKING_DOCUMENTS, newWorkingDocuments, newWorkingDocuments));
	}
	...
	public NotificationChain basicSetPayments(PaymentsType newPayments, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _301Package.SOURCE_DOCUMENTS_TYPE__PAYMENTS, oldPayments, newPayments);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPayments(PaymentsType newPayments) {
		if (newPayments != payments) {
			NotificationChain msgs = null;
			if (payments != null)
				msgs = ((InternalEObject)payments).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _301Package.SOURCE_DOCUMENTS_TYPE__PAYMENTS, null, msgs);
			if (newPayments != null)
				msgs = ((InternalEObject)newPayments).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _301Package.SOURCE_DOCUMENTS_TYPE__PAYMENTS, null, msgs);
			msgs = basicSetPayments(newPayments, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.SOURCE_DOCUMENTS_TYPE__PAYMENTS, newPayments, newPayments));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _301Package.SOURCE_DOCUMENTS_TYPE__SALES_INVOICES:
				return basicSetSalesInvoices(null, msgs);
			case _301Package.SOURCE_DOCUMENTS_TYPE__MOVEMENT_OF_GOODS:
				return basicSetMovementOfGoods(null, msgs);
			case _301Package.SOURCE_DOCUMENTS_TYPE__WORKING_DOCUMENTS:
				return basicSetWorkingDocuments(null, msgs);
			case _301Package.SOURCE_DOCUMENTS_TYPE__PAYMENTS:
