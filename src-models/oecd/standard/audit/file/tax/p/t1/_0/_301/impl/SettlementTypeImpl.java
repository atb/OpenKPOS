 ...
 * <ul>
 *   <li>{@link oecd.standard.audit.file.tax.p.t1._0._301.impl.SettlementTypeImpl#getSettlementAmount <em>Settlement Amount</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SettlementTypeImpl extends EObjectImpl implements SettlementType {
	...
	protected EClass eStaticClass() {
		return _301Package.eINSTANCE.getSettlementType();
	}
	...
	public void setSettlementAmount(BigDecimal newSettlementAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _301Package.SETTLEMENT_TYPE__SETTLEMENT_AMOUNT, oldSettlementAmount, settlementAmount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _301Package.SETTLEMENT_TYPE__SETTLEMENT_AMOUNT:
