...
start /B javaw -cp %CP% -Djava.util.logging.config.file=$DIRNAME/logging.properties -Dswing.defaultlaf=javax.swing.plaf.metal.MetalLookAndFeel -Djava.library.path="%DIRNAME%Windows\i368-mingw32" -Ddirname.path="%DIRNAME%./" pt.ktc.openk.pos.forms.StartOpenKPOS %1
rem java -cp %CP% -Dswing.defaultlaf=javax.swing.plaf.metal.MetalLookAndFeel -Djava.library.path="%DIRNAME%Windows\i368-mingw32" -Ddirname.path="%DIRNAME%./" pt.ktc.openk.pos.forms.StartOpenKPOS %1
rem java -cp %CP% -Dswing.defaultlaf=javax.swing.plaf.metal.MetalLookAndFeel -Djava.library.path="%DIRNAME%Windows\i368-mingw32" -Ddirname.path="%DIRNAME%./" pt.ktc.openk.pos.utils.MACAddress
