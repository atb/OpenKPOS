...
# start Openbravo POS
java -cp $CP -Djava.util.logging.config.file=$DIRNAME/logging.properties -Dswing.defaultlaf=javax.swing.plaf.metal.MetalLookAndFeel -Djava.library.path=$DIRNAME:$LIBRARYPATH -Ddirname.path=$DIRNAME/ pt.ktc.openk.pos.forms.StartOpenKPOS ./openk_pos_demo.properties ./openk_pos_services_demo.properties
