...
public class DataLogicCustomers extends BeanFactoryDataSingle {
    ...
    // CustomerList All -> (ATB) Passar para um aspecto!!!!
    public SentenceList getCustomerListAll() {
        
    	return new StaticSentence(s
            , new QBFBuilder("SELECT ID, TAXID, SEARCHKEY, NAME FROM CUSTOMERS ORDER BY NAME", new String[] {"TAXID", "SEARCHKEY", "NAME"})
            ...
            , new SerializerRead() {
                    public Object readValues(DataRead dr) throws BasicException {
                    	com.openbravo.pos.customers.CustomerInfo c = new com.openbravo.pos.customers.CustomerInfo(dr.getString(1));
